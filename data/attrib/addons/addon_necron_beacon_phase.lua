...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111209]] -- - Allows the Beacon to cast the Void Possession; if Rise of the Machines has been researched, the effect will be global!
...
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_beacon_voiddragon_addon]]
...
GameData["ui_info"]["screen_name_id"] = [[$18111208]] -- Beacon of the Void Dragon (add-on)
