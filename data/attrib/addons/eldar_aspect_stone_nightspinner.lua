...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows the production of Nightspinner artillery tanks from this building.]]
...
GameData["ui_info"]["icon_name"] = [[eldar_icons/aspect_stone_nightspinner_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[Nightspinner Aspect Stone Add-on]]
