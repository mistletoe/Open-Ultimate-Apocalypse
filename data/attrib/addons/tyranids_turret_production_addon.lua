...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211026]] -- - Allows this structure to continuously produce spore mines for free.
...
GameData["ui_info"]["screen_name_id"] = [[$18211025]] -- Attachment: Spore Mine Production (Add-On)
