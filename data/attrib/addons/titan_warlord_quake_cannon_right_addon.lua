...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Replaces default gatling cannon (right arm) with quake cannon.]]
...
GameData["ui_info"]["icon_name"] = [[npc/warlord_quake_cannon_right_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[Quake Cannon (Right)]]
