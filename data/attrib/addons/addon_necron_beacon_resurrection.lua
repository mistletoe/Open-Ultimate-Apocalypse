...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111211]] -- - Allows the Beacon to cast Mass Resurrection; if Rise of the Machines has been researched, the effect will be global!
...
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_beacon_resurrection_addon]]
...
GameData["ui_info"]["screen_name_id"] = [[$18111210]] -- Resurrection Beacon (add-on)
