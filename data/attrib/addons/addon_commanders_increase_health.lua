...
GameData["requirements"]["required_7"]["mutually_exclusive_with"] = [[addons\addon_commanders_increase_production.lua]]
...
GameData["requirements"]["required_9"]["addon"] = [[addon_commanders_increase_health]]
