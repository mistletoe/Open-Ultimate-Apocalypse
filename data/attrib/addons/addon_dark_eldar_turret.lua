...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210776]] -- - Replaces standard weapon on the turret with a Splinter Cannon and Dark Lance.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210777]] -- - Effective against most target types.
...
GameData["ui_info"]["screen_name_id"] = [[$18210775]] -- Turret Improvements (Add-On)
