...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$692000]] -- - Fortify this Strategic Point.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$692001]] -- - Fortified Positions produce the Requisition resource at a higher rate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$692002]] -- - Fortified Positions are tougher, and are equipped with a turreted weapon effective against Infantry and Heavy Infantry.
...
GameData["ui_info"]["screen_name_id"] = [[$692003]] -- Fortified Position Addon
