...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows the production of Soul Walkers from this structure.]]
...
GameData["ui_info"]["icon_name"] = [[eldar_icons/aspect_stone_wraith_walker_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[Soul Walker Aspect Stone Addon]]
