...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows the production of Wraithguard from this structure.]]
...
GameData["ui_info"]["icon_name"] = [[eldar_icons/aspect_stone_wraithguard_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[Wraithguard Aspect Stone Add-on]]
