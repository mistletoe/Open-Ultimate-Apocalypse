...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\chaos_ritual_confusion_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210685]] -- - Sacrifice Ritual drains the life of all enemy infantry globally for a long duration. User is rendered immobile throughout the duration of the Ritual.
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_spell_sacrifice_research_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[$18210684]] -- Learn Ritual: Sacrifice
