...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\addon_daemons_hq_2.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\addon_daemons_hq_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16002017]] -- - Forms a direct connection between the Daemonic Army and the Warp.
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16002018]] -- - Allows the summoning of Greater Daemons and embodiments of the dark gods.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16002019]] -- - Grants even better regeneration to all summoned structures (but the Maledictum).
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16002020]] -- - Allows the final Daemonic Gifts to be petitioned.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16002021]] -- - WARNING: While performing this Add-on, ALL protections of this Warp Gate are suspended.
GameData["ui_info"]["help_text_list"]["text_07"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[$0]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_tieriii_icon]]
...
GameData["ui_info"]["screen_name_id"] = [[$16002016]] -- Ultimate Summoning Add-on (Tier III)
