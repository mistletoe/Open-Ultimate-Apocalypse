...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows the creation of Wraithlords from this structure.]]
...
GameData["ui_info"]["screen_name_id"] = [[Wraithlord Aspect Stone Add-on]]
