...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_01"] = Reference([[type_armour\tp_TOUGHNESS5.lua]])
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_04"] = Reference([[type_armour\tp_TOUGHNESS8_VEHICLE.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_enable.lua]])
...
GameData["child_ability_name"] = [[dark_eldar_energy_field_araspida_operative_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable ability: Entrench the Araspida, enabling overshields.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- While Entrenched, the Araspida will be very immune to melee attacks and cannot move, but shields will be strengthened greatly and health is increased by 200%.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Left-click to activate!]]

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/araspida_entrench_icon]]

GameData["ui_info"]["screen_name_id"] = [[Entrench]]
