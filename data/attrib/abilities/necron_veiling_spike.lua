...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Necron/sp/beacon_pulse]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Necron/sp/beacon_pulse]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Necron/sp/beacon_pulse]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Necron/sp/beacon_pulse]]
...
GameData["area_effect"]["throw_data"]["force_min"] = 46
...
GameData["spawned_entity_name"] = [[necron_veiled_spike]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111829]] -- - Ancient energies deep within the catacombs.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111830]] -- - The veiled spike emerges from the ground, reactivated, forming a cloud of deception within the eyes of the victim within a moderate radius.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18111833]] -- - Left-click and target a position to activate!

GameData["ui_info"]["icon_name"] = [[necron_icons/blinding_pillar_entity]]

GameData["ui_info"]["screen_name_id"] = [[$18111828]] -- Summon Blinding Spike of Deception
