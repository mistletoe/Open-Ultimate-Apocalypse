...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[tau/vehicle_burst]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[tau/vehicle_burst]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[tau/vehicle_burst]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[tau/vehicle_burst]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[tau/vehicle_burst]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 230
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tau_arka_cannon_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18100003]] -- - Overcharges the Ion Cannon, allowing it to fire its ion blasts at rapid fire rates, critically damaging objects from across the map!
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18100004]] -- - Requires 50% health to operate, as the overcharge will melt the core of the Arka Cannon.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18100005]] -- - Left-click to activate!

GameData["ui_info"]["icon_name"] = [[tau_icons\lasergun_ability_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18100006]] -- Ion Cannon Overcharge Mode
