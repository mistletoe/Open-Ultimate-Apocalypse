...
GameData["child_ability_name"] = [[necron_solar_pulse_monolith2]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111422]] -- - Allows the caster to unleash three massive photon bursts at a targeted location.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704202]] -- - All infiltrated units in a large area are revealed.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$704203]] -- - All enemy units in the area are blinded for several seconds.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$704204]] -- - Blinded units cannot fire ranged weapons in the affected zone.
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Left-click and target a location or enemy to activate.]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[necron_icons/necron_solar_pulse_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111421]] -- Solar Pulses of Unnatural
