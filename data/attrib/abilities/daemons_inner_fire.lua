...
GameData["ability_motion_name"] = [[unit_impact_events\chaos_flamer_hit_end.events]]
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[daemons\lost_soul_inner_fire.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[daemons\lost_soul_inner_fire.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[daemons\lost_soul_inner_fire.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[daemons\lost_soul_inner_fire.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[daemons\lost_soul_inner_fire.events]]
