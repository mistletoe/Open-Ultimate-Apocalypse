...
GameData["child_ability_name"] = [[chaos_mark_of_khorne_child]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\chaos_Pact.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Enemy infantry are unable to move while active]]

GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_marine_icon_berserker_fear]]

GameData["ui_info"]["screen_name_id"] = [[Blood Scream]]
