...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_soul_shields_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable ability, turns on/off the Soul Shields of the Haemonculus.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Soul Shield is a protective defense shields that arms your unit with invulnerability as long as the "morale" of the unit remains charged.]]
...
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/haemonculus_shield]]

GameData["ui_info"]["screen_name_id"] = [[Soul Shield]]
