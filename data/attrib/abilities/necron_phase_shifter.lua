...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704101]] -- - Allows the Necron Lord and nearby friendly units to phase out of the material universe.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704102]] -- - Phase shifted units are immune to all forms of damage, but cannot attack.
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_phase_shifter_icon]]

GameData["ui_info"]["screen_name_id"] = [[$704100]] -- Phase Shifter
