...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Since you have chosen the Mark of Slaanesh, the ability will increase the morale and movement speeds of all surrounding allied troops 50m away from the Worship.]]
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/worship_slaanesh_icon]]
GameData["ui_info"]["screen_name_id"] = [[Worship Slaanesh]]
