...
GameData["requirements"]["required_1"]["research_name"] = [[research\marine_spell_inquisition.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Can only damage and target daemons, monsters, or commanders!]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$673151]] -- - Generates a psychic energy that tortures enemy units.
GameData["ui_info"]["help_text_list"]["text_03"] = [[- All hit monstrous creatures or commanders are flung around in an area effect, brutally damaging all within the area effect.]]
