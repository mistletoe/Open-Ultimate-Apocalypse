...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\eldar_wargear_upgrade_10.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\eldar_wargear_upgrade_10.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4000093]] -- - Farseer Caerys will continue to take damage, but will not die while the Soulstone ability is active.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4000094]] -- - Left-click to activate
GameData["ui_info"]["icon_name"] = [[eldar_icons\soulstone_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4000091]] -- Soulstone
