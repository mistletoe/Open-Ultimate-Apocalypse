...
GameData["requirements"]["required_2"]["structure_name"] = [[ebps\races\dark_eldar\structures\dark_eldar_hq.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100012]] -- - Unleashes the tortured spirits of captured Psykers, driving enemies mad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100013]] -- - Causes enemy infantry to fight amongst themselves.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100014]] -- - Left-click and target an enemy squad to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/crucible_of_malediction_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4100011]] -- Crucible of Malediction
