...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["target_type_name"] = [[chaos_lord_of_change]]
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["value"] = 0
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\cost_requisition_modifier.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["target_type_name"] = [[chaos_lord_of_change]]
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 0.3300000131
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210849]] -- - Might of Tzeentch will make the Lord of Change recruitable for free, and will allow the Lord of Change to use his abilities without delay!
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210850]] -- - Instantly recharges the Lord of Change's abilities and greatly increases ability range so long as the Sorceror Lord is using the Ritual.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91543]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_spell_full_might_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210847]] -- Ritual: Full Might of Tzeentch
