...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Necron/Deceiver_MC_AOE]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Necron/Deceiver_MC_AOE]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Necron/Deceiver_MC_AOE]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Necron/Deceiver_MC_AOE]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Necron/Deceiver_MC_AOE]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\ability_necron_chronometron_event.lua]])
...
GameData["entity_busy_time"] = 2.349999905
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210445]] -- - Active fooling ability, confuses your enemy into attacking their allies.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210446]] -- - Left-click and target enemy infantry, commanders, or monsters to activate.
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_deceive_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4500014]] -- Deceive
