...
GameData["child_ability_name"] = [[tyranids_minelaunch_child]]
...
GameData["fire_cost"]["requisition"] = 160
...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\tyranids_turret_launcher_addon.lua]]
