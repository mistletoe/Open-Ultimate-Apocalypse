...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[necron/abilities/necron_selfdestruct]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[necron/abilities/necron_selfdestruct]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[necron/abilities/necron_selfdestruct]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[necron/abilities/necron_selfdestruct]]
...
GameData["child_ability_name"] = [[necron_amplifier_selfdestruct_child]]
