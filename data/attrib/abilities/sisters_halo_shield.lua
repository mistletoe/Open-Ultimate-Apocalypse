...
GameData["requirements"]["required_2"]["research_name_either"] = [[research\sisters_wargear18.lua]]
GameData["requirements"]["required_2"]["research_name_or"] = [[research\sisters_wargear18.lua]]
