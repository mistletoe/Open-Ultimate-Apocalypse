...
GameData["child_ability_name"] = [[ork_fighta_bomma_bombs_child]]
...
GameData["spawned_entity_name"] = [[ebps\game\airstrike\fighta_flyby.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Dem Fighta Bommas will blow dem dumb enemies in da air! Cuz we so smart now.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Ranjey an' boomy bom dropped from dem Fighta Bommas an' makes a big boooom!!! ]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Press left button thing and choose open ground to use!]]

GameData["ui_info"]["icon_name"] = [[ork_icons/ork_bomma_boom_icon]]

GameData["ui_info"]["screen_name_id"] = [[$672900]] -- Burna Bomb
