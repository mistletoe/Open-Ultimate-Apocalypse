...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Boost Dark Eldar running speed.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92293]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/de_foot_on_fire_ability]]

GameData["ui_info"]["screen_name_id"] = [[Feet On Fire]]
