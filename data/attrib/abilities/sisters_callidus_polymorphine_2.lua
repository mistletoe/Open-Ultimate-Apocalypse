...
GameData["area_effect"]["area_effect_information"]["radius"] = 22
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[witch_hunters/callidus_cease_noloop]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[witch_hunters/callidus_cease_noloop]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[witch_hunters/callidus_cease_noloop]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[witch_hunters/callidus_cease_noloop]]
...
GameData["duration_time"] = 15.80000019
