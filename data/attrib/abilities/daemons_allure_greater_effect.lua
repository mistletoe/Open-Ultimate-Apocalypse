...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[daemonic_alluring_greater_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[daemonic_alluring_greater_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[daemonic_alluring_greater_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[daemonic_alluring_greater_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[daemonic_alluring_greater_event]]
