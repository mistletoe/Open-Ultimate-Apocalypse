...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 321
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[eldar\abilities\eldritchtempest_hit_small.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[eldar\abilities\eldritchtempest_hit_large.events]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[eldar\abilities\eldritchtempest_hit_small.events]]
...
GameData["child_ability_name"] = [[eldar_eldritch_tempest10_strike]]
...
GameData["initial_delay_time"] = 18
