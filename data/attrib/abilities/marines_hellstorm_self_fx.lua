...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\ability_tau_mark_target_event.lua]])
...
GameData["child_ability_name"] = [[marines_hellstorm_child1]]
