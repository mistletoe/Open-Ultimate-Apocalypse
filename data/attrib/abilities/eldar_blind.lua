...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111190]] -- - Blinds the targeted squad for a duration.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18111178]] -- - Left-click and target an enemy unit or structure to activate.

GameData["ui_info"]["icon_name"] = [[eldar_icons/blind]]

GameData["ui_info"]["screen_name_id"] = [[$18111189]] -- Blindness
