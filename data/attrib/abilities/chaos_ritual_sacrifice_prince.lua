...
GameData["child_ability_name"] = [[chaos_ritual_sacrifice_child]]
...
GameData["recharge_timer_id"] = 44056
GameData["refresh_time"] = 1
GameData["requirements"] = Reference([[tables\requirements.lua]])
GameData["requirements"]["required_1"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_1"]["addon_name"] = [[addons\chaos_ritual_sacrifice_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Ritual ability, a far more deadly but risky to use spell to cast.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- A global offensive/defensive ability that drains the health of enemies at a minor rate over time for 45 seconds.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The Daemon Prince becomes immobile and will do nothing throughout the duration of this spell.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91543]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_spell_sacrifice_icon]]

GameData["ui_info"]["screen_name_id"] = [[Ritual: Sacrifice]]
