...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021305]] -- - Finds and calculates the relative weapon systems emplaced on all enemy structures throughout the globe by mathematical calculations.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021306]] -- - Temporarily disables all enemy turrets or defensive weaponry for a duration.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021291]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/idh_reprogram_sabotage]]

GameData["ui_info"]["screen_name_id"] = [[$16021304]] -- Calculation: Structural Defense Hacking
