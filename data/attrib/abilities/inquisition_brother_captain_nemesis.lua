...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[abilities\holocaust_start]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[abilities\holocaust_start]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[abilities\holocaust_start]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[abilities\holocaust_start]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 135
...
GameData["child_ability_name"] = [[inquisition_brother_captain_nemesis_child01]]
...
GameData["ui_hotkey_name"] = [[inquisition_nemesis]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$92431]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021252]] -- - Offensive anti daemon ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021253]] -- - A scouraging psychic warp wave devourers the flesh of the hit victim.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021254]] -- - Deals good damage versus all unit types, except titans and Living Metal units.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021255]] -- - Left-click and target an enemy unit or the ground to activate!

GameData["ui_info"]["icon_name"] = [[inquisition_icons/nemesis_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16021250]] -- Nemesis
