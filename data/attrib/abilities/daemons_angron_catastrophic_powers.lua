...
GameData["child_ability_name"] = [[daemons_angron_catastrophic_powers_child1]]
...
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_angron_catastrophic_powers_icon]]
