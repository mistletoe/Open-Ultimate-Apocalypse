...
GameData["spawned_entity_name"] = [[tyranids_tyranoform_infest]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16028298]] -- - Create an infestation cloud above a targeted location.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16028299]] -- - Infestation cloud has a chance to cripple enemy production speeds at regular intervals, for a prolonged duration.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16028300]] -- - Infestation cloud speeds up production speeds around your own structures if casted upon your territory.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16028301]] -- - Left-click and target a location to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[tyranids_icons\i_cata_sporecloud]]

GameData["ui_info"]["screen_name_id"] = [[$16028296]] -- Hive Mind Link: Infest Environment
