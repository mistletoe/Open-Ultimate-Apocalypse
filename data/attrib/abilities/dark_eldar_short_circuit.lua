...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_04"]["screen_name_id"] = [[$4450037]] -- Aircraft
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100042]] -- - Creates a localized EMP pulse that deactivates electronic targeting systems.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100043]] -- - Temporarily shuts down vehicle and building weapons.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100044]] -- - Left-click and target a vehicle or building to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/short_circuit_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4100041]] -- Short Circuit
