...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 0.1000000015
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 0.1000000015
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 0.1000000015
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 0.1000000015
...
GameData["child_ability_name"] = [[dark_eldar_shroud_shadow_reveal]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_portal_shroud_shadow_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211314]] -- - Toggleable support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92443]] -- - Left-click to activate.  Left-click again to de-activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211311]] -- - Upon activation, the structure will cover a large area in dark shrouds, decreasing sight of enemy units, but will reveal this structure to the enemy as uncloaked.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/portal_shroud_shadow]]

GameData["ui_info"]["screen_name_id"] = [[$18211313]] -- Dark Abyss
