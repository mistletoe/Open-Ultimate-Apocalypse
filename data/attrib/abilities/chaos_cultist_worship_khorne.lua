...
GameData["requirements"]["required_10"]["research_name"] = [[research\chaos_mark_khorne_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Since you have chosen the Mark of Khorne, the ability will increase the health regeneration of all surrounding allied troops 50m away from the Worship.]]
