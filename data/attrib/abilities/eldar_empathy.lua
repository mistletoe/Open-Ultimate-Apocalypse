...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 55
...
GameData["initial_delay_time"] = 1.850000024
...
GameData["requirements"]["required_1"]["research_name"] = [[research\eldar_spell_empathy.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211510]] -- - Targetable support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211511]] -- - Affected allied unit will overtime heal quickly for a very long duration. Increases health regeneration by a lot.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022393]] -- - Left-click and target an ally infantry unit to activate!

GameData["ui_info"]["icon_name"] = [[eldar_icons/empathy_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211509]] -- Empathy
