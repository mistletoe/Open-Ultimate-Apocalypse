...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 590
...
GameData["projectile_name"] = [[chaos_firebolt_projectile]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\chaos_mark_khorne_research.lua]]
...
GameData["requirements"]["required_4"]["research_name"] = [[research\chaos_mark_tzeentch_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Propels a ball of daemonic flame at the target.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Does high damage over a wide area.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$698050]] -- - Left-click and target a location or enemy units to activate.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$698052]] -- - Effective against enemy Infantry.

GameData["ui_info"]["icon_name"] = [[chaos_icons/warp_fire_icon]]

GameData["ui_info"]["screen_name_id"] = [[Firebolt]]
