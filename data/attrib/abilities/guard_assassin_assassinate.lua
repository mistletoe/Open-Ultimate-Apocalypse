...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$692951]] -- - High powered scope that doubles the range, sight, and damage of the Assassin's Exitus Rifle.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$692952]] -- - Can only be used for limited periods of time due to the rifle overheating.
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_ability_assassinate]]

GameData["ui_info"]["screen_name_id"] = [[$692950]] -- Assassination Scope
