...
GameData["requirements"]["required_1"]["research_name"] = [[research\daemons_wargear09.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000343]] -- - Defensive timed ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000344]] -- - Casts a temporary shield that grants total resistance against damage.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000345]] -- - The user will be invulnerable for a temporary amount of time.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16000346]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_shield_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000342]] -- Daemonic Shield
