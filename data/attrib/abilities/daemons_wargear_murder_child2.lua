...
--REPLACE_ME
GameData["area_effect"]["weapon_damage"]["armour_damage"]["life_leech_damage"] = 1.5
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 2.5
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 0.25
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 0.25
