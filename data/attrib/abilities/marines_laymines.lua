...
GameData["spawned_entity_name"] = [[space_marine_deployed_mines]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Spawn support ability.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Deploy a minefield on the ground underneath the transport.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Left-click to activate.]]

GameData["ui_info"]["icon_name"] = [[space_marine_icons/rhino_deploy_minefield_icon]]
GameData["ui_info"]["screen_name_id"] = [[Deploy Minefield]]
