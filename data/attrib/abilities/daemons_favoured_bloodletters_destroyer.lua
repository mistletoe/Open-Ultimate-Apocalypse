...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\enable_squad_reinforcement.lua]])
...
GameData["requirements"]["required_1"] = Reference([[requirements\required_structure_exclusive.lua]])
GameData["requirements"]["required_1"]["structure_name_exclusive"] = [[ebps\races\daemons\troops\daemon_khorne_herald.lua]]
