...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\guard_smoke_bomb.lua]]
GameData["speech_directory"] = [[Bomb]]
GameData["target_ground"] = true 
GameData["target_leader_in_squad"] = false
GameData["target_self"] = false
GameData["target_self_shazam"] = false
GameData["ui_hotkey_name"] = [[guard_smoke_bombs]]
GameData["ui_index_hint"] = 3
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4500031]] -- - Drops a series of smoke canisters.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4500032]] -- - Smoke provides cover for all units.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4500033]] -- - Left-click to activate.  Continues dropping canisters for the duration of the ability.

GameData["ui_info"]["icon_name"] = [[guard_icons/smoke_bombs_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[$4500030]] -- Bombing Run:  Smoke Canisters
