...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Chaos\BiotoxBomb_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Chaos\BiotoxBomb_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Chaos\BiotoxBomb_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Chaos\BiotoxBomb_aura]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_mark_nurgle_research.lua]]
