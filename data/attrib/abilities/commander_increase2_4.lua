...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[heroes_events/hero_lvl4]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[heroes_events/hero_lvl4]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[heroes_events/hero_lvl4]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[heroes_events/hero_lvl4]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[heroes_events/hero_lvl4]]
...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\commander_level4_research.lua]]
