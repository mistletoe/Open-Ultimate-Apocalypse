...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 0.2
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211178]] -- - Recharges all void shields with a 100% boost to max shielding of your titans at a quick rate temporarily.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211179]] -- - Also decreases ability recharge time of your titans by 80%.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211180]] -- - Cannot be used simultaneously with Boost W.O.M.D. ability.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210050]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[npc/thermo_boost_shields]]

GameData["ui_info"]["screen_name_id"] = [[$18211177]] -- Titanic Shield Boost
