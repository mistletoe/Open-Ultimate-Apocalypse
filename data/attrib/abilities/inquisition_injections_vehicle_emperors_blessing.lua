...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\armour_minimum_modifier.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_essence_machine_spirit_research.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_structure.lua]])
GameData["requirements"]["required_3"]["structure_name"] = [[inquisition_shrine_to_the_emperor.lua]]
