...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210907]] -- - Lesser version of the Orbital Bombardment, bombarding a targeted spot with one blast from orbit.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210908]] -- - Can be fired over and over for a small cost every 20 seconds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210909]] -- - Left-click and target an enemy unit or ground to activate!
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210910]] -- 

GameData["ui_info"]["icon_name"] = [[space_marine_icons/orbitalstrike_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210906]] -- Orbital Strike
