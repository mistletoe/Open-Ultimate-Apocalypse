...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[addon1_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[addon1_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[addon1_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[addon1_event]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_donate1_research.lua]]
