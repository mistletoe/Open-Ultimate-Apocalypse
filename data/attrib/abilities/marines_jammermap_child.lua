...
GameData["area_effect"]["area_effect_information"]["radius"] = 85
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210821]] -- - Timed Support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210822]] -- - Jams the sensor readings of all enemy units within a 85m radius, removing their ability to detect infiltrated units.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210823]] -- - Blinds enemy units in range, blurring their line of sight, on top of a small weapon accuracy penalty.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210824]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[space_marine_icons/sabotage_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210820]] -- Sensor Jam
