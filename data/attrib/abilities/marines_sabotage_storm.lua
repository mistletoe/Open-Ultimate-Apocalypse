...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\ability_ig_curse_of_the_machine_spirit_event.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112053]] -- - Causes a massive electrical overload in vehicles and buildings nearby.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112054]] -- - All vehicles and structures in a short radius from Beacon cannot do anything for a short period of time, including producing units, performing research, etc.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112055]] -- - NB!: ALL vehicles and structures nearby including (your own and allied) become dysfunctional. Use with caution.

GameData["ui_info"]["icon_name"] = [[space_marine_icons/sabotage_icon]]
GameData["ui_info"]["screen_name_id"] = [[$18112052]] -- Jamming Beacon
