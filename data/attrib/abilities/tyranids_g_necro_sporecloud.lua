...
GameData["child_ability_name"] = [[tyranids_g_necro_sporecloud_child1]]
...
GameData["requirements"]["required_2"]["owned_count"] = 4
...
GameData["requirements"]["required_4"]["global_addon_name"] = [[addons\tyranids_hq_addon_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16029598]] --  - Creates an acidic cloud that slowly damages enemy units.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100116]] -- - Left-click and target ground to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16026903]] --  - Requires 4 captured Strategic Points.

GameData["ui_info"]["icon_name"] = [[Tyranids_icons/i_necro_sporecloud]]
