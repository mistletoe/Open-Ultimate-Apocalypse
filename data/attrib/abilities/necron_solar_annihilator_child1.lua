...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Necron\aeonic_orb_blasts]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Necron\aeonic_orb_blasts]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Necron\aeonic_orb_blasts]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Necron\aeonic_orb_blasts]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 12500
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 7400
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111673]] -- - Not even titans can withstand the blast.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111674]] -- Solar Annihilator (Expanded Impact)
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18111675]] -- - Æonic Orb's primary superweapon, expanded impact.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18111676]] -- - Long ranged devastating weapon that destroys everything within a very large area of effect; does not harm Living Metal Necron units.

GameData["ui_info"]["icon_name"] = [[guard_icons\guard_let_it_burn_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111672]] -- - Long ranged devastating weapon that destroys everything within an area of effect; does not harm Living Metal Necron units.
