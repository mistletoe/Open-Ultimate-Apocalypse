...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 36500
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 27660
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 1000
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 12000
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111671]] -- - Æonic Orb's primary superweapon, default.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111672]] -- - Long ranged devastating weapon that destroys everything within an area of effect; does not harm Living Metal Necron units.
...
GameData["ui_info"]["screen_name_id"] = [[$18111670]] -- Solar Annihilator (Standard)
