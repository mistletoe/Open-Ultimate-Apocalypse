...
GameData["requirements"]["required_2"]["research_name"] = [[addons\eldar_farseer_ability_research_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$92284]] -- - Does massive damage to all unit types.
