...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\enable_hardpoint_03.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\enable_hardpoint_04.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable offensive ability.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Psyker Primaris unleashes the full might of his power, casting devastating bolt projectiles at surrounding enemies within a 30m radius.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- If the ability is turned on, the Psyker Primaris will be able to use these deadly weapons, but will be unable to move, use abilities or engage in combat as he focuses his powers solely onto the ability.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[WARNING!!! Each projectile costs 5 power per use.]]

GameData["ui_info"]["icon_name"] = [[guard_icons/soulripper_icon]]

GameData["ui_info"]["screen_name_id"] = [[Fury of the Emperor]]
