...
--Effects all infantry and buildings.
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_10"] = Reference([[type_armour\tp_TOUGHNESS8_BUILDING.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_11"] = Reference([[type_armour\tp_TOUGHNESS9_BUILDING.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_12"] = Reference([[type_armour\tp_TOUGHNESS10_BUILDING.lua]])
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Dark_Eldar\SA_WarFrenzy]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\repair_cost_modifier.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.1000000015
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\construction_speed_modifier.lua]])
...
GameData["requirements"]["required_10"]["structure_name"] = [[dark_eldar_hq.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Force Labors the Dark Eldar slaves to do your will.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increases the construction, repair, and production rates of all slaves and structures for a duration.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100040]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/war_frenzy_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[War Frenzy]]
