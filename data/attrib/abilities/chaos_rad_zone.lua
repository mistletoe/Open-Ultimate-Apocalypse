...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Chaos\Rad_Aura_fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Chaos\Rad_Aura_fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Chaos\Rad_Aura_fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Chaos\Rad_Aura_fx]]
...
GameData["entity_busy_time"] = 8.050000191
