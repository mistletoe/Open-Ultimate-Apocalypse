...
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_krak_grenades_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/ability_krak_grenades_improved]]
