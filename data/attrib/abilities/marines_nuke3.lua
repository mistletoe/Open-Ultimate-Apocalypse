...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 500
...
GameData["fire_cost"]["requisition"] = 2500
...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\guidable_beam.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$15043103]] -- - Spawn a deadly guidable beam at the targeted location.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$15043104]] -- - Can move around the battlefield, destroying and killing things in matter of seconds within a 13m radius wherever it goes.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$15043105]] -- - Distintigrates all unit types, including titans in not more than 3 seconds.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100123]] -- - Left-click and target ground to spawn.

GameData["ui_info"]["icon_name"] = [[npc/superweapon_high_energy_beam_icon]]

GameData["ui_info"]["screen_name_id"] = [[$15043102]] -- Superweapon: Satellite Particle Cannon
