...
GameData["ability_ordered_event_name"] = [[Guard\Abilities\Strafe_ordered_target_general]]
...
GameData["speech_directory"] = [[ability/strafing_run_vox]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112039]] -- - Allows the command leader to call in an Air Strike.
...
GameData["ui_info"]["screen_name_id"] = [[$18112038]] -- Strafing Run
