...
GameData["requirements"]["required_1"]["research_name"] = [[research\ork_research_speed_boost.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Boosts dem Storm Boyz speed on doze jet pack things and makes dem more chargy!]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Press dat left button thing to use!]]
