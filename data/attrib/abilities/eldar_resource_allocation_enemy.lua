...
GameData["child_ability_name"] = [[eldar_resource_allocation_enemy_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211222]] -- - Global enemy support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211223]] -- - Distribute 25% of your resources to all of your enemies for 30 seconds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211224]] -- - Subtracted cost of 250 requisition/power is taken from your income.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18211219]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[eldar_icons/webway_gate_resource_allocation_enemy_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211221]] -- Allocate Resources To Enemy
