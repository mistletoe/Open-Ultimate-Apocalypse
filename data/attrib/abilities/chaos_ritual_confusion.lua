...
GameData["child_ability_name"] = [[chaos_ritual_confusion_child]]
...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\chaos_ritual_confusion_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210861]] -- - The ritual of confusion will temporarily cause everything who oppose the powers of Chaos to attack each other and lose control, so long as the Sorceror is using the ritual.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210862]] -- - DOES NOT affect titans, heavily armored vehicles, structures, aircraft, or daemons.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91543]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_spell_confusion_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210860]] -- Ritual: Confusion
