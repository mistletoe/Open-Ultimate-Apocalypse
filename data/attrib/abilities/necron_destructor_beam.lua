...
GameData["child_ability_name"] = [[necron_destructor_beam_child1]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111668]] -- - Æonic Orb's secondary emergency weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111669]] -- - Short ranged split beam cutting in half all enemies 70m away from the Orb in a fixed direction. Ultimately destructive.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18111673]] -- - Not even titans can withstand the blast.

GameData["ui_info"]["icon_name"] = [[necron_icons\necron_solar_destructor_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111667]] -- Split Solar Flare Beam
