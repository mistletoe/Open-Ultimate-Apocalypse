...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 25
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111425]] -- - Allows the caster to phase out into an invulnerable state that lasts for about 30 seconds.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111426]] -- - While active, the Doomsday Monolith undergoes repairs, but loses its ability to attack for the duration of these effects.
...
GameData["ui_info"]["screen_name_id"] = [[$18111424]] -- Phase Shift Generator
