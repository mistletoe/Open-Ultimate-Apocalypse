...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[unit_ability_fx/inquisition_plane_of_purity]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[unit_ability_fx/inquisition_plane_of_purity]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx/inquisition_plane_of_purity]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[unit_ability_fx/inquisition_plane_of_purity]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022405]] -- - Timed offensive/support ability | Duration: 20 seconds. (Costs 400 morale)
...
GameData["ui_info"]["screen_name_id"] = [[$16022404]] -- Spell: Plane of Purity
