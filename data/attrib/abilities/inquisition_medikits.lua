...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_medikits.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022019]] -- - Support ability used to heal the squad wounded in combat. 
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022020]] -- - The ability costs requisition to use.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022039]] -- - Left-click to activate!

GameData["ui_info"]["icon_name"] = [[inquisition_icons/medikit_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16022016]] -- Medikit
