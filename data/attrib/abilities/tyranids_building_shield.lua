...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 14
...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\tyranids_structure_shield_addon.lua]]
