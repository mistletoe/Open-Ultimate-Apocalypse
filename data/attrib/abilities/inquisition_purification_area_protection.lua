...
GameData["child_ability_name"] = [[inquisition_purification_area_protection_event]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\inquisition_pentagrams.lua]]
