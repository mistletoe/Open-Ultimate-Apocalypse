...
GameData["fire_cost"]["power"] = 15000
...
GameData["recharge_timer_id"] = 15495
GameData["refresh_time"] = 1
GameData["requirements"] = Reference([[tables\requirements.lua]])
GameData["requirements"]["required_1"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_1"]["research_name"] = [[research\tyranids_hivefleet_research.lua]]
...
GameData["requirements"]["required_9"]["structure_name"] = [[tyranids_hq]]
GameData["requirements"]["required_12"] = Reference([[requirements\required_none.lua]])
GameData["spawned_entity_name"] = [[tyranids_hive_fleet_structure]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$15043112]] -- - Call down the essence of the Hive Fleet at the designated target.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$15043113]] -- - All structures and heavily armored vehicles immediately get enveloped upon the arrival of the Hive Fleet, knocking back infantry in its path.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$15043114]] -- - The Hive Fleet will last on the battlefield until it dies (unable to be fed), enveloping everything slowly in a 60m radius while also summoning forth all Tyranid units.

GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_hive_fleet]]

GameData["ui_info"]["screen_name_id"] = [[$15043111]] -- Superweapon: Spawn the Hive Fleet
