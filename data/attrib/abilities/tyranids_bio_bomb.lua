...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[tyranids_bio_bomb]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[tyranids_bio_bomb]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[tyranids_bio_bomb]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[tyranids_bio_bomb]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 10500
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 9000
...
GameData["projectile_spawn_pos"]["z"] = 0.6999999881
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tyranids_biobomb_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$15043158]] -- - Unleash poisonous gases and deadly blasts of energy at the designated target.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$15043159]] -- - Wipes out most objects in a 45m radius, plus an expanding gas cloud effect covering approximately 60m.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$15043160]] -- 

GameData["ui_info"]["icon_name"] = [[chaos_icons\massed_biotoxin_icon]]

GameData["ui_info"]["screen_name_id"] = [[$15043157]] -- Superweapon: Bio Bomb
