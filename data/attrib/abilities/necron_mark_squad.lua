...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_13"] = Reference([[type_armour\tp_TOUGHNESS6.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_13"]["screen_name_id"] = [[$4450037]] -- Aircraft
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_vision_granting.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Mark for death.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- All targets marked will become more vulnerable to ranged fire.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$665859]] -- - Left-click and target an enemy squad to activate.

GameData["ui_info"]["icon_name"] = [[necron_icons/necron_deathmark_target_icon]]
