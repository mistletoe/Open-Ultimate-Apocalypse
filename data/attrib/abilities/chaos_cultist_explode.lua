...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Chaos\Statue_Impact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Chaos\Statue_Impact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Chaos\Statue_Impact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Chaos\Statue_Impact]]
...
GameData["backfire_area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Chaos\Statue_Impact]]
GameData["backfire_area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Chaos\Statue_Impact]]
GameData["backfire_area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Chaos\Statue_Impact]]
GameData["backfire_area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Chaos\Statue_Impact]]
...
GameData["backfire_area_effect"]["area_effect_information"]["radius"] = 10
GameData["backfire_area_effect"]["area_effect_information"]["remove_modifiers_with_source_entity"] = false
GameData["backfire_area_effect"]["area_effect_information"]["start_from_caster"] = true 

GameData["backfire_area_effect"]["throw_data"]["direction_angle_random"] = 45
GameData["backfire_area_effect"]["throw_data"]["force_max"] = 50
GameData["backfire_area_effect"]["throw_data"]["force_min"] = 35
GameData["backfire_area_effect"]["throw_data"]["up_angle_max"] = 35
...
GameData["backfire_area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 340
GameData["backfire_area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 210
GameData["backfire_area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 15
GameData["backfire_area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 100
...
GameData["requirements"]["required_1"]["structure_name"] = [[chaos_hq]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Causes a member of the squad to explode.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Disrupts enemy formations and staggers their morale in a 15m radius.]]
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/deathblast_icon]]

GameData["ui_info"]["screen_name_id"] = [[Deathblast]]
