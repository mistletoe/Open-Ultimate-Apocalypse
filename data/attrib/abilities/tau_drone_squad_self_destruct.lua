...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704401]] -- - Temporary ability that allows the player to manually self-destruct the Drone Squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704402]] -- - Simulates the Drones' automatic self-destruct sequence when low on health.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_drone_self_destruct_icon]]

GameData["ui_info"]["screen_name_id"] = [[$704400]] -- Drone Self Destruct
