...
GameData["requirements"]["required_1"]["research_name"] = [[research\marine_krak_grenades_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[space_marine_icons/krakgrenade_icon_improved]]
