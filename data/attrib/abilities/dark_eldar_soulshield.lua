...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable ability, turns on/off the Soul Shields of the Titan.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Soul Shield is a protective defense shields that arms your titan with invulnerability as long as the "morale" of the titan remains charged.]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires the donation of more souls to fuel the Tormentor's energy.]]
