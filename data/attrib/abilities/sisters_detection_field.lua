...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_sisters_wall_probe.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$673451]] -- - Scans an area for infiltrated units.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$673452]] -- - Left-click and target a location to activate.
GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_detection_field]]

GameData["ui_info"]["screen_name_id"] = [[$673450]] -- Long Range Scanner
