...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Pylon Shift ultimately phases all nearbye Necron units out of the material Universe, making all units immune to attacks, while also able to attack!]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_phase_shifter_icon]]

GameData["ui_info"]["screen_name_id"] = [[Pylon Shift]]
