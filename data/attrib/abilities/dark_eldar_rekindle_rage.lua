...
GameData["requirements"]["required_2"]["structure_name"] = [[dark_eldar_soul_cage.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100125]] -- - Maelstrom of destructive power.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100122]] -- - High damage to all units caught within its fury.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100126]] -- - Guide towards enemies to wreak havoc among their ranks.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/soulstorm_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[$4100120]] -- Soulstorm
