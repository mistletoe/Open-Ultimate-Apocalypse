...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[nuber_3]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[nuber_3]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[nuber_3]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[nuber_3]]
GameData["area_effect"]["area_effect_information"]["area_type"] = Reference([[type_areaeffect\tp_area_effect_circle.lua]])
GameData["area_effect"]["area_effect_information"]["radius"] = 75
GameData["area_effect"]["area_effect_information"]["remove_modifiers_with_source_entity"] = true 
GameData["area_effect"]["sweeping_information"]["sweep_duration"] = 11.13000011
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 16000
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Necron\abilities\wailing_doom]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Necron\abilities\wailing_doom]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Necron\abilities\wailing_doom]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Necron\abilities\wailing_doom]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Necron\abilities\wailing_doom]]
...
GameData["child_ability_name"] = [[necron_annihilator_3explode2]]
