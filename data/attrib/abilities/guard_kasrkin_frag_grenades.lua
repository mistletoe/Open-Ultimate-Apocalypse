...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_frag_grenade_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- 50m throwing range, knocks back enemies in abouat a 7m radius.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Exclusive free throwing grenade, will not disable other grenades for a duration.]]
...
GameData["ui_info"]["screen_name_id"] = [[Kasrkin Frag Grenade]]
