...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_01"]["screen_name_id"] = [[$16026080]] -- Elite Warrior with Rending Claw
...
GameData["ui_info"]["screen_name_id"] = [[tyranids woth regen]]
