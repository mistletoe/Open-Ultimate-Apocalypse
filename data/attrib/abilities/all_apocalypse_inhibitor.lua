...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211174]] -- - Affects only tier IV Weapons of Mass Destruction, super structures.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211175]] -- - Boosts the production and ability speeds/reload times of weapons of mass destruction from super structures temporarily.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211176]] -- - Cannot be used simultaneously with Titanic Shield Boost ability.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210050]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[npc/inhibitor_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211173]] -- Boost W.O.M.D. Production Output
