...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Unit_Ability_FX/dread_Fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Unit_Ability_FX/dread_Fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Unit_Ability_FX/dread_Fx]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Unit_Ability_FX/dread_Fx]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 15
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\speed_maximum_modifier.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 2.329999924
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\enable_squad_reinforcement.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021233]] -- - Purifier squad conceal themselves for a temporary duration.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021235]] -- - Sight radius, infiltration detection radius, and movement speed is temporarily increased.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021230]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/strike_shroud_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16021232]] -- Psychic Shroud
