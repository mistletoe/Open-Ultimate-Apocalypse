...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[wind_of_chaos_loc]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[wind_of_chaos_loc]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[wind_of_chaos_loc]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[wind_of_chaos_loc]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 1350
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[unit_impact_events\chaos_flamer_blue_end]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[unit_impact_events\chaos_flamer_blue_end]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_impact_events\chaos_flamer_blue_end]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[unit_impact_events\chaos_flamer_blue_end]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000297]] -- - Offensive close-targeted spell, with long-range effect.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000298]] -- - Raw Warp energy casts forth from the caster that damages and knocks back everything in its path.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000299]] -- - Left-click and target the ground or enemy to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons\daemons_warpfire_loc_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000296]] -- Wall of Vile Magic
