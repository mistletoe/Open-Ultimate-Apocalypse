...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[aura/emperor_wrath]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[aura/emperor_wrath]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[aura/emperor_wrath]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[aura/emperor_wrath]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_psy_power_12.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022324]] -- - Timed defensive ability | Duration: 15 seconds on self. (Costs 600 morale)
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022327]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/emperorswrath_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16022323]] -- Spell: Emperor's Wrath
