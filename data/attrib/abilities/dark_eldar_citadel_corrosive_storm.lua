...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[corrosive_cloud]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[corrosive_cloud]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[corrosive_cloud]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[corrosive_cloud]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111944]] -- - Summons a vast tempest of poisonous and blinding winds. All targets within a 50m radius are blind, unable to shoot, and unable of production.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100123]] -- - Left-click and target ground to spawn.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/corrosive_storm_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111943]] -- Corrosive Storm
