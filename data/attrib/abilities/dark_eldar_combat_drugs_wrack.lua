...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100008]] -- - Injects an infusion of drugs that boosts the Dark Eldar metabolism and eliminates fear or pain.
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Grants morale and damage immunity, making the squad invulnerable with a huge health regeneration and combat buff.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100010]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/wrack_drugs_icon]]

GameData["ui_info"]["screen_name_id"] = [[Superior Combat Drugs]]
