...
GameData["child_ability_name"] = [[necron_annihilator_1pulses]]
...
GameData["spawned_entity_name"] = [[Data\attrib\ebps\environment\gameplay\necron_superweapon_sight.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$15043135]] -- - Fire a deadly beam of loathsome energies at the designated target.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$15043136]] -- - A focused blast violently explodes outward in a 75m radius, laying waste to everything in its path, eviscerating an entire base or army instantly.
...
GameData["ui_info"]["screen_name_id"] = [[Superweapon: Annihilator (Amplification Upgrade)]]
