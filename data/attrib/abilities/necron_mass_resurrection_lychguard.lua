...
GameData["speech_directory"] = [[ability_resurrection]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Reassembles any fallen Necron unit 15m away from the cast location.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- WARNING! Global recharge, other Lychguard squads will not be able to use the ability 60 seconds later.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210400]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[necron_icons/necron_mass_resurrection_icon]]

GameData["ui_info"]["screen_name_id"] = [[Lychguard's Resurrection]]
