...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[wind_of_chaos]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[wind_of_chaos]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[wind_of_chaos]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[wind_of_chaos]]
...
GameData["area_effect"]["sweeping_information"]["sweep_duration"] = 1.100000024
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing"] = 35
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16002251]] -- - Offensive close-targeted ability, with long-range effect.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16002253]] -- - With a mighty sword strike, the Possessed Daemon Prince invokes the might of the Warp.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16002254]] -- - Unleashes a flaming sheet that scorches and knocks back everything in its path.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16002255]] -- - Left-click and target the ground or enemy to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons\daemons_ability_flametongue_prince_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16002250]] -- Greater Flame Tongue
