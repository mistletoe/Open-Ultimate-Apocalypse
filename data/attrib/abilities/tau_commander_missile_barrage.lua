...
GameData["child_ability_name"] = [[tau_commander_missile_barrage_child_1]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\tau_wargear04.lua]]
