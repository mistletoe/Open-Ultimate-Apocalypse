...
GameData["requirements"]["required_9"]["structure_name"] = [[ebps\races\chaos\structures\chaos_armoury.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4500046]] -- - Improves squad's resistance to attacks that damage morale.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4500045]] -- - Squad does more damage, but also takes more damage.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91813]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/forcedlabor_icon]]

GameData["ui_info"]["screen_name_id"] = [[$91810]] -- Berserk Fury
GameData["ui_info"]["use_override_table_for_non_requisition_races"] = true 
