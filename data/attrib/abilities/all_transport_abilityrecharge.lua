...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211262]] -- - Support Ability, will recharge the abilities of your units nearby the transport a lot faster and restore the morale of squads.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211257]] -- - Cannot be used with other transport abilities (besides deploying minefields).
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211256]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[npc/transport_ability_recovery_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211261]] -- Transport Ability: Ability Overcharge
