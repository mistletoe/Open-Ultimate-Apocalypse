...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\population_growth_rate_player_modifier.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\eldar_webway_gate_resource_allocation_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211227]] -- - Toggleable support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211234]] -- - While on: Will reduce 25% of your requisition and power income for a 10% relic income increase.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211235]] -- - Good for Titan Wars or Titan Wars Extreme/Infinite winconditions. Especially useful for the Vaul Portal.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210050]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[eldar_icons/webway_gate_resource_allocation_relic_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211233]] -- Relic Resource Allocation
