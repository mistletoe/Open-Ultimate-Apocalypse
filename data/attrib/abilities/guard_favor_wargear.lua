...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\guard_wargear_upgrade_10.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\guard_wargear10.lua]]
