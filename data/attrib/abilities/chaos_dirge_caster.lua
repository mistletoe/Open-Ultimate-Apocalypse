...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\chaos_dirge_caster_research.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\chaos_dirge_caster_research.lua]]
