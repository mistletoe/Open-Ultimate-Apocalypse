...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000305]] -- - Offensive close-targeted ability, with long-range effect.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000306]] -- - Daemonic summoned flames cast forth from the caster that damages and knocks back everything in its path.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000307]] -- - Left-click and target the ground or enemy to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons\daemons_warpfire_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000304]] -- Wall of Fire
