...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\addon_necron_beacon_chronometron.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_10"]["addon_name"] = [[addons\addon_necron_beacon_chronometron.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111215]] -- - All enemy units within a 35m radius are slowed down to a crawling speed.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$575450]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_beacon_chronometron_ability]]
