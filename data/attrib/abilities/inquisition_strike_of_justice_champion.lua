...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[cosmos_custom_events\inquisition_strike_of_justice]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[cosmos_custom_events\inquisition_strike_of_justice]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[cosmos_custom_events\inquisition_strike_of_justice]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[cosmos_custom_events\inquisition_strike_of_justice]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 1781
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 699
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021238]] -- - Targetable offensive ability. A beam of light gets called down by the psychic powers of this unit.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021239]] -- - All enemy targets within an a 15 meter radius suffer moderate damage and are stunned for several seconds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021240]] -- - Monstrous creatures gets dealt severe damage and weaker monsters might be killed in the process.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021241]] -- - Left-click and target an enemy unit/structure or ground to activate!

GameData["ui_info"]["icon_name"] = [[inquisition_icons/strike_of_justice_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16021237]] -- Strike of Justice
