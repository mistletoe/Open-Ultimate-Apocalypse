...
GameData["area_effect"]["throw_data"]["direction_angle_random"] = 55
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704300]] -- - Causes the Energy Auxiliary to surge out into a magnetic maelstrom.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704301]] -- - Energy Auxiliary's components temporarily become a storm of deadly projectiles that damage all nearby units.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_kinetic_whirlwind_icon]]

GameData["ui_info"]["screen_name_id"] = [[$704302]] -- Magnetic Storm
