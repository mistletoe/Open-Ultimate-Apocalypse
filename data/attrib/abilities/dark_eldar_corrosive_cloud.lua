...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- All abilities, health, and morale of target regenerate instantly and the target becomes invulnerable for a duration.]]
