...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 19
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 11
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4300067]] -- - Throws a grenade at the targeted location or enemy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4300068]] -- - Left-click and target a location or enemy squad to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4300069]] -- - Damages enemy infantry.  Especially effective at breaking enemy morale.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4300070]] -- - Has no effect on vehicles or buildings.

GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_phosphor_grenades]]

GameData["ui_info"]["screen_name_id"] = [[$4300066]] -- Phosphor Grenades
