...
GameData["area_effect"]["area_effect_information"]["angle_left"] = -45
GameData["area_effect"]["area_effect_information"]["angle_right"] = 45
...
GameData["area_effect"]["throw_data"]["force_min"] = 75
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000431]] -- - Throws all infantry in front of Angron 45 degrees to the left and right out of the way. Also deals moderate morale and physical damage.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000432]] -- - Left-click and target an enemy or ground to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_angron_force_throw_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000429]] -- Force Throw
