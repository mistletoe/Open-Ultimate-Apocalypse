...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_frag_grenade_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/fraggrenade_ability_improved]]
