...
GameData["requirements"]["required_2"]["research_name"] = [[research\inquisition_auto_repair_systems_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021302]] -- - Finds and calculates the locations of all damages applied to allied vehicles and repairs them by mathematical formulas.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021303]] -- - Increases vehicular repair rates of all allied vehicles throughout the globe.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021291]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/idh_reprogram_vehicular_repair_ratio]]

GameData["ui_info"]["screen_name_id"] = [[$16021301]] -- Calculation: Vehicular Foundation
