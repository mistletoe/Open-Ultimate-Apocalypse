...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_05"] = Reference([[type_armour\tp_TOUGHNESS10_VEHICLE.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 66.66000366
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_auto_repair_systems_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022036]] -- - Support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022037]] -- - Equips Rhino Transports with the ability to repair the hull of itself and surrounding vehicles within the area for a duration.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022038]] -- - In exchange, a good portion of power is used to repair the vehicles, but very quickly.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022039]] -- - Left-click to activate!

GameData["ui_info"]["icon_name"] = [[inquisition_icons/auto_repair_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16022040]] -- Auto Repair Systems
