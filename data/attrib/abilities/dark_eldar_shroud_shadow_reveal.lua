...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\ability_eldar_shroud_event.lua]])
...
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/portal_shroud_shadow_icon]]
