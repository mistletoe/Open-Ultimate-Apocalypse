...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\enable_movement.lua]])
...
GameData["requirements"]["required_2"]["research_name"] = [[research\eldar_vehicle_ability_research.lua]]

GameData["requirements"]["required_10"] = Reference([[requirements\required_structure.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["structure_name"] = [[eldar_hq.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112258]] -- - Built in ability systems encase the user in wraithbone.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112259]] -- - The user will become disabled for a temporary duration in exchange for massive health regeneration.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112260]] -- 
GameData["ui_info"]["help_text_list"]["text_04"] = [[$575450]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[eldar_icons/wraithtomb_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18112257]] -- Wraithbone Regeneration
