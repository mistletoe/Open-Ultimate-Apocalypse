...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing"] = 55


--REPLACE_ME
GameData["area_effect"]["weapon_damage"]["armour_damage"]["life_leech_damage"] = 0
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 500
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 270
...
GameData["child_ability_name"] = [[inquisition_sabotage_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022962]] -- - Powerful electrical overload of the vehicle or building.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022963]] -- - Left click and select a building or vehicle to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022964]] -- - The selected building is rendered useless for a brief period of time (no unit production, no research).
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022965]] -- - The selected vehicle is rendered powerless for a brief period (no combat, no movement, decrease of armour rating).

GameData["ui_info"]["icon_name"] = [[inquisition_icons/sabotage_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16022960]] -- Sabotage
