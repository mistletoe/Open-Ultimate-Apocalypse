...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\chaos_wargear_upgrade_09_banner_research.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\chaos_wargear09.lua]]
