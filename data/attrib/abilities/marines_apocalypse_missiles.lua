...
GameData["child_ability_name"] = [[marines_apocalypse_missile1]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112497]] -- - The Imperial Reaver Titan unleashes a barrage of missiles at the designated target.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112498]] -- - Many missiles pour forth from the Apocalypse Missile Launcher and create a huge area of destruction..
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112499]] -- - Long ranged ability, perfect for artillery strikes and destroying key targets.

GameData["ui_info"]["icon_name"] = [[space_marine_icons/missile_volley_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18112496]] -- Apocalypse Missile Launcher Barrage
