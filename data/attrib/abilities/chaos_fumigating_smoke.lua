...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Chaos\fumigation]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Chaos\fumigation]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Chaos\fumigation]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Chaos\fumigation]]
...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\chaos_fumigation.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Releases clouds of choking gas at the targetted location.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Enemy units within the cloud suffer morale damage and reduced vision.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Does not affect buildings or relic units.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$673452]] -- - Left-click and target a location to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/fumigation_icon.tga]]

GameData["ui_info"]["screen_name_id"] = [[Fumigating Smoke]]
