...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Necron/homeportal_summon]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Necron/homeportal_summon]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Necron/homeportal_summon]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Necron/homeportal_summon]]
...
GameData["child_ability_name"] = [[necron_homeworld_portal_summon]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111664]] -- - Creates a link to your homeworld and summon the unstoppable machines of death.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111665]] -- - Each portal is summoned at the cost of high amounts of power and will be kept open to this world until attacked.
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_homeportal_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111663]] -- Summon Homeworld Portal
