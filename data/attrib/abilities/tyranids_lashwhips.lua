...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\tyranids_ht_bw_addon.lua]]
...
GameData["ui_info"]["icon_name"] = [[Tyranids_icons/i_whip]]

GameData["ui_info"]["screen_name_id"] = [[lash whip]]
