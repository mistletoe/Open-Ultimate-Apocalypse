...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211182]] -- - Dumps a large load of requisition and depletes requisition rate in exchange for maximum power production output, lasting for 60 seconds.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211183]] -- - Cannot be used simultaneously with Power Dump.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210050]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[npc/thermo_dump_requisition]]

GameData["ui_info"]["screen_name_id"] = [[$18211181]] -- Requisition Dump
