...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Boosts da speed o' dem Armored Nobz an' makes dem speedy. Da Nobz tho' takes damage if used!]]
...
GameData["ui_info"]["screen_name_id"] = [[Powa Surge]]
