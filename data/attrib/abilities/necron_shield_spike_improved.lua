...
GameData["child_ability_name"] = [[necron_shield_spike_active]]
...
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = [[addons\addon_necron_shield_spike.lua]]
...
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_shield]]
