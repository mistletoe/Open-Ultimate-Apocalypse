...
GameData["caster_damage"]["armour_damage"]["morale_damage"] = 10
GameData["caster_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["caster_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["caster_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_movement.lua]])

GameData["caster_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = -1
GameData["caster_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_general_combat.lua]])

GameData["caster_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = -1
GameData["caster_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\enable_squad_jump.lua]])
