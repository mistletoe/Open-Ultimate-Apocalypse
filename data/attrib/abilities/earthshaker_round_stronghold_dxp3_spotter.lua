GameData = Inherit([[]])
GameData["ability_cursor_event"] = [[Guard\Abilities\Basilisk_cursor]]
GameData["ability_motion_name"] = [[capture_strategic_point]]
GameData["ability_ordered_event_mp"] = [[Guard\Abilities\Basilisk_marker]]
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_12"] = Reference([[type_armour\tp_TOUGHNESS6.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_12"]["screen_name_id"] = [[$4450037]] -- Aircraft
...
GameData["child_ability_name"] = [[earthshaker_round_stronghold_dxp3_buildings_spotter]]
...
GameData["entity_busy_time"] = 10.69999981
...
GameData["projectile_spawn_pos"]["x"] = 0.009999999776
GameData["projectile_spawn_pos"]["y"] = 4.650000095
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$694601]] -- - Devastating shot that can annihilate whole squads of Infantry.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$694602]] -- - Earthshaker Rounds are custom forged on Mars and very expensive.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$694603]] -- - Each shot uses 200 Requisition and 200 Power.

GameData["ui_info"]["icon_name"] = [[guard_icons/guard_basilisk_bombardment]]

GameData["ui_info"]["screen_name_id"] = [[$694600]] -- Earthshaker Round
