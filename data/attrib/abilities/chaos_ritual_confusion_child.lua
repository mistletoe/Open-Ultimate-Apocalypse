...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- A global offensive ritual spell that sacrifices (kills) all enemy infantry units around the map 240 seconds after the ability has been casted.]]
