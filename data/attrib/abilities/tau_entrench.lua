...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["value"] = 5
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 1.5
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$671405]] -- - XV88 Broadside Battlesuits entrench into a defensive position.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$671410]] -- - Allows Broadsides to fire their powerful railguns.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$671409]] -- - Firepower and range both increase signficantly.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$671408]] -- - Entrenched units are immobile and have a minimum range.

GameData["ui_info"]["icon_name"] = [[tau_icons/tau_entrench_icon]]

GameData["ui_info"]["screen_name_id"] = [[$671404]] -- Entrench
