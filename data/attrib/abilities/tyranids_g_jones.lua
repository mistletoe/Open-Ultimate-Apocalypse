...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[tyranids\global_jones]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[tyranids\global_jones]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[tyranids\global_jones]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[tyranids\global_jones]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[tyranids\global_jones]]
...
GameData["child_ability_name"] = [[tyranids_g_jones_child]]
...
GameData["ui_hotkey_name"] = [[tyranids_g_jones]]
...
GameData["ui_info"]["screen_name_id"] = [[$16028193]] --         Darken the Skies
