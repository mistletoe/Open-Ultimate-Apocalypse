...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_05"] = Reference([[type_armour\tp_TOUGHNESS9.lua]])
...
GameData["requirements"]["required_2"]["research_name"] = [[addons\eldar_spell_shroud.lua]]
