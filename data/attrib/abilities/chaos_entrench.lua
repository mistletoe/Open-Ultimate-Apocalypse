...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210868]] -- - Toggleable support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210869]] -- - Disables melee combat and movement of the unit in exchange for rapid fire rates; improving artillery barrage amounts and quick reload times of all weapons.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210870]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/defcannon]]

GameData["ui_info"]["screen_name_id"] = [[$18210867]] -- Desecration
