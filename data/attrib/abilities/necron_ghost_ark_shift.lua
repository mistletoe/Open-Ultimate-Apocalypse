...
GameData["requirements"]["required_1"]["research_name"] = [[necron_ghost_ark_shift_research]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Timed defensive ability.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Ghost Ark Phase Shift ultimately phases all nearbye Necron units out of the material Universe, making all units immune to attacks, while also able to attack!]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_phase_shifter_icon]]

GameData["ui_info"]["screen_name_id"] = [[Ghost Ark Phase Shift]]
