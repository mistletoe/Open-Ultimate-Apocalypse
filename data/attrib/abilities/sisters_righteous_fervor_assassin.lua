...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4300074]] -- - Drives the Sister Repentia squad to fight harder, to their detriment.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4300075]] -- - Left-click to activate.  Left-click again to de-activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4300076]] -- - While active, the Sister Repentia squad will move faster and receives a damage bonus.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4300077]] -- - While active, the Sister Repentia squad will lose health.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$4300078]] -- - Beware! The Sister Repentia squad can die from this ability.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_righteous_fervor_assassin]]

GameData["ui_info"]["screen_name_id"] = [[$4300073]] -- Righteous Fervor
