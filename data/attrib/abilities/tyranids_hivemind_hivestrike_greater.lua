...
GameData["requirements"]["required_3"]["structure_name"] = [[ebps\races\tyranids\structures\tyranids_xeno_hive.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16028311]] -- - Spawn several large meteors at a targeted location.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16028312]] -- - Meteors do good damage to all enemy units and structures randomly throughout the targeted area.
...
GameData["ui_info"]["screen_name_id"] = [[$16028310]] -- Hive Mind Link: Meteor Strike
