...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[chaos\abilities\warp_storm_0]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[chaos\abilities\warp_storm_0]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[chaos\abilities\warp_storm_0]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[chaos\abilities\warp_storm_0]]
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_07"] = Reference([[type_armour\tp_TOUGHNESS6_VEHICLE.lua]])

GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_08"] = Reference([[type_armour\tp_TOUGHNESS8_VEHICLE.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["max_lifetime"] = 30
...
GameData["child_ability_name"] = [[chaos_warp_storm_super2_blast]]
...
GameData["looping_event_name"] = [[chaos\abilities\warp_storm_0_ant]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Sorcerer tries to control unimaginable power.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Does not affect buildings or daemons.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Powerful ability, but costly and slow.]]

GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_warp_storm_icon]]

GameData["ui_info"]["screen_name_id"] = [[Warp Storm]]
