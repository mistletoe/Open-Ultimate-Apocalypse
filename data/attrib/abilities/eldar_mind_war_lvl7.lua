...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 99
...
GameData["requirements"]["required_3"]["research_name"] = [[research\commander_level8_research.lua]]
