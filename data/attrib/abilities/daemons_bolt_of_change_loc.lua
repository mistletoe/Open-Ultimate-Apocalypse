...
GameData["child_ability_name"] = [[daemons_bolt_of_change_loc_child1]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000125]] -- - This spell can be used quite often, as the ranged attack of the Lord of Change.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16000375]] -- - Left click and target an enemy or the ground to activate.
