...
GameData["child_ability_name"] = [[daemons_allure_greater_effect]]
...
GameData["speech_directory"] = [[ability\allure]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16003781]] -- - Favoured Daemonettes' seducing lasts longer, and their victims are still affected even if loose sight of them.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16000389]] -- - Left click and target any enemy infantry unit to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[daemons_icons\daemons_allure_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16003780]] -- Greater Allure
GameData["ui_instructional_msg"] = [[$16003782]] -- Left-click on any enemy Infantry or Commander unit to be Allured by lusting beauty!
GameData["ui_invalid_target_msg"] = [[$16003783]] -- This ability can only be targeted directly on any Enemy Infantry or Commander units!
