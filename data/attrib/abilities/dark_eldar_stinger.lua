...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100054]] -- - Flings a barbed dart tipped with a virulent, unstable poison.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100055]] -- - Causes damage over time.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100056]] -- - Enemies that die while under the influence of the poison will explode in a burst of bone and blood, causing damage to nearby squads.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100057]] -- - Left-click and target an enemy squad to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/stinger_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4100053]] -- Stinger
