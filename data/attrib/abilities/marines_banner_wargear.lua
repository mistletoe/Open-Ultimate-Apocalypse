...
GameData["requirements"]["required_1"]["research_name_either"] = [[research\marine_wargear_upgrade_08.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\marine_wargear17.lua]]
