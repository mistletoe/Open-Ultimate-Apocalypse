...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\ability_healing1_event.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tyranids_building_miasmax2_research.lua]]
