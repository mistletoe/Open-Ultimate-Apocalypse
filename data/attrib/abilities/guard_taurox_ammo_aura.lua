...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[cosmos_custom_events\taurox_ammo_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[cosmos_custom_events\taurox_ammo_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[cosmos_custom_events\taurox_ammo_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[cosmos_custom_events\taurox_ammo_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\max_range_weapon_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 1.149999976
...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_taurox_ammo_stash_research.lua]]
