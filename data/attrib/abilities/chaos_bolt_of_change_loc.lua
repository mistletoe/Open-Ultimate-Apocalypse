...
GameData["child_ability_name"] = [[chaos_bolt_of_change_loc_child1]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Hurls three improved balls of warp energy which causes rapid mutation when it strikes, tearing armor apart.]]
