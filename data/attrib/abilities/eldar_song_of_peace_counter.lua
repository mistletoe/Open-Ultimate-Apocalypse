...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 91
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_abilities.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 91
...
GameData["speech_directory"] = [[buildstructure]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Temporarily infiltrates an allied structure encasing it in a wraithtomb, enabling self repair.]]
