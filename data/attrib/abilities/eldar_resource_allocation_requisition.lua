...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 0.05000000075
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\ability_energy_field_event.lua]])
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211231]] -- - While on: Will reduce 20% of your power income for a 10% requisition income increase.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210050]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[eldar_icons/webway_gate_resource_allocation_requisition_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211230]] -- Requisition Resource Allocation
