...
GameData["backfire_caster_damage"]["modifiers"]["modifier_01"]["max_lifetime"] = 2
GameData["backfire_caster_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\morale_rate_squad_modifier.lua]])
...
GameData["caster_damage"]["armour_damage"]["morale_damage"] = 160
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_psy_power_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022398]] -- - Offensive ability. (Costs 160 morale)
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022336]] -- - Left-click and target an enemy unit/structure to activate!

GameData["ui_info"]["icon_name"] = [[inquisition_icons/fireball_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16022397]] -- Spell: Fireball
