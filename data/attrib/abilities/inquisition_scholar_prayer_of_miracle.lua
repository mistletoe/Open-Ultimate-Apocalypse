...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_tome_invigorate_soul.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021223]] -- - Timed support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021224]] -- - When activated, all infantry squads around the globe will not be able to take physical or morale damage for 6 seconds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021225]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_prayer_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16021222]] -- Prayer of Miracles
