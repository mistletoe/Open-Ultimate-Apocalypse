...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_08"] = Reference([[type_armour\tp_TOUGHNESS3.lua]])
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_11"] = Reference([[type_armour\tp_TOUGHNESS8.lua]])
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_14"] = Reference([[type_armour\tp_TOUGHNESS8_VEHICLE.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$694501]] -- - Allows the Command Squad to call in an Air Strike.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$694502]] -- - Air Strikes are devastating barrages that can destroy entire squads.
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_captain_strafing_run]]

GameData["ui_info"]["screen_name_id"] = [[$694500]] -- Strafing Run
