...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16028231]] --  - A psychic ability that forces Tyranids to fight on, even when they should fall.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16028233]] --  - Left-click to activate a short range aura for a short duration.
GameData["ui_info"]["icon_name"] = [[Tyranids_icons/i_catalyst]]

GameData["ui_info"]["screen_name_id"] = [[$16028234]] --  Hive Tyrant Catalyst
