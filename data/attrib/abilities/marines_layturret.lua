...
GameData["fire_cost"]["requisition"] = 140
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211443]] -- - Offensive Targetable ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211444]] -- - Call down a drop pod which will unload a defensive placement from space!
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211445]] -- - Deployed drop pod will impact the targeted area with moderate damage. Keep your squads away from impact!
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18211441]] -- - Left-click and target an enemy or ground to activate!

GameData["ui_info"]["icon_name"] = [[space_marine_icons/rhino_deploy_turret_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211442]] -- Deploy Turret
