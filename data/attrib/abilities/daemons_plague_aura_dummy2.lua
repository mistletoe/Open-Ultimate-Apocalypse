...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[unit_ability_fx/daemon_plague]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[unit_ability_fx/daemon_plague]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[unit_ability_fx/daemon_plague]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[unit_ability_fx/daemon_plague]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 2.5
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 2.5
