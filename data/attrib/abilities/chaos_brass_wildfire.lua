...
GameData["area_effect"]["area_effect_information"]["radius"] = 23
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112443]] -- - The Brass Scorpion uses its tail like a whip to disrupt enemies around it, easily cutting through titanic armor.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112444]] -- - The tail shoots flames within the circle traced by the attack, hurting infantry morale.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112445]] -- - Left click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/wildfire_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18112442]] -- Death Whirlwind
