...
GameData["backfire_caster_damage"]["armour_damage"]["morale_damage"] = 400
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_psy_power_9.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022383]] -- - Anti vehicle offensive ability | Duration: 10 seconds. (Costs 300 morale)
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022386]] -- - Left-click and target an enemy vehicle to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/doom_machine_ability]]

GameData["ui_info"]["screen_name_id"] = [[$16022382]] -- Spell: Doom of the Machine Spirit
