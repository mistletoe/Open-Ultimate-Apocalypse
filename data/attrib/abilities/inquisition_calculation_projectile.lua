...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 0.8999999762
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021293]] -- - Finds and calculates the coordinates of every single enemy projectile on the globe, allowing for preparation tactics.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021294]] -- - Increases ranged damage resistance for all allied units.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021291]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/idh_calculate_coordinate_projectile]]

GameData["ui_info"]["screen_name_id"] = [[$16021292]] -- Calculation: Projectile Coordinate
