...
GameData["anticipation_event_name"] = [[tyranids\spore_drop]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 56
...
GameData["child_ability_name"] = [[tyranids_hivemind_hivestrike_child2]]
