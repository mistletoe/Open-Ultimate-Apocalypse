...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[unit_fx/reinforce_ravener]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[unit_fx/reinforce_ravener]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[unit_fx/reinforce_ravener]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[unit_fx/reinforce_ravener]]
...
GameData["fire_cost"]["requisition"] = 75
...
GameData["requirements"]["required_1"]["structure_name_either"] = [[ebps\races\tyranids\structures\tyranids_relic_hive.lua]]
GameData["requirements"]["required_1"]["structure_name_or"] = [[ebps\races\tyranids\structures\tyranids_warrior_hive.lua]]
...
GameData["requirements"]["required_4"]["structure_name"] = [[ebps\races\tyranids\structures\tyranids_hq.lua]]
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\tyranids_tunnel.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- An emplacement used to hold Tyranid units and Trygons underground.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Shares the same squad types of units being held within all Tunnels.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Tunnels can spawn Raveners and Trygons.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Left-click and target a ground location to activate!]]

GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_tunnel_ability]]

GameData["ui_info"]["screen_name_id"] = [[Spawn Tunnel Link]]
