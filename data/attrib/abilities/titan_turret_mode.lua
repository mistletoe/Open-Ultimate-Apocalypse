...
GameData["child_ability_name"] = [[titan_turret_mode_bumper]]
...
GameData["ui_info"]["icon_name"] = [[npc/titan_stomp_mode_icon]]

GameData["ui_info"]["screen_name_id"] = [[Titan Stomp Mode]]
