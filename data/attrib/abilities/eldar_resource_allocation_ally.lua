...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\garrison_requisition_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211216]] -- - Global allied/enemy support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211217]] -- - Exchange resources to enhance an ally or enemy Listening Post, providing it with more req income.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211218]] -- - Does not work on any other structure besides Listening Posts!
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18211220]] -- - Left-click and target a Listening Post, whether enemy or ally to activate!

GameData["ui_info"]["icon_name"] = [[eldar_icons/webway_gate_resource_allocation_ally_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211215]] -- Allocate Resources To Ally
