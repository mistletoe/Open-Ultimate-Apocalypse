...
GameData["ability_ordered_event_mp"] = [[Tau\Abilities\ION_Cannon_Warmup]]
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_01"]["screen_name_id"] = [[$4450037]] -- Aircraft
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_12"] = Reference([[type_armour\tp_TOUGHNESS6_VEHICLE.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 375
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$3950242]] -- - Fires a powerful Ion blast.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$3950243]] -- - Effective against infantry and vehicles.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$3950244]] -- - Left-click and target ground to activate.

GameData["ui_info"]["icon_name"] = [[tau_icons/lasergun_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[$3950241]] -- Fire Orbital Defense cannons
