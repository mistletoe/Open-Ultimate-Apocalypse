...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[aura/inquisitor_lord_command_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[aura/inquisitor_lord_command_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[aura/inquisitor_lord_command_aura]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[aura/inquisitor_lord_command_aura]]
