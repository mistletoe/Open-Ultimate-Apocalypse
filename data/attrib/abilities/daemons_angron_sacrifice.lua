...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\population_growth_rate_player_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000420]] -- - Sacrifices an ally minion squad to empower Angron once again!
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000421]] -- - Leeches health, and quickly restores morale, the stronger and more durable the sacrifice is. Also greatly increases the relic resource rate!
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16000423]] -- - Left-click and target an ally minion to activate.

GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_angron_khorne_sacrifice_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000419]] -- Khorne's Sacrifice
