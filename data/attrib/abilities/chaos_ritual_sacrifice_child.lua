...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_10"] = Reference([[type_armour\tp_TOUGHNESS7.lua]])
...
--REPLACE_ME
GameData["area_effect"]["weapon_damage"]["armour_damage"]["life_leech_damage"] = 50
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210856]] -- - The ritual of Sacrifice will continuously leach the blood of all infantry units throughout the globe, slowly killing them with reduced movement speeds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210857]] -- - The Chaos Sorceror so as as he is using the ritual will regenerate his health back to full strength very quickly, especially the number of infantry units on the battlefield.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210858]] -- - DOES NOT work on vehicles and structures.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$91543]] -- - Left-click to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[chaos_icons/ritual_sacrifice_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210855]] -- Ritual: Sacrifice
