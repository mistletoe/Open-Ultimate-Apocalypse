...
GameData["area_effect"]["throw_data"]["force_max"] = 18
GameData["area_effect"]["throw_data"]["force_min"] = 18
...
GameData["child_ability_name"] = [[necron_shroud_of_antigravity_noaction]]
