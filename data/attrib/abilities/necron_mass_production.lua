...
GameData["child_ability_name"] = [[necron_mass_production_child1]]
...
GameData["looping_event_name"] = [[necron\abilities\necron_productiongrid]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210417]] -- - Toggleable/Support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210418]] -- - If turned on, the user will project an aura over all objects within a 20m radius, buffing health regeneration and granting the user a 6x production bonus with slight ranged protection.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210419]] -- - Decreases nearby enemy vision and keen sight and allows the monolith to detect infiltrators, but disables movement of the user.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210420]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[necron_icons/necron_production_grid_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18210416]] -- Production Grid
