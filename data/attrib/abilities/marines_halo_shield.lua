...
GameData["requirements"]["required_2"]["research_name_either"] = [[research\marine_wargear06.lua]]
GameData["requirements"]["required_2"]["research_name_or"] = [[research\marine_wargear14.lua]]
