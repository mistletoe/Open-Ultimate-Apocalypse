...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4500044]] -- - Drops a bomb carrying a virulent plague that can spread through the enemy's ranks in seconds.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4500036]] -- - The plague can also spread to friendly troops.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4500037]] -- - Left-click and target enemy squads to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/biotoxin_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4500043]] -- Biotoxin Bomb
