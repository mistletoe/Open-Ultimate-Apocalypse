...
GameData["area_effect"]["area_effect_information"]["radius"] = 28
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16003421]] -- - The Daemon Prince exhales a volatile cloud of gas that instantly ignites, consuming everything in its path.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16003422]] -- - Additionally a loud, terrifying roar cripples the morale of all troops.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16003423]] -- - Causes massive damage, especially effective against any infantry.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16003424]] -- - Left-click and target an enemy unit to activate.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16003425]] -- 
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_prince_scream.tga]]

GameData["ui_info"]["screen_name_id"] = [[$16003420]] -- Breath Of Chaos
