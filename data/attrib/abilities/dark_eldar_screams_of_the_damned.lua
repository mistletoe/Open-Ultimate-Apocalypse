...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Dark_Eldar\SA_Speedfrenzy]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Dark_Eldar\SA_Speedfrenzy]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Dark_Eldar\SA_Speedfrenzy]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Dark_Eldar\SA_Speedfrenzy]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Dark_Eldar\SA_Speedfrenzy]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Hastens the agility and stamina of all units with powerful dark energies.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Temporarily boosts the movement speed of all units.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100040]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/speed_frenzy_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[Speed Frenzy]]
