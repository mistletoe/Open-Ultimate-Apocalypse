...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 1999
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Dark_Eldar\SA_Damnation]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Dark_Eldar\SA_Damnation]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Dark_Eldar\SA_Damnation]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Dark_Eldar\SA_Damnation]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Dark_Eldar\SA_Damnation]]
...
GameData["range"] = 2000
GameData["recharge_time"] = 122
GameData["recharge_timer_global"] = true 
GameData["recharge_timer_id"] = 0
GameData["refresh_time"] = 120
GameData["requirements"] = Reference([[tables\requirements.lua]])
GameData["requirements"]["required_1"] = Reference([[requirements\required_structure.lua]])
GameData["requirements"]["required_1"]["structure_name"] = [[ebps\races\dark_eldar\structures\dark_eldar_soul_cage.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_structure.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["structure_name"] = [[ebps\races\dark_eldar\structures\dark_eldar_hq_sp_dxp3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111942]] -- - Targeted enemy unit suffers drastic health, morale, movement, combat, and overall regeneration penalties. Target will be killed almost instantly if the target is low on health.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100077]] -- - Left-click and target an enemy unit to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/eternal_agony_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18111941]] -- Eternal Agony
