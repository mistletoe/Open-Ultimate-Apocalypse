...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4300015]] -- - The Sisters are blessed with the favor of the Emperor.  Enemies who attack the blessed squad invoke the Emperor's divine retribution.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4300016]] -- - Returns damage inflicted on the affected squad to their attackers.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4300012]] -- - Left-click to activate.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4300018]] -- - Costs Faith to use.

GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_divine_retribution]]

GameData["ui_info"]["screen_name_id"] = [[$4300014]] -- Act of Faith: Divine Retribution
