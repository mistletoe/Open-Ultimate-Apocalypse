...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_07"] = Reference([[type_armour\tp_TOUGHNESS6.lua]])
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_14"] = Reference([[type_armour\tp_TOUGHNESS10_BUILDING.lua]])

GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_15"] = Reference([[type_armour\tp_TOUGHNESS10_VEHICLE.lua]])
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021296]] -- - Finds and calculates the coordinates of every single enemy life form on the globe, allowing for preparation tactics.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021297]] -- - Has a chance in revealing an enemy unit in random locations.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021291]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[inquisition_icons/idh_calculate_coordinate_entity]]

GameData["ui_info"]["screen_name_id"] = [[$16021295]] -- Calculation: Entity Coordinate
