...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704501]] -- - Causes the Energy Auxiliary to send out a concentrated burst of magnetic energy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704502]] -- - All enemy units in the path of the blast are thrown aside and take heavy damage.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_kinetic_blast_icon]]

GameData["ui_info"]["screen_name_id"] = [[$704500]] -- Magnetic Blast
