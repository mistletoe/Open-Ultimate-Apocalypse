...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_03"] = Reference([[type_armour\tp_TOUGHNESS1.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 400
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704651]] -- - High-powered shot that can pierce almost any armor type.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704652]] -- - Can only be fired intermitently to prevent over-heating of the XV22's weapon systems.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$704653]] -- - Left-click and target an enemy squad.

GameData["ui_info"]["icon_name"] = [[tau_icons/tau_target_acquired_icon]]

GameData["ui_info"]["screen_name_id"] = [[$704650]] -- Target Acquired
