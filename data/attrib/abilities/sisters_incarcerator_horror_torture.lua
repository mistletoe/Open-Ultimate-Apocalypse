...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 75
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\ability_tau_shield_event.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\ability_turbo_boost_event.lua]])
...
GameData["speech_directory"] = [[ability/witch_hunters_incarcerator_horror_torture]]
GameData["target_ground"] = false
GameData["target_leader_in_squad"] = false
GameData["target_self"] = false
GameData["ui_hotkey_name"] = [[marine_techmarine]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211934]] -- Horror Torture
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211935]] -- - Tortures the daemon inside to harness it's power.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211936]] -- - Decreases weapons reload at the expense of damageing the vehicle.

GameData["ui_info"]["icon_name"] = [[sisters_icons/witch_hunters_incarcerator_horror_torture_icon]]
