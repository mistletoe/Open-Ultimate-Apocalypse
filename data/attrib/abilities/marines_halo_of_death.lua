...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\eldar_to_war_event.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\marine_wargear09.lua]]
