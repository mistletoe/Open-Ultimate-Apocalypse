...
GameData["requirements"]["required_1"]["research_name"] = [[research\sisters_flashbang_grenade_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_flash_grenades]]
