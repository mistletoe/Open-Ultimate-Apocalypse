...
GameData["child_ability_name"] = [[tau_bumpertank_kroot_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210804]] -- - Kroot units will ram into enemy units at the cost of nothing but weapon accuracy and a longer recharge time as it will tire the kroot units out.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210805]] -- - For a duration, all kroot charging at the enemy will gain a 100% movement speed bonus with a medium knockback range wherever the units may go.
...
GameData["ui_info"]["screen_name_id"] = [[$18210803]] -- CHARGE!!!
