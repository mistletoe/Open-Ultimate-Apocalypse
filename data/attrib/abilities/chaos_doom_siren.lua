...
GameData["ui_hotkey_name"] = [[chaos_doomsiren]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91811]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Self targeted offensive ability.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Shout of the Noise Marine Champion will demoralize the morale of any enemy squad within a 60m radius.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$91813]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[chaos_icons/doom_siren_icon]]

GameData["ui_info"]["screen_name_id"] = [[Doom Siren]]
