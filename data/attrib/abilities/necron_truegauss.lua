...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 3.5
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210388]] -- - Support ability, extremely useful for engaging targets within movement range.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210389]] -- - Squad will receive an overwhelming boost in firepower for a duration but with a penalty of movement speed.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210390]] -- - Left-click to activate!

GameData["ui_info"]["icon_name"] = [[necron_icons/upgrade_gauss]]

GameData["ui_info"]["screen_name_id"] = [[$18210387]] -- Gauss Weapon Overcharge
