...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_screaming_jets.lua]])

GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"] = Reference([[modifiers\enable_squad_jump.lua]])
