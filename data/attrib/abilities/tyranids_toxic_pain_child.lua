...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\income_requisition_player_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92333]] -- - Left-click to activate.  Left-click again to deactivate.
