...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[ability_necron_chronometron_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[ability_necron_chronometron_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[ability_necron_chronometron_event]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[ability_necron_chronometron_event]]
...
GameData["area_effect"]["weapon_damage"]["hit_entity_event_name"] = [[ability_necron_chronometron_event]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["max_lifetime"] = 120
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_vision_granting.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["max_lifetime"] = 120
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["max_lifetime"] = 120
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\ability_necron_chronometron_event.lua]])
...
GameData["child_ability_name"] = [[tyranids_genestealer_infect_child1]]
...
GameData["entity_busy_time"] = 1.669999957
...
GameData["looping_event_name"] = [[ability_necron_chronometron_event]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100076]] -- - Attaches a device that grants vision through the enemy unit's eyes.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100077]] -- - Left-click and target an enemy unit to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/tracking_device_icon]]

GameData["ui_info"]["screen_name_id"] = [[$4100075]] -- Tracking Device
