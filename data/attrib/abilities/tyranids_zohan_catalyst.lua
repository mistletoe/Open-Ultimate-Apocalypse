...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 16
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Activate a wide aura catalyst affect that will allow your army nearby to fight on even when they should fall.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- While active, all nearby ally units within the area of affect cannot die, will heal faster than normal, and receive bioshield morale immunity for a duration.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Left-click to activate.]]

GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_catalyst]]

GameData["ui_info"]["screen_name_id"] = [[$16028230]] --  Zoanthrope Catalyst
