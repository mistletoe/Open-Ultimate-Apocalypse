...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4300047]] -- - Invoking the might of the Holy Ecclesiarchy, the Confessor pronounces his judgement, before which few can stand defiant.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4300048]] -- - Stuns an enemy squad.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4300049]] -- - Left-click and target enemy infantry to activate.

GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_divine_pronouncement]]

GameData["ui_info"]["screen_name_id"] = [[$4300046]] -- Act of Faith: Holy Edict
