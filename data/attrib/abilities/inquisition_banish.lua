...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[abilities\exterminatus]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[abilities\exterminatus]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[abilities\exterminatus]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[abilities\exterminatus]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[abilities\exterminatus]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\enable_squad_morale_damage.lua]])
...
GameData["child_ability_name"] = [[inquisition_banish_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021244]] -- - The squad chants away at a targeted daemonic creature.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021245]] -- - After a 15 second period of chanting the doom of the daemon, the daemonic squad gets killed; banished in the process, never to return!
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021246]] -- - If a Greater Daemon was targeted instead, that daemonic embodiment becomes paralyzed for several seconds, losing the ability to see, attack, use abilities, or fly away.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021247]] -- - 15 seconds in length, the casters cannot move or do anything throughout the duration.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16021248]] -- - Left-click and target a daemonic squad or greater daemon to activate!
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_banish_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16021243]] -- Banish
