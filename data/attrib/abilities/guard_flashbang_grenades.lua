...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_flashbang_grenade_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_flash_grenade_icon]]
