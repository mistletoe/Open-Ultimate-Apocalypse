...
GameData["requirements"]["required_1"]["structure_name_either"] = [[ebps\races\tyranids\structures\tyranids_biomorph_hive.lua]]
GameData["requirements"]["required_1"]["structure_name_or"] = [[ebps\races\tyranids\structures\tyranids_xeno_hive.lua]]
