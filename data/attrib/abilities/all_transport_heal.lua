...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211259]] -- - Support ability, will provide all nearby infantry with immediate medical attention, regenerating their health over time.
...
GameData["ui_info"]["icon_name"] = [[npc/transport_health_recovery_icon]]

GameData["ui_info"]["screen_name_id"] = [[$18211258]] -- Transport Ability: Medical Aid
