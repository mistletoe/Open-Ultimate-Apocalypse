...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_krak_grenades_research.lua]]
...
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_krak_grenade_icon_improved]]
