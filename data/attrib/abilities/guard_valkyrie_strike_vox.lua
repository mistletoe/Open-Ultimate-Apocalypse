...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112142]] -- - The commanding officer calls for an off-field Valkyrie airship to initiate bombing run.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112143]] -- - The Valkyrie unloads a devastating payload at the marked location which annihilates all within the area of effect.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112144]] -- 

GameData["ui_info"]["icon_name"] = [[guard_icons/guard_valkyrie_strike]]

GameData["ui_info"]["screen_name_id"] = [[$18112141]] -- Valkyrie Bombing Run
