...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100110]] -- - Infuses your production facilities with a hunger for battle, vastly increasing their work speed for a duration.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100111]] -- - Units are produced more quickly.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4100112]] -- - Squads reinforce more quickly.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100113]] -- - Left-click to activate.

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/fast_production_icon]]
GameData["ui_info"]["no_button"] = true 

GameData["ui_info"]["screen_name_id"] = [[$4100109]] -- War Frenzy
