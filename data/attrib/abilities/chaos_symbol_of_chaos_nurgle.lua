...
GameData["requirements"]["required_2"]["research_name"] = [[research\chaos_mark_nurgle_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Units have increased health and faster health regeneration]]
