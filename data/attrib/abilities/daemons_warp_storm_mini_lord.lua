...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000402]] -- - Cast a powerful maelstorm of destruction at a designated target.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000403]] -- - Executes a small radius of lightning strikes and unleashes a volley of meteors!
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000404]] -- - Left-click and target an enemy or location to activate!

GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_warp_storm_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000401]] -- Summon Mini Warp Storm
