...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_fleet_of_foot_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210403]] -- - Order the squad to run.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210404]] -- - Increases movement speed by 45% in exchange for weapon accuracy. 
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210405]] -- - Lasts for 10 seconds, 2 second cooldown after use.

GameData["ui_info"]["icon_name"] = [[command_icons/ability_run]]

GameData["ui_info"]["screen_name_id"] = [[$18210402]] -- RUN!!!
