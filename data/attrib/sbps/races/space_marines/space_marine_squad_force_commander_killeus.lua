...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\space_marines\troops\force_commander_killeus.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\marine_chapter_bloodravens_research.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011739]] -- - Primary commander unit.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011740]] -- - Durability: Excellent | Strength: Very Good | Morale: Plenty | Upgrades: Promotion, Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Abilities: Good | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/forcecommander_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011738]] -- Force Commander
