...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011817]] -- - (Deepstrike) Elite armored walker vehicle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011818]] -- - Durability: Excellent | Strength: Very Good | Morale: Immune | Squad Size: Single | Upgrades: Few | Movement Speed: Standard | Sight: Good | Keen Sight: None | Abilities: None | Weapon range: Good | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/ven_dread_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011816]] -- Venerable Dreadnought
