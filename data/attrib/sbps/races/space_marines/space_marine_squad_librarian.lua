...
GameData["squad_jump_ext"]["requirements"]["required_1"]["research_name"] = [[research\marine_jumppack_research.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011748]] -- - Support commander (detector).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011749]] -- - Durability: Good | Strength: Good | Morale: Average | Upgrades: Spells, Hero Wargear | Squad Size: Single | Movement Speed: Standard-Fast (Jumppack) | Sight: Very Good | Keen Sight: 25m | Abilities: Excellent| Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/librarian_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011747]] -- Chief Librarian
