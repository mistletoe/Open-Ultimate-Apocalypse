...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011733]] -- - Primary commander unit.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011734]] -- - Durability: Excellent | Strength: Excellent | Morale: Plenty | Upgrades: Promotion, Hero Wargear | Squad Size: Single | Movement Speed: Standard - Fast (Jumppack) | Sight: Good | Keen Sight: 2m | Abilities: Good | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/gladeus_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011732]] -- Brother Captain
