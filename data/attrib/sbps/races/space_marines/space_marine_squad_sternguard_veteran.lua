...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\space_marines\troops\sternguard_veteran.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011775]] -- - Elite ranged unit. ~~~ Has various training in both melee and ranged (especially) combat.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011776]] -- - Durability: Good | Strength: Very Good | Morale: 7.5 | Upgrades: 14 | Squad Size: Small | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: Yes.
...
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/sternguard_veteran_icon]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011774]] -- Sternguard Veterans
