...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012046]] -- - (Deepstrike) Armored elite ranged infantry. ~~~ Can teleport.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012047]] -- - Durability: Excellent | Strength: Excellent | Morale: Plenty | Upgrades: A lot | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard | Keen Sight: 2m | Abilities: Basic | Weapon range: Good | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012048]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/terminator_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012045]] -- Terminators
