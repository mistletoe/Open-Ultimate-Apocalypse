...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$581300]] -- - Honor Guard unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$701602]] -- - Anti-Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$701603]] -- - Dreadnought variant that foregoes close combat for more ranged weaponry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$701601]] -- - Fires rockets that do area effect damage and disrupt enemy Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$701600]] -- - Effective at dealing with massed Infantry.
--INTENTIONAL SPACER
