...
GameData["squad_reinforce_ext"]["cost"]["cost"]["power"] = 95
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011789]] -- - Scout vehicle. ~~~ Can vault over impassable terrain.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011790]] -- - Durability: Average | Strength: Average | Squad Size: Single | Upgrades: A lot | Morale: Immune | Movement Speed: Extreme | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/landspeeder_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011788]] -- Landspeeder
