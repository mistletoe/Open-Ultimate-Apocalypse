...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011813]] -- - Armored walker vehicle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011814]] -- - Durability: Very Good | Strength: Good | Morale: Immune | Squad Size: Single | Upgrades: Few | Movement Speed: Slow | Sight: Standard | Keen Sight: None | Abilities: Below Average | Weapon range: Good | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011815]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/dreadnought_ironclad_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011812]] -- Ironclad Dreadnought
