...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["squad_table"]["squad_02"] = [[races\space_marines\space_marine_squad_chaplain_advance_sp.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011745]] -- - Secondary / healer commander (detector). ~~~ Heals nearby units over time.
