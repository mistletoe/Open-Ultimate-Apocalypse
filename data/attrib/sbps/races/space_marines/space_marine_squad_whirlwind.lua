...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011805]] -- - Durability: Good | Strength: Very Good | Squad Size: Single | Upgrades: Few | Morale: Immune | Movement Speed: Fast | Sight: Excellent | Keen Sight: None | Abilities: Below Average | Weapon range: Artillery | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011806]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/whirlwind_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011803]] -- Whirlwind MK I
