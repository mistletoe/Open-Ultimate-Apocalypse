...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\space_marines\troops\terminator_sergeant.lua]]
GameData["squad_leader_ext"]["leader_2"]["add_while_moving"] = true 
GameData["squad_leader_ext"]["leader_2"]["cost_time"]["cost"]["power"] = 50
GameData["squad_leader_ext"]["leader_2"]["cost_time"]["cost"]["requisition"] = 250
GameData["squad_leader_ext"]["leader_2"]["cost_time"]["time_seconds"] = 25
GameData["squad_leader_ext"]["leader_2"]["leader"]["type"] = [[ebps\races\space_marines\troops\terminator_apothecary.lua]]
GameData["squad_leader_ext"]["leader_3"]["add_while_moving"] = true 
GameData["squad_leader_ext"]["leader_3"]["cost_time"]["cost"]["power"] = 50
GameData["squad_leader_ext"]["leader_3"]["cost_time"]["cost"]["requisition"] = 250
GameData["squad_leader_ext"]["leader_3"]["cost_time"]["time_seconds"] = 25
GameData["squad_leader_ext"]["leader_3"]["leader"]["type"] = [[ebps\races\space_marines\troops\terminator_banner_bearer.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012050]] -- - (Deepstrike) Armored elite melee infantry. ~~~ Can teleport.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012051]] -- - Durability: Excellent | Strength: Excellent.5 | Morale: Plenty | Upgrades: None | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard | Keen Sight: 2m | Abilities: Basic | Weapon range: Good | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18012048]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/terminator_assault_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012049]] -- Assault Terminators
