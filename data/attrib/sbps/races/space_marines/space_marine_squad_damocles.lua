...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011795]] -- - Vehicle (detector). ~~~ Protects all nearby ally units from ranged attacks and boosts their damage outputs; uses an assortment of map control abilites that jams enemy sensors or reveals the FOW.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011796]] -- - Durability: Good | Strength: Average | Squad Size: Single | Morale: Immune | Movement Speed: Fast | Sight: Very Good | Keen Sight: 20m | Abilities: Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/damocles_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011794]] -- Damocles
