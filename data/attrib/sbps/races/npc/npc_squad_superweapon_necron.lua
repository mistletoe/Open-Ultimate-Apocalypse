...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["addon_name"] = [[addons\addon_necron_pyramid_engaged.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$15043232]] -- Construct Superweapon
