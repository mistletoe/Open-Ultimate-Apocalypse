...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011500]] -- - Flame tank. ~~~ Can upgrade with a very deadly weapon, the chemical cannon.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011501]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: Few | Morale: Immune | Movement Speed: Fast | Sight: Standard | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_hellhound]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011499]] -- Hellhound
