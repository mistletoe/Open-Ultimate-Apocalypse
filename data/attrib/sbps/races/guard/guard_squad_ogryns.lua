...
GameData["squad_leader_ext"]["leader_1"]["cost_time"]["cost"]["requisition"] = 180
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011482]] -- - Elite melee monsters.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011483]] -- - Durability: Average | Strength: Good | Squad Size: Below Standard | Upgrades: None | Morale: Average | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: None | Weapon range: Short | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011484]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_ogryns]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011481]] -- Ogryns
