...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\guard\troops\guard_reaver_lucius_full_titan.lua]]
...
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["default"] = 3750
GameData["squad_morale_ext"]["max"] = 3750
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012373]] -- - Medium class battle titan. ~~~ Contains titanic shielding that will recharge when idle or disabled.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012374]] -- 
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012372]] -- Lucius Pattern Reaver Titan
