...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\guard\troops\guard_vehicles_stormlord.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011538]] -- - Relic unit. (Transport: 2)
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011533]] -- - Durability: Excellent | Strength: Excellent | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Standard | Sight: Excellent | Keen Sight: None | Abilities: None | Weapon range: Very Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_stormlord]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012131]] -- Stormlord
