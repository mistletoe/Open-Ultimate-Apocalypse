...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\guard\troops\guard_vehicles_marauder_vigilant.lua]]
...
GameData["squad_ui_ext"]["multi_select_priority"] = 40
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012238]] -- - Scout aircraft (detector). ~~~ Can jump to any location on the map; support unit that can jam or strengthen sight ranges.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012239]] -- - Durability: Basic | Strength: Basic | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Extreme | Sight: Excellent | Keen Sight: 15m | Abilities: Basic | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/marauder_vigilant_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012237]] -- Marauder Vigilant
