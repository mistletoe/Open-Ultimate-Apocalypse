...
GameData["squad_requirement_ext"]["requirements"]["required_11"]["squad_table"]["squad_02"] = [[races\guard\guard_squad_priest.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011451]] -- - Durability: Basic | Strength: Basic | Morale: Average | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 25m | Abilities: Average | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_psyker]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011449]] -- Psyker
