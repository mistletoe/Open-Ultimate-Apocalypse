...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\space_marines\troops\guard_warhound_titan.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[npc\sm_warhound_titan_icon]]
--INTENTIONAL SPACER
