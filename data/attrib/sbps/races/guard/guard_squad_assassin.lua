...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011459]] -- - Long ranged assassin (infiltrator).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011460]] -- - Durability: Average | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Very Good | Keen Sight: 2m | Abilities: Average | Weapon range: Very long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_assassin]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011458]] -- Vindicare Assassin
