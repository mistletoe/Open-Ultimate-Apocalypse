...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\guard\troops\guard_leaders_priest_sp_dxp3_prisoner.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$693700]] -- - Infantry Commander.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$693701]] -- - Inspire their squads to fight courageously.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$693702]] -- - Add hitpoints and morale to any squad they are attached to.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$693707]] -- - Increase the damage output of any squad they are attached to.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$693708]] -- - Their Fanaticism ability can make their squads temporarily invulnerable.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_priest]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$693704]] -- Priest
