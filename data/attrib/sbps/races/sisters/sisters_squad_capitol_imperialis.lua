...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_capitol_imperialis.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["structure_name"] = [[ebps\races\sisters\structures\sisters_capitol_building.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012330]] -- - Armed mobile production unit. (Heavy Transport: 6) (faithful unit). ~~~ Contains void shields that can be recharged when idle | able to produce units faster than any structure (while doors deployed) | bulldozes structures within a set radius
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012331]] -- - Durability: Very Excellent | Strength: Very Good | Morale: Very Good | Upgrades: None | Squad Size: Single | Movement Speed: Slow | Sight: Excellent | Keen Sight: None | Abilities: Below Average | Weapon Range: Artillery | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Masterofroflness (donator of $20) ~~~ Will you add Shrek?]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_capitol_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012329]] -- Mobile Capitol Imperialis
