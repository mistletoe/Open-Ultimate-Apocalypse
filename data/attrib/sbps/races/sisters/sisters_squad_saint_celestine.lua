...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_saint_celestine.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012390]] -- - Offensive Commander Unit (faithful unit). ~~~ Can vault over impassable terrain; can revive herself after death by miraculous intervention.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012391]] -- - Durability: Very Good | Strength: Excellent | Squad Size: Single | Upgrades: Hero Researches | Morale: Immune | Movement Speed: Fast | Sight: Very Good | Keen Sight: 15m | Abilities: Good| Weapon Range: Melee | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012392]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/sisters_saint_celestine]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012389]] -- Saint Celestine
