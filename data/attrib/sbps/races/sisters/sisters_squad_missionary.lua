...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["structure_name"] = [[ebps\races\sisters\structures\sisters_holy_reliquary.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011668]] -- - Attachable support unit (faithful unit). ~~~ Provides squads with a quantity of useful faith abilities.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011669]] -- - Durability: Basic | Strength: Basic | Squad Size: Single | Upgrades: None | Morale: Basic | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Average | Weapon range: Standard | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_missionary]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011667]] -- Missionary
