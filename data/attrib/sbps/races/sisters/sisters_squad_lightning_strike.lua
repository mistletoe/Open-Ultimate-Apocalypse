...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_lightning_strike.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011844]] -- - Aircraft unit. ~~~ Can jump to any location on the map.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011845]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Extreme | Sight: Very Good | Keen Sight: None | Abilities: Below Average | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/lightning_strike]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011843]] -- Lightning Strike
