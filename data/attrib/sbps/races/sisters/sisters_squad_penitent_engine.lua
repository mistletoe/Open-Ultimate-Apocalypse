...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011716]] -- - Elite melee or ranged vehicle. ~~~ Use flamers (ranged weapons) for morale/structure/or daemon carnage; melee for everything else.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011717]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_penitent_engine]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011715]] -- Penitent Engine
