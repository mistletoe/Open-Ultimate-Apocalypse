...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\sisters\troops\sisters_veteran_superior_celestian_hg_dxp3.lua]]
...
GameData["squad_leader_ext"]["leader_2"]["leader"]["type"] = [[ebps\races\sisters\troops\sisters_celestian_imagifer_hg_dxp3.lua]]
GameData["squad_leader_ext"]["max_leaders"] = 2
GameData["squad_leader_ext"]["multi_with_reinforce"] = true 
GameData["squad_leader_ext"]["multi_with_upgrades"] = true 
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_celestian_hg_dxp3.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4250177]] -- - Best of the best heavy infantry, hailing from the finest convents on Ophelia VII.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4250178]] -- - Requisitioned to serve in Canoness Agna's personal retinue.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4250179]] -- - Heavily armored troops equipped with Krak grenades and heavy weapons.
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/HG_squad_celestian]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$4250175]] -- Ophelian Celestian Squad
