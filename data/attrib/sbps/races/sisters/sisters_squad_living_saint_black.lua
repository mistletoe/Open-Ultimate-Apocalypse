...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_living_saint_black.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012513]] -- - Relic unit (detector). ~~~ Can vault over impassable terrain; can revive herself after death by miraculous intervention; will reduce faith income whilst alive.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18012514]] -- - Living Saint of damnation | has an aura of protection, making all units near her more tanky, and is exceptionally tanky compared to the other angels herself.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012515]] -- - Durability: Excellent | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Average | Sight: Very Good | Keen Sight: 15m | Abilities: Good| Weapon Range: Melee | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/living_saint_merciless_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012110]] -- Saint Arabella
