...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\sisters\troops\sisters_veteran_superior_hg_dxp3.lua]]
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\sisters\troops\sisters_battle_sister_hg_dxp3.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4250167]] -- - Intense additional training and wide-ranging battlefield experience are minimum requirements for the elite Prioris Battle Sisters, guardians of the Order of the Sacred Rose's convent.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4250168]] -- - Requisitioned to serve in Canoness Agna's personal retinue.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4250169]] -- - Has access to many weapon upgrades, including anti-morale Phosphor Grenades.
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$4250165]] -- Battle Sister Prioris Squad
