...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011662]] -- - Commander unit (faithful unit).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011663]] -- - Durability: Average | Strength: Average | Squad Size: Single | Upgrades: 10 + Hero Researches | Morale: Average | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Abilities: Average | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_canoness]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011661]] -- Canoness
