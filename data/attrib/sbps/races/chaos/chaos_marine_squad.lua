...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011089]] -- - Basic ranged heavy infantry (infiltrator). ~~~ Contains training in both melee and ranged (especially) combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011090]] -- - Durability: Good | Strength: Average | Morale: Average | Upgrades: A lot | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard |  Keen sight: 2m | Abilities: Few | Weapon range: Good | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Tristan Gillis (donator of $1) ~~~ For the false Emperor!]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/marine_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011088]] -- Chaos Space Marines
