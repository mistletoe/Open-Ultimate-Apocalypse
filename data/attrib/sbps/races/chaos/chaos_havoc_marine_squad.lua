...
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_08"] = Reference([[modifiers\lose_control.lua]])
...
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_08"]["value"] = -10
--INTENTIONAL SPACER
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011105]] -- - Long ranged pre-elite heavy infantry. ~~~ Contains training in both melee and ranged (especially) combat.
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/havocs_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011104]] -- Havoc Marines
