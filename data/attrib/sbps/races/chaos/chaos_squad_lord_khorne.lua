...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["squad_name"] = [[sbps\races\chaos\chaos_squad_bloodthirster.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\chaos_mark_khorne_research.lua]]
GameData["squad_transportable_ext"] = Reference([[sbpextensions\squad_transportable_ext.lua]])
GameData["squad_ui_ext"] = Reference([[sbpextensions\squad_ui_ext.lua]])
GameData["squad_ui_ext"]["counter_text_id"] = [[$0]]
GameData["squad_ui_ext"]["multi_select_priority"] = 1
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012214]] -- - Secondary commander unit. ~~~ Can ascend into the Bloodthirster.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012215]] -- - Durability: Good | Strength: Good | Morale: Plenty | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Good |  Keen sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/chaos_lord_khorne]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012213]] -- Champion of Khorne
