...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\chaos\troops\chaos_lord_terminator.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_4"]["squad_name"] = [[sbps\races\chaos\chaos_squad_lord.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\chaos_wargear10.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012223]] -- - (Deepstrike) Primary (relic) commander unit. ~~~ Able to teleport.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012224]] -- - Durability: Excellent | Strength: Excellent | Morale: Legendary | Upgrades: Hero Wargear | Squad Size: Single | Movement Speed: Slow | Sight: Good |  Keen sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/chaos_terminator_lord_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012222]] -- Chaos Lord (In Terminator Armor)
