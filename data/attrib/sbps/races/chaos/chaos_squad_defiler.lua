...
GameData["squad_reinforce_ext"] = Reference([[]])
GameData["squad_reinforce_ext"]["can_upgrade"] = true 
GameData["squad_reinforce_ext"]["cost"] = Reference([[tables\time_cost_table.lua]])
GameData["squad_reinforce_ext"]["in_combat_time_multiplier"] = 2
GameData["squad_reinforce_ext"]["leader_event"] = [[Unit_Upgrade_Morale_FX/reinforce_trooper]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011166]] -- - Elite armored walker vehicle. ~~~ Can change fire modes from melee to range, granting artillery weapons.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011167]] -- - Durability: Excellent | Strength: Very Good | Morale: Immune | Upgrades: Few | Squad Size: Single | Movement Speed: Standard | Sight: Standard |  Keen sight: None | Abilities: None | Weapon range: Very long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/defiler_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011165]] -- Defiler
