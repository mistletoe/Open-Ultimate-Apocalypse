...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$696900]] -- - Heavy Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$667201]] -- - These Possessed Marines are picked from Eliphas' most able warriors.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$667202]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/pos_marine_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$667200]] -- Chosen Possessed Squad
