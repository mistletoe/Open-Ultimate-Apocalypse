...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\chaos\troops\chaos_mutilator.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012147]] -- - (Deepstrike) Elite daemonic melee unit.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012148]] -- - Durability: Excellent | Strength: Very Good | Morale: Immune | Upgrades: None | Squad Size: Small | Movement Speed: Slow | Sight: Standard | Keen Sight: 2m | Abilities: Basic | Weapon Range: Melee | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011149]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/chaos_mutilators_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012146]] -- Mutilators
