...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$696705]] -- - Heavy Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$696722]] -- - Detects infiltrated units.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$696721]] -- - Boosts morale recovery when attached to squads.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$696720]] -- - Uses many powerful abilities focused on damage and limiting enemy movement.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$696719]] -- - Can be possessed by the Bloodthirster.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$696718]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
