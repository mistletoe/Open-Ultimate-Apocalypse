...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$667155]] -- - Honor Guard unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450133]] -- - One of the Alpha Legion's most vicious Raptor Champions.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$667157]] -- - Powerful jump infantry unit.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/aspiring_champion_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$667150]] -- Raptor Champion
