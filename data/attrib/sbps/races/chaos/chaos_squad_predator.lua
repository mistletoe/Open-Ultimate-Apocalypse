...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011163]] -- - Elite vehicle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011164]] -- - Durability: Very Good | Strength: Very Good | Morale: Immune | Upgrades: A lot | Squad Size: Single | Movement Speed: Fast | Sight: Standard |  Keen sight: None | Abilities: None | Weapon range: Good | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/predator_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011162]] -- Chaos Predator
