...
GameData["squad_loadout_ext"]["unit_max"] = 11
...
GameData["squad_reinforce_ext"]["max_upgrades"] = 11
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011562]] -- - Basic ranged unit. ~~~ Gains strength when in a horde of other Ork Boyz and could possibly increase resource income if high enough.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011563]] -- - Durability: Basic | Strength: Basic | Upgrades: A lot | Morale: Basic | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011564]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/shoota_boyz_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011561]] -- Shoota Boyz
