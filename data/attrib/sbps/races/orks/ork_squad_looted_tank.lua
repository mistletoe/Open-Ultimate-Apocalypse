...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["research_name"] = [[research\ork_research_tech_looted_tank.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011633]] -- - Elite artillery-like vehicle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011634]] -- - Durability: Good | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Very good | Keen Sight: None | Abilities: None | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/looted_tank_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011632]] -- Looted Tank
