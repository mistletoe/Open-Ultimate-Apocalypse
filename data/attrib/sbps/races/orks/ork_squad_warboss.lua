...
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["default"] = 3400
GameData["squad_morale_ext"]["max"] = 3400
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["population_required"] = 110
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011552]] -- - Da big boss (detector).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011553]] -- - Durability: Very Good | Strength: Very Good | Morale: Legendary | Upgrades: Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/warboss_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011551]] -- Warboss
