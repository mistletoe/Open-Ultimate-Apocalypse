...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["research_name"] = [[research\ork_research_tech_deff_dread.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011627]] -- - Elite melee/siege vehicle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011628]] -- - Durability: Good | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: None | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/deff_dread]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011626]] -- Deff Dread
