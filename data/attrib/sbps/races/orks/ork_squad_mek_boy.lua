...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011555]] -- - Teky Boss (detector). ~~~ Can teleport; can attach to squads and allow the attached squad to teleport.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011556]] -- - Durability: Average | Strength: Average | Morale: Average | Upgrades: Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 15m | Abilities: Average | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/mekboy_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011554]] -- Big Mek
