...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\orks\troops\ork_honor_guard_slugga_boy.lua]]
GameData["squad_loadout_ext"]["unit_max"] = 30
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 1.799999952
GameData["squad_reinforce_ext"]["in_combat_time_multiplier"] = 2
GameData["squad_reinforce_ext"]["leader_event"] = [[Unit_Upgrade_Morale_FX/reinforce_ork_trooper]]
GameData["squad_reinforce_ext"]["max_upgrades"] = 30
...
GameData["squad_requirement_ext"]["requirements"]["required_9"] = Reference([[requirements\required_squad_cap.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_9"]["max_squad_cap"] = 5
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012053]] -- - Special Slugga unit. ~~~ Improves the construction speed of Gretchinz.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011559]] -- - Durability: Basic | Strength: Basic | Morale: Basic | Upgrades: A lot | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011560]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/grot_leader_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012052]] -- Trojan Boyz
