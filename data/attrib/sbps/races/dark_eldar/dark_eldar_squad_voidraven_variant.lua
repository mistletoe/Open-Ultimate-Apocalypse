...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_vehicle_voidraven_variant.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012277]] -- - Durability: Very Excellent | Strength: Very Excellent | Morale: Plenty | Upgrades: 0 | Squad Size: Single | Movement Speed: Extreme | Sight: Excellent | Keen Sight: None | Abilities: Good | Weapon range: Very Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011204]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/dark_eldar_razorwing_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012276]] -- Razorwing Fighter
