...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4050165]] -- - Elite strike group composed of the deadliest Scourge jump troops.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4050166]] -- - Can be equipped with Dark Lances to tear through vehicle armor.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4050167]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/HG_scourge_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$4050163]] -- Razorwing Scourge Squad
