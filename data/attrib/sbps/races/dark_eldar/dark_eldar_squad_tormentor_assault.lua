...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_titan_tormentor_assault.lua]]
...
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_07"]["value"] = 134
--INTENTIONAL SPACER
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011278]] -- - Titan unit (infiltrator) (detector). ~~~ Equipped with titanic like shields, recovered when idle or disabled.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011279]] -- - Durability: Very Good | Strength: Very Good | Morale: Plenty | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Standard | Keen Sight: 12m | Abilities: Good| Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011280]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/tormentor_titan_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011281]] -- Tormentor Assault Titan
