...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011264]] -- - Elite vehicle. ~~~ Can vault over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011265]] -- - Durability: Good | Strength: Good | Morale: Immune | Upgrades: Few | Squad Size: Single | Movement Speed: Very fast | Sight: Standard | Keen sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/ravager_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011263]] -- Ravager
