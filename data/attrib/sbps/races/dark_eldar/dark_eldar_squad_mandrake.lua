...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011214]] -- - Starting melee infantry (infiltrator).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011215]] -- - Durability: Basic | Strength: Basic | Morale: Basic | Upgrades: None | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/mandrake_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011213]] -- Mandrake
