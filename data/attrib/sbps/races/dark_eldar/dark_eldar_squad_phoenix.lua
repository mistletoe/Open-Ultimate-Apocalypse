...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_vehicle_phoenix.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011404]] -- - Durability: Very Excellent | Strength: Excellent | Morale: Plenty | Upgrades: None | Squad Size: Single | Movement Speed: Very fast | Sight: Excellent | Keen Sight: None | Abilities: Excellent| Weapon range: Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011204]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/de_void_dragon_phoenix]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011730]] -- Void Dragon Phoenix
