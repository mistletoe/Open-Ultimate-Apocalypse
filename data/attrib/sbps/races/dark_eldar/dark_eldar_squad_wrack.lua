...
GameData["squad_leader_ext"]["leader_1"]["cost_time"]["time_seconds"] = 23
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_infantry_wrack_sybarite.lua]]
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_infantry_wrack.lua]]
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 12.80000019
...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["global_addon_name"] = [[addons\addon_dark_eldar_hq_2.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011249]] -- - Elite heavy infantry unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[- Leader unit range attacks debuffs armor]]
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011250]] -- - Durability: Good | Strength: Average | Morale: Average | Upgrades: None | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen sight: 2m | Abilities: Average | Weapon range: Standard | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/wrack_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011248]] -- Wracks
