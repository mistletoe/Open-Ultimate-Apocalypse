...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_infantry_warrior_trueborn_leader.lua]]
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_infantry_warrior_trueborn.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_tier3_research.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012122]] -- - Elite ranged unit.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012123]] -- - Durability: Good | Strength: Good | Squad Size: Standard | Upgrades: Few | Morale: Average | Movement Speed: Above standard | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/trueborn_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012121]] -- Trueborn Warriors
