...
GameData["squad_loadout_ext"]["birth_resource"]["souls"] = 1000
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\dark_eldar\troops\dark_eldar_support_slave_murdered.lua]]
