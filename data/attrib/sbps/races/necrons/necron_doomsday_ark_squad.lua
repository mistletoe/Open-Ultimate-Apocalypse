...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012173]] -- - Very long ranged elite vehicle tank. ~~~ Can vault over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012174]] -- - Durability: Good | Strength: Excellent | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Basic | Weapon range: Very long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_doomsday_ark_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012172]] -- Doomsday Ark
