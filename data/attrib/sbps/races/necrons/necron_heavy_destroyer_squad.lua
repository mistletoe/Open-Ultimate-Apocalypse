...
GameData["squad_reinforce_ext"]["cost"]["cost"]["power"] = 115
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011028]] -- - Heavy ranged vehicles. ~~~ Can jump over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011029]] -- - Durability: Good | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Small | Movement Speed: Fast | Sight: Standard |  Keen sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_heavy_destroyer_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011027]] -- Heavy Destroyers
