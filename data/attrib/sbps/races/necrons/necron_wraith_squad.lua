...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011000]] -- - Elite scout melee unit (Detector) (Infiltrator). ~~~ Able to jump over impassable terrain; has ranged damage immunity the more the unit upgrades.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011001]] -- - Durability: Average | Strength: Very Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Good |  Keen sight: 20m | Abilities: Basic | Weapon Range: Melee | Capture Points: Uncapture.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_wraith_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18010029]] -- Wraith
