...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012165]] -- - Elite anti vehicle tank. ~~~ Can vault over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012166]] -- - Durability: Very Good | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Very Fast | Sight: Good | Keen Sight: None | Abilities: Basic | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_annihilation_barge_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012164]] -- Annihilation Barge
