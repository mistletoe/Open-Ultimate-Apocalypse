...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011034]] -- - (Reassembles) Living Metal melee vehicle/minor relic unit (infiltrator). ~~~ Can direct spawn attack scarabs; immune to most superweapons.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011035]] -- - Durability: Very Good | Strength: Very Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Standard |  Keen sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_tomb_stalker_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011033]] -- Tomb Stalker
