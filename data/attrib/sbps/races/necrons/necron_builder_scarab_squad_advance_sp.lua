...
GameData["squad_capture_strategic_point_ext"]["capture_rate"] = 0.5
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$580450]] -- - Honor Guard unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$708109]] -- - Detects infiltrated units.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$708108]] -- - Constructs all Necron buildings.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$580452]] -- - Can capture Strategic Points.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_builder_scarab_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$708100]] -- Builder Scarabs
