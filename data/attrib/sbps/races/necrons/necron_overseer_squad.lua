...
GameData["squad_requirement_ext"]["requirements"]["required_9"]["global_addon_name"] = [[addons\addon_necron_hq_1.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012143]] -- - (Reassembles) Support commander unit (detector).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012144]] -- - Durability: Average | Strength: Average | Morale: Immune | Upgrades: Paths, Hero Wargear |  Squad Size: Single| Movement Speed: Standard | Sight: Good | Keen sight: 20m | Abilities: Excellent| Weapon Range: Melee | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012145]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_overseer_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012142]] -- Cryptek
