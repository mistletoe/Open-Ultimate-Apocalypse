...
GameData["squad_modifier_apply_ext"]["modifiers"]["modifier_02"]["modifier"]["value"] = 1.75
--INTENTIONAL SPACER
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 27.5
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18010022]] -- - Basic ranged unit. ~~~ Able to be recalled back to structures.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18010023]] -- - Durability: Average | Strength: Average | Morale: Immune | Upgrades: None | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard | Keen sight: 2m | Abilities: Below Average | Weapon range: short | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18010024]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_warrior_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18010021]] -- Necron Warriors
