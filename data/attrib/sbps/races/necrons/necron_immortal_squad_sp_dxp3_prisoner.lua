...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\necrons\troops\necron_immortal_sp_dxp3_prisoner.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$708351]] -- - Heavy Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$708352]] -- - These elite warriors were among the first to swear allegiance to the C'tan.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$708353]] -- - Equipped with Gauss Blasters that are calibrated to penetrate vehicle and building armor.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$708354]] -- - Only effective against infantry in melee combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$708355]] -- - Like Necron Warriors, some Immortals may reassemble themselves when destroyed.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$4600011]] -- - Effective against Aircraft.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_immortal_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$708350]] -- Immortals
