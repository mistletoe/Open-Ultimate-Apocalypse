...
GameData["squad_cannibalize_ext"]["max_cannibalism_bonus"] = 1500
GameData["squad_cannibalize_ext"]["souls_amount"] = 20
GameData["squad_cannibalize_ext"]["souls_speed"] = 15
GameData["squad_cannibalize_ext"]["ui_description"] = [[$16003539]] -- 
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_hormagaunt.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16026031]] -- - Basic melee unit (swarm unit, provides nearby bonuses such as strength, health regen, and production speed). ~~~ Can leap at enemy targets.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026032]] -- - Effective versus: Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026033]] -- - Durability: 2.5 | Strength: 2.5 | Morale: Immune | Upgrades: 0 | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 1 | Weapon range: 0 | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026034]] -- - Provides +0.5 requisition per unit in the squad while alive.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16026035]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[Tyranids_icons/i_hormagaunt]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16026030]] --  Hormagaunt
