...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_gaunt_won.lua]]
GameData["squad_loadout_ext"]["unit_max"] = 25
GameData["squad_loadout_ext"]["unit_min"] = 25
...
GameData["squad_reinforce_ext"]["cost"]["cost"]["requisition"] = 3
...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["max_cumulative_squad_cap"] = 4
GameData["squad_requirement_ext"]["requirements"]["required_3"]["squad_table"]["squad_01"] = [[races\tyranids\tyranids_squad_spinegaunt.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_3"]["squad_table"]["squad_02"] = [[races\tyranids\tyranids_squad_spinegaunt_max.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026059]] --  - WoN: Without Number: Free, accelerated Unit Spawn, and faster than Spinegaunts MaSS (swarm unit, provides nearby bonuses such as strength, health regen, and production speed).
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[Tyranids_icons/i_spinegaunt_won]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16026058]] --  Spinegaunt (Without Number)
