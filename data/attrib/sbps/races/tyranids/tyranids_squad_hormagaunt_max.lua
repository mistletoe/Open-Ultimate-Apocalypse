...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_hormagaunt_max.lua]]
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 2.5
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026031]] -- - Basic melee unit (swarm unit, provides nearby bonuses such as strength, health regen, and production speed). ~~~ Can leap at enemy targets.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026032]] -- - Effective versus: Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026033]] -- - Durability: 2.5 | Strength: 2.5 | Morale: Immune | Upgrades: 0 | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 1 | Weapon range: 0 | Capture Points: Yes.
--INTENTIONAL SPACER
