...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_spinegaunt.lua]]
GameData["squad_loadout_ext"]["unit_max"] = 16
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 0.8000000119
...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["squad_table"]["squad_01"] = [[races\tyranids\tyranids_squad_gaunt_won.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_2"]["squad_table"]["squad_02"] = [[races\tyranids\tyranids_squad_spinegaunt_max.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16026051]] -- - Meatshield/distraction unit (swarm unit, provides nearby bonuses such as strength, health regen, and production speed). 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026052]] -- - Durability: 1.5 | Strength: 2 | Morale: Immune | Upgrades: 0 | Squad Size: Very large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 0 | Weapon range: 0 | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026053]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026054]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16026055]] --  
--INTENTIONAL SPACER
