...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_hierophant.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_7"] = Reference([[requirements\global_required_addon.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_7"]["global_addon_name"] = [[addons\tyranids_hq_addon_2.lua]]
...
GameData["squad_transportable_ext"]["nr_spots"] = 8
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16026218]] -- - Titan unit (detector). ~~~ Takes down anything in melee and most targets in ranged combat; exudes miasma, hurting enemies and strengthening Tyranids.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026219]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026220]] -- - Durability: 22 | Strength: 22 | Morale: Immune | Upgrades: 4 | Squad Size: Single | Movement Speed: Standard | Sight: Very good | Keen Sight: 20m | Ability Strength: 4 | Weapon range: Good | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026221]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- #Nidthan (donator of $0) ~~~ I don't know... seems kinda squishy.]]
--INTENTIONAL SPACER
