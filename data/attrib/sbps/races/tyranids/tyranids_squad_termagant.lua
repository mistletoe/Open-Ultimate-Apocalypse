...
GameData["squad_cannibalize_ext"]["animator_action_name"] = [[melee_attack]]
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tyranids\troops\tyranids_termagant.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16026021]] -- - Basic ranged unit (swarm unit, provides nearby bonuses such as strength, health regen, and production speed).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026022]] -- - Effective versus: Infantry ~~~ Increases the health of everything by 1% each unit fielded.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026023]] -- - Durability: 2 | Strength: 2 | Morale: Immune | Upgrades: 0 | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 0 | Weapon range: Standard | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16026024]] -- 
