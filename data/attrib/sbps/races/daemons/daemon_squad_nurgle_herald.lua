...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\daemons\troops\daemon_nurgle_herald.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16003011]] -- - Daemon Commander (secondary) (detector).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16003012]] -- - Durability: 4.5 | Strength: 4.5 | Morale: 5 | Upgrades: 0 | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Ability Strength: 2 | Weapon range: 0 | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16003013]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_herald_nurgle_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16003010]] -- Herald of Nurgle
