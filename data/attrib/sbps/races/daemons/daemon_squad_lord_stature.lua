...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\daemons\troops\daemon_lord_stature.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_11"]["squad_table"]["squad_06"] = [[sbps\races\daemons\daemon_squad_lord.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16000143]] -- - A more powerful version of the Daemon Lord.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_lord_stature_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16000142]] -- Daemon Lord (Stature)
