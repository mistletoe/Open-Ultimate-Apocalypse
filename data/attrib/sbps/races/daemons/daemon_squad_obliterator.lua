...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\daemons_research_gift21.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\daemons_research_gift21.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16000131]] -- - Summons a single squad of Obliterators, from the Chaos Marines army.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000132]] -- - Touched by pure Chaos, this Daemonic version is a true combat menace.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000217]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000219]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000133]] -- - Wield a wide array of weapons which can be switched automatically, for optimum damage output.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16000221]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$16000222]] -- Infernal Trade: Requisition And Power
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_mutilator_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16000130]] -- Daemonic Obliterators
