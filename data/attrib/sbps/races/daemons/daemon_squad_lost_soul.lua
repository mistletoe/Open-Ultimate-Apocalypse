...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["max_squad_cap"] = 8
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16002312]] -- - Durability: 1 | Strength: N/A | Morale: Immune | Upgrades: 0 | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 15m | Ability Strength: 1 | Weapon range: 0 | Capture Points: Uncapture.
--INTENTIONAL SPACER
