...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_manta.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\tau_apocalypse_research.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_7"]["structure_name"] = [[ebps\races\tau\structures\tau_guidance_beacon.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012068]] -- - Titanic Transport Aircraft unit (Transport: 20) (produces units). ~~~ Can jump to any location on the map; contains garrisson bonuses while the Ethereal is inside, granting: detection of infiltrated units, sight range increased, ability recharge rate increase, and health regeneration enabled.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012069]] -- - Durability: 50 | Strength: Unstoppable | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Standard | Sight: Extreme | Keen Sight: None | Abilities: Below Average3 | Weapon range: Extreme | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012070]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012071]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_manta_2]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012067]] -- Manta
