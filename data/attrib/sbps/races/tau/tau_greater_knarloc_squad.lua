...
GameData["squad_reinforce_ext"]["cost"]["cost"]["requisition"] = 750
...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["research_name"] = [[research\tau_teachings_of_kauyon_research.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011945]] -- - Relic unit. ~~~ Cheap to reinforce | harms opponents with a vile bite, decreasing armor and causes bleeding damage for a long duration.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011946]] -- - Durability: Excellent | Strength: Excellent | Squad Size: Below Standard | Upgrades: None | Morale: Immune | Movement Speed: Standard | Sight: Good | Keen Sight: 3m | Abilities: None | Weapon Range: Melee | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011947]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_greater_knarloc_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011944]] -- Greater Knarloc
