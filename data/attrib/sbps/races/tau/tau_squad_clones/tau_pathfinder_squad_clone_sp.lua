...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$709702]] -- - Scout/Recon Unit. Good sight range and fast movement.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$709706]] -- - Armed with markerlights to mark enemy units, making targets more vulnerable to attack.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$709707]] -- - Supression fire slows enemy advance.
--INTENTIONAL SPACER
