...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$671356]] -- - Commander Unit (secondary)
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$671355]] -- - Commands Kroot Carnivore and Kroot Hound squads.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$671354]] -- - Improves speed and health of squad.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_kroot_shaper_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$671357]] -- Kroot Shaper
