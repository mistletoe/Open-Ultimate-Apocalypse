...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$708803]] -- - Can jetpack quickly around, and over, the battlefield.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$708804]] -- - Equipped with heavy firepower that can be fired from a great distance.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$708805]] -- - Weapons can be customized to deal with different opponents.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_crisis_suit_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$708800]] -- XV8 Crisis Battlesuit Team
