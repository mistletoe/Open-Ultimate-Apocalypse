...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_xv101_riptide_suit.lua]]
...
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["default"] = 3000
GameData["squad_morale_ext"]["max"] = 3000
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012193]] -- - Super heavy walker/titan. ~~~ Can jump over impassable terrain; equipped with titanic shields that regenerate when idle; takes more damage when in melee combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012194]] -- - Durability: Very Excellent | Strength: Excellent | Squad Size: Single | Upgrades: None | Morale: Legendary | Movement Speed: Standard | Sight: Very Good | Keen Sight: None | Abilities: Excellent| Weapon range: Very Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012195]] -- - Riptide variant of Kauyon. Cheaper and more flexible when dealing with infantry and vehicles.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_riptide_suit_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012192]] -- XV101 Riptide Titan
