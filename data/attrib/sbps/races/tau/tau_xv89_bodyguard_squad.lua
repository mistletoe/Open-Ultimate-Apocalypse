...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_xv89_bodyguard.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012153]] -- - Elite commander bodyguards. ~~~ Able to jump over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012154]] -- - Durability: Good | Strength: Good | Squad Size: Below Standard | Upgrades: Few | Morale: Average | Movement Speed: Slow | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_xv89_bodyguards_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012152]] -- XV89 Bodyguards
