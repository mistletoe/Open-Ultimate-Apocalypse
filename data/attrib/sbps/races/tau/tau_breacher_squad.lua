...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[Data\attrib\ebps\races\tau\troops\tau_shasui_breacher.lua]]
...
GameData["squad_leader_ext"]["leader_4"]["leader"]["type"] = [[ebps\races\tau\troops\tau_marker_drone_commander_sp_breacher.lua]]
GameData["squad_leader_ext"]["max_leaders"] = 2
GameData["squad_leader_ext"]["multi_with_reinforce"] = true 
GameData["squad_leader_ext"]["multi_with_upgrades"] = true 
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_breacher.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012446]] -- Basic ranged unit. --- Equipped with pulse shotguns to disrupt enemy infantry at close range.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012447]] -- - Durability: Basic | Strength: Average | Squad Size: Standard | Upgrades: Few | Morale: Basic | Movement Speed: Standard | Sight: Average | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_breacher_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012445]] -- Breachers
