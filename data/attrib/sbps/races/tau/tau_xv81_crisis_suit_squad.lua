...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\tau\troops\tau_shield_drone.lua]]
...
GameData["squad_reinforce_ext"]["cost"]["cost"]["power"] = 140
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\tau_teachings_of_montka_research.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011961]] -- - Heavy elite ranged unit. ~~~ Can vault over impassable terrain.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011962]] -- - Durability: Good | Strength: Good | Squad Size: Below Standard | Upgrades: Few | Morale: Average | Movement Speed: Standard | Sight: Below standard | Keen Sight: 2m | Abilities: Basic | Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011963]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_xv81_crisis_suit_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011960]] -- XV8 Sunfire Battlesuits
