...
GameData["squad_jump_ext"]["jump_distance_max"] = 170
GameData["squad_jump_ext"]["jump_time_max"] = 3
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["area_effect_information"]["filter_type"] = Reference([[type_areafilter\tp_area_filter_enemy.lua]])
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["area_effect_information"]["radius"] = 14
--INTENTIONAL SPACER
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_xv104_riptide_suit.lua]]
...
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["default"] = 3500
GameData["squad_morale_ext"]["max"] = 3500
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012242]] -- - Super heavy walker/titan. ~~~ Can jump over impassable terrain; equipped with titanic shields that regenerate when idle; takes more damage when in melee combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18012244]] -- - Riptide variant of Montka. Stronger variant, dealing with fewer armor types with upgrade choices.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012243]] -- - Durability: Very Excellent | Strength: Excellent | Squad Size: Single | Upgrades: Few | Morale: Legendary | Movement Speed: Fast | Sight: Very Good | Keen Sight: None | Abilities: Excellent| Weapon range: Very Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_riptide_montka_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012241]] -- XV104 Riptide Titan
