...
GameData["squad_jump_ext"]["go_down_time"] = 1.370000005
GameData["squad_jump_ext"]["go_up_time"] = 1.029999971
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011993]] -- - Scout vehicle. ~~~ Can vault over impassable terrain.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011994]] -- - Durability: Basic | Strength: Basic | Squad Size: Single | Upgrades: Few | Morale: Immune | Movement Speed: Very Fast | Sight: Excellent | Keen Sight: None | Abilities: Basic | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons\tau_piranha_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011992]] -- Piranha Skimmer
