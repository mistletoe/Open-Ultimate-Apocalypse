...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_pathfinder_sp_dxp3_prisoner.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$709701]] -- - Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$709717]] -- - Detects infiltrated units.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$709716]] -- - Scout/Recon Unit. Good sight range and fast movement.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$709715]] -- - Armed with markerlights to mark enemy units, making targets more vulnerable to attack.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$709714]] -- - Suppression fire slows enemy advance.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_pathfinder_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$709700]] -- Pathfinder Team
