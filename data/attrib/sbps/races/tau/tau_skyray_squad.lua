...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011996]] -- - Artillery/medium tank. ~~~ Can vault over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011997]] -- - Durability: Average | Strength: Average | Squad Size: Single | Upgrades: Few | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Artillery | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011998]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_skyray_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011995]] -- Skyray Missile Gunship
