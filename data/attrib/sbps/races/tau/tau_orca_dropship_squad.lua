...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\tau\troops\tau_orca_dropships.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["research_name_either"] = [[research\tau_teachings_of_kauyon_research.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_2"]["research_name_or"] = [[research\tau_teachings_of_montka_research.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_orca_dropship_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011985]] -- Orca Transport
