...
GameData["squad_reinforce_ext"]["cost"]["cost"]["power"] = 85
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["addon_name"] = [[addons\eldar_aspect_stone_wraithguard.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_11"] = Reference([[requirements\local_required_addon.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_11"]["addon_name"] = [[addons\eldar_aspect_stone_wraithguard.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011344]] -- - Ranged Elite heavy infanty. ~~~ Is granted increased sight range and movement speed when reinforced with a Spiritseer.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18011346]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011345]] -- - Durability: Good | Strength: Very Good | Morale: Immune | Upgrades: A lot | Squad Size: Small | Movement Speed: Slow | Sight: Short | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/wraithguard]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011343]] -- Wraithguard
