...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$669556]] -- - Honor Guard unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$669552]] -- - Also known as "Caerys's Swift-Striking spear", using their warping abilities to cripple the enemy at their weakest point.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$669553]] -- - One of two councils formed of the most legendary Warp Spider Exarchs from Craftworld Ulthwé.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$669554]] -- - Effective against Infantry and Heavy Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$669254]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/upgrade_exarch_warp_spider]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$669550]] -- Warp Spider Exarchs
