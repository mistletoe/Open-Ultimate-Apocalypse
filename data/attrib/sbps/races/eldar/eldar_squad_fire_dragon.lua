...
GameData["squad_infiltration_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_research_stealth_stone_fire_dragon.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011330]] -- - Ranged pre-elite anti-vehicle heavy infantry.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011331]] -- - Durability: Average | Strength: Average | Morale: Average | Upgrades: None | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011332]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/eldar_icon_fire_dragons]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011329]] -- Fire Dragons
