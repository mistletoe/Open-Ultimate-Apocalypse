...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011390]] -- - Durability: Basic | Strength: Good | Upgrades: Few | Morale: Immune | Squad Size: Single | Movement Speed: Extreme | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
