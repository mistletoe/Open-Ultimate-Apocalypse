...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_grav_platform_shadow_weaver.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011354]] -- - Durability: Basic | Strength: Average | Morale: Immune | Upgrades: None | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: None | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/grav_platform_shadow_weaver]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011363]] -- Shadow Weaver Grav Platform
