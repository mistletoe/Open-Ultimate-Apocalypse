...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011350]] -- - Durability: Basic | Strength: Average | Morale: Immune | Upgrades: None | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: None | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/grav_platform_shurikencannon_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011348]] -- Shuriken Cannon Grav Platform
