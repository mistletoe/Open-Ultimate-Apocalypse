...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_voidspinner.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012029]] -- - Artillery relic unit. ~~~ Can vault over impassable terrain; contains shields (after research) that regenerate when idle.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012030]] -- - Durability: Very Good | Strength: Excellent | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Fast | Sight: Very Good | Keen Sight : None | Abilities: Below Average | Weapon range: Artillery | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18012031]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/voidspinner_super_heavy]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012028]] -- Void Spinner Super-Heavy
