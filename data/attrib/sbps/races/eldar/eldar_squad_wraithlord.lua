...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011385]] -- - Melee/siege walker unit.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011386]] -- - Durability: Average | Strength: Good | Morale: Immune | Upgrades: Few | Squad Size: Single | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011387]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/wraithlord_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011384]] -- Wraithlord
