...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_hornet.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["addon_name"] = [[addons\eldar_aspect_stone_hornet.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_2"] = Reference([[requirements\local_required_addon.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_2"]["addon_name"] = [[addons\eldar_aspect_stone_hornet.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012361]] -- - Vehicle unit. ~~~ Can vault over impassable terrain.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012362]] -- - Durability: Very Good | Strength: Good | Morale: Good | Upgrades: None | Squad Size: Single | Movement Speed: Very Fast | Sight: Very Good | Keen Sight: None | Ability Strength: Average | Weapon range: Good | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/hornet_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18012360]] -- Hornet
