...
GameData["squad_infiltration_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_research_stealth_stone_banshees.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011307]] -- - Basic melee unit. ~~~ Can leap into the air, knocking back infantry and dealing damage.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011308]] -- - Durability: Basic | Strength: Basic | Morale: Basic | Upgrades: None | Squad Size: Standard | Movement Speed: Fast | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/howling_banshee_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011306]] -- Howling Banshees
