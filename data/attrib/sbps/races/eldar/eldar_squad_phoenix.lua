...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_phoenix.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011403]] -- - Titanic air unit. ~~~ Can jump to any location on the map; equipped with titanic like shields, recovered when idle or disabled; regenerates health; can direct spawn Nightwing Fighters.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011404]] -- - Durability: Very Excellent | Strength: Excellent | Morale: Plenty | Upgrades: None | Squad Size: Single | Movement Speed: Very fast | Sight: Excellent | Keen Sight: None | Abilities: Excellent| Weapon range: Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011204]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[- Ryan Stapleton (donator of $20) ~~~ I'm a flying, terrifying, and powerful b**ch.]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/phoenix_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011402]] -- Airborn Phoenix
