...
GameData["squad_infiltration_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_research_stealth_stone_warp_spider.lua]]
...
GameData["squad_jump_ext"]["setup_time"] = 0.3000000119
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011340]] -- - (Deepstrike) Ranged Elite heavy infantry. ~~~ Can teleport; weapons are able to shoot through terrain.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011341]] -- - Durability: Average | Strength: Very Good | Morale: Average | Upgrades: None | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Average | Weapon range: Standard | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/warp_spider_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011339]] -- Warp Spiders
