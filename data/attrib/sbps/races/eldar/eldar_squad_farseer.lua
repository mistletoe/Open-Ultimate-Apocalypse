...
GameData["squad_infiltration_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_research_stealth_stone_farseer.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011288]] -- - Support commander unit (shrouder (infiltration)) (detector).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011289]] -- - Durability: Basic | Strength: Average | Morale: Average | Upgrades: Spells, Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Very Good | Keen Sight: 15m | Abilities: Good| Weapon range: Short | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/farseer_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011287]] -- Farseer
