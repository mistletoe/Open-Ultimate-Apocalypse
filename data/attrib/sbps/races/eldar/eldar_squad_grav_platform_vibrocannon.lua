...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_grav_platform_vibrocannon.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011360]] -- - Durability: Average | Strength: Average | Morale: Immune | Upgrades: None | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: None | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/grav_platform_vibrocannon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011359]] -- Vibro Cannon Grav Platform
