...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011377]] -- - Medium Transport unit (Transport: 1). ~~~ Transport rule: Equipped with various support abilities | can vault over impassable terrain | equipped with shields that regenerate when idle (after research).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011378]] -- - Durability: Average | Strength: Average | Morale: Basic | Upgrades: A lot | Squad Size: Single | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011379]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/falcon_grav_tank_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011376]] -- Falcon Grav Tank
