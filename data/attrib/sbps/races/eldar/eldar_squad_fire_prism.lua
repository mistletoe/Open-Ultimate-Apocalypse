...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011395]] -- - Elite vehicle unit. ~~~ Can vault over impassable terrain; equipped with shields that regenerate when idle (after research).
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011396]] -- - Durability: Good | Strength: Good | Morale: Basic | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Standard | Keen Sight: None | Abilities: Below Average | Weapon range: Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011397]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/fire_prism_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011394]] -- Fire Prism
