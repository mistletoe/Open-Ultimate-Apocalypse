...
GameData["squad_jump_ext"]["go_up_time"] = 0.3000000119
GameData["squad_jump_ext"]["jump_distance_max"] = 130
GameData["squad_jump_ext"]["jump_min_height"] = 5
GameData["squad_jump_ext"]["jump_time_max"] = 6
...
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["throw_data"]["force_max"] = 75
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["throw_data"]["force_min"] = 50
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["throw_data"]["up_angle_max"] = 60
GameData["squad_jump_ext"]["screaming_jets_area_effect"]["throw_data"]["up_angle_min"] = 40
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\eldar\troops\eldar_titan_revenant.lua]]
...
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_07"]["value"] = 37.5
--INTENTIONAL SPACER
GameData["squad_morale_ext"]["default"] = 2250
GameData["squad_morale_ext"]["max"] = 2250
...
GameData["squad_ui_ext"]["ui_index_hint"] = 7
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011410]] -- - Scout class titan (detector). ~~~ Can vault over impassable terrain; equipped with titanic like shields, recovered when idle or disabled.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011411]] -- - Durability: Very Excellent | Strength: Excellent | Morale: Plenty | Upgrades: Few | Squad Size: Single | Movement Speed: Very fast | Sight: Excellent | Keen Sight: 20m | Abilities: Good| Weapon range: Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011412]] -- - Recovers shields extremely quickly, even more so than greater titans when idle.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/revenant_titan_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011409]] -- Revenant Titan
