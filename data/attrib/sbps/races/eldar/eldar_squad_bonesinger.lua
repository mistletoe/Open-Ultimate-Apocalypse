...
GameData["squad_jump_ext"]["charge_jump_cost_max"] = 450
GameData["squad_jump_ext"]["charge_jump_cost_min"] = 450
...
GameData["squad_jump_ext"]["jump_distance_max"] = 250
...
GameData["squad_jump_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_bonesinger_jump_research.lua]]
...
GameData["squad_jump_ext"]["requirements"]["required_10"]["structure_name"] = [[ebps\races\eldar_hq.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011295]] -- - Builder unit. ~~~ Can teleport.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18011296]] -- - Durability: Weak | Strength: Weak | Morale: Basic | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: No.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/bonesinger_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$18011294]] -- Bonesinger
