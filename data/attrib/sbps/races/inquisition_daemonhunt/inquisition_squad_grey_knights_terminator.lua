...
GameData["squad_leader_ext"]["leader_1"]["leader"]["type"] = [[ebps\races\inquisition_daemonhunt\troops\inquisition_grey_knights_terminator_justicar.lua]]
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\inquisition_daemonhunt\troops\inquisition_grey_knights_terminator.lua]]
...
GameData["squad_reinforce_ext"]["cost"]["cost"]["requisition"] = 280
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\inquisition_schematic_grey_knight_terminator.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\inquisition_schematic_grey_knight_terminator.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021155]] -- - (Deepstrike) Elite warriors of the Inquisition. ~~~ Can teleport.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16021156]] -- - Durability: 7.5 | Strength: 7.5 | Morale: 9 | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard | Ability Strength: 0 | Weapon range: Standard | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$16021157]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/gk_terminator_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16021154]] -- Grey Knight Terminators
