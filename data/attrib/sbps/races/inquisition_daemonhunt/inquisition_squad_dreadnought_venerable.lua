...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\inquisition_daemonhunt\troops\inquisition_dreadnought_venerable.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["research_name"] = [[research\inquisition_ultimate_forces.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021175]] -- - (Deepstrike) Elite armored walker vehicle. ~~~ Contains an aura of daemon purging.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16021176]] -- - Durability: 10.5 | Strength: 9.5 | Morale: Immune | Squad Size: Single | Upgrades: 0 | Movement Speed: Fast | Sight: Good | Keen Sight: None | Ability Strength: 1 | Weapon range: Good | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16021177]] -- 
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/dreadnought_venerable_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16021174]] -- Venerable Dreadnought
