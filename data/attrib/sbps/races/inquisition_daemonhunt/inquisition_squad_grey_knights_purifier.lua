...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\inquisition_schematic_grey_knight_purifier.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\inquisition_schematic_grey_knight_purifier.lua]]
...
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021151]] -- - (Deepstrike) (Detector) Battle brothers of the Inquisition - psychic squad. ~~~ Able to teleport over medium distances.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16021152]] -- - Durability: 4 | Strength: 4 | Morale: 6 | Upgrades: 0 | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 15m | Ability Strength: 6 | Weapon range: Standard | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/grey_knight_purifier_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16021150]] -- Grey Knight Purifiers
