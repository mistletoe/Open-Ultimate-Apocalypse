...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\inquisition_daemonhunt\troops\inquisition_warhound_titan.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\inquisition_schematic_titan_purifier.lua]]
GameData["squad_requirement_ext"]["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["squad_requirement_ext"]["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\inquisition_schematic_titan_purifier.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011203]] -- - Durability: Titanic | Strength: Excellent | Morale: Plenty | Upgrades: Few | Squad Size: Single | Movement Speed: Fast | Sight: Excellent |  Keen sight: None | Abilities: Good | Weapon range: Very long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011204]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[- Gurra (donator of $20) ~~~ Purifier > Vengence 10/10]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/idh_warhound_purifier_icon]]
--INTENTIONAL SPACER
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16021122]] -- Warhound Purifier Titan
