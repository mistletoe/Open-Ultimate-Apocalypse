...
GameData["requirements"]["required_3"]["research_name"] = [[ork_generator_boost_research_1]]
...
GameData["requirements"]["required_10"]["research_name"] = [[ork_generator_boost_research_1]]
