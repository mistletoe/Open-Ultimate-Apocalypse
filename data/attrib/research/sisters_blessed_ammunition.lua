...
GameData["modifiers"]["modifier_15"]["target_type_name"] = [[sisters_bolt_pistol_artisan]]
...
GameData["modifiers"]["modifier_17"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_17"]["target_type_name"] = [[sisters_bolt_pistol_preceptor]]
GameData["modifiers"]["modifier_17"]["value"] = 1.5
GameData["modifiers"]["modifier_18"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_18"]["target_type_name"] = [[sisters_heavy_bolter_capitol]]
GameData["modifiers"]["modifier_18"]["value"] = 1.5
GameData["modifiers"]["modifier_19"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[sisters_bolt_pistol_veteran_superior]]
GameData["modifiers"]["modifier_19"]["value"] = 1.5
GameData["modifiers"]["modifier_20"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[sisters_bolt_pistol_veteran_superior_seraphim]]
GameData["modifiers"]["modifier_20"]["value"] = 1.5
GameData["modifiers"]["modifier_21"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[sisters_bolt_pistol_veteran_superior_celestian]]
GameData["modifiers"]["modifier_21"]["value"] = 1.5
GameData["modifiers"]["modifier_22"] = Reference([[modifiers\cover_damage_bonus_modifier.lua]])
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[sisters_bolt_pistol_crusader]]
GameData["modifiers"]["modifier_22"]["value"] = 1.5
