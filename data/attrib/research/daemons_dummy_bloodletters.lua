...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000174]] -- - (Deepstrike) Durable melee combat unit.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000175]] -- - Durability: 5 | Strength: 4.5 | Morale: 3.5 | Upgrades: 1 | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 1 | Weapon range: 0 | Capture Points: No.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000176]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16000177]] -- 
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodletter_icon_d]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$16000173]] -- Bloodletters
