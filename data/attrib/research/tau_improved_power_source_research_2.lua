...
GameData["modifiers"]["modifier_16"]["target_type_name"] = [[tau_burst_cannon_xv25]]
...
--REPLACE ME
GameData["modifiers"]["modifier_17"]["target_type_name"] = [[tau_burst_cannon_xv25]]
...
--REPLACE ME
GameData["modifiers"]["modifier_18"]["target_type_name"] = [[tau_burst_cannon_xv25]]
...
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[tau_fusion_blaster_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[tau_fusion_blaster_crisis_suit]]
...
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[tau_missile_pod_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[tau_missile_pod_crisis_suit]]
...
GameData["modifiers"]["modifier_23"]["target_type_name"] = [[tau_missile_pod_xv81_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_24"]["target_type_name"] = [[tau_missile_pod_xv81_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_25"]["target_type_name"] = [[tau_burst_cannon_crisis_suit]]
...
GameData["modifiers"]["modifier_26"]["target_type_name"] = [[tau_burst_cannon_crisis_suit]]
...
GameData["modifiers"]["modifier_27"]["target_type_name"] = [[tau_burst_cannon_crisis_suit_right]]
...
--REPLACE ME
GameData["modifiers"]["modifier_28"]["target_type_name"] = [[tau_burst_cannon_crisis_suit_right]]
...
--REPLACE ME
GameData["modifiers"]["modifier_29"]["target_type_name"] = [[tau_flamer_crisis_suit]]
...
GameData["modifiers"]["modifier_30"]["target_type_name"] = [[tau_flamer_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_31"]["target_type_name"] = [[tau_plasma_rifle_crisis_suit]]
...
GameData["modifiers"]["modifier_32"]["target_type_name"] = [[tau_plasma_rifle_crisis_suit]]
...
--REPLACE ME
GameData["modifiers"]["modifier_33"]["target_type_name"] = [[tau_plasma_rifle_crisis_suit_right]]
...
GameData["modifiers"]["modifier_34"]["target_type_name"] = [[tau_plasma_rifle_crisis_suit_right]]
...
GameData["modifiers"]["modifier_35"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
...
--REPLACE ME
GameData["modifiers"]["modifier_36"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
...
--REPLACE ME
GameData["modifiers"]["modifier_37"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
GameData["modifiers"]["modifier_37"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifiers"]["modifier_37"]["value"] = 5
GameData["modifiers"]["modifier_38"] = Reference([[modifiers\max_damage_weapon_modifier.lua]])
GameData["modifiers"]["modifier_38"]["target_type_name"] = [[tau_rail_rifle]]
GameData["modifiers"]["modifier_38"]["value"] = 1.149999976
GameData["modifiers"]["modifier_39"] = Reference([[modifiers\min_damage_weapon_modifier.lua]])
--REPLACE ME
GameData["modifiers"]["modifier_39"]["target_type_name"] = [[tau_rail_rifle]]
GameData["modifiers"]["modifier_39"]["value"] = 1.149999976
GameData["modifiers"]["modifier_40"] = Reference([[modifiers\max_damage_weapon_modifier.lua]])
GameData["modifiers"]["modifier_40"]["target_type_name"] = [[tau_pulse_rifle_pathfinder]]
GameData["modifiers"]["modifier_40"]["value"] = 1.149999976
GameData["modifiers"]["modifier_41"] = Reference([[modifiers\min_damage_weapon_modifier.lua]])
--REPLACE ME
GameData["modifiers"]["modifier_41"]["target_type_name"] = [[tau_pulse_rifle_pathfinder]]
...
GameData["modifiers"]["modifier_42"]["target_type_name"] = [[tau_breacher]]
GameData["modifiers"]["modifier_42"]["value"] = 1.25
GameData["modifiers"]["modifier_43"] = Reference([[modifiers\min_damage_weapon_modifier.lua]])
--REPLACE ME
GameData["modifiers"]["modifier_43"]["target_type_name"] = [[tau_breacher]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\tau_improved_power_source_research.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["research_name"] = [[research\tau_improved_power_source_research.lua]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Further improves the weapon damages of all Tau weapons.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Further improves the maximum range of all Rail Rifles.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- All Crisis Suit weapons are greatly enhanced.]]
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_advanced_pulse_rifle2_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[Heavily Advanced Pulse Rifles]]
