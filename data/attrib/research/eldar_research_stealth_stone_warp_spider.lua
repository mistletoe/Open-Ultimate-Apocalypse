...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\eldar_aspect_stone_warp_spider.lua]]
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[eldar_icons\stealth_stone_warp_spider_icon]]
GameData["ui_info"]["screen_name_id"] = [[$18112168]] -- Warp Spider Stealth Stone Research
