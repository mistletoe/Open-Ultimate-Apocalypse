...
GameData["requirements"]["required_2"]["research_name"] = [[research\marine_generator_boost_research_3.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["research_name"] = [[research\marine_generator_boost_research_3.lua]]
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[npc/production_boost4]]
GameData["ui_info"]["screen_name_id"] = [[$18212012]] -- Increased Generator Production Boost IV
