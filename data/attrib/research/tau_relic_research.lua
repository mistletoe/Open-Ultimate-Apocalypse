...
GameData["requirements"]["required_3"]["research_name_either"] = [[research\tau_teachings_of_kauyon_research.lua]]
GameData["requirements"]["required_3"]["research_name_or"] = [[research\tau_teachings_of_montka_research.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_structure.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["structure_name"] = [[tau_hq]]
