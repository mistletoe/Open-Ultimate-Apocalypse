...
GameData["requirements"]["required_2"]["research_name"] = [[daemons_requisition_research_1]]
...
GameData["requirements"]["required_10"]["research_name"] = [[daemons_requisition_research_1]]
