...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16003461]] -- - Greater Daemonettes.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16003462]] -- - Durability: 4 | Strength: 5 | Morale: 4 | Upgrades: 0 | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 2 | Weapon range: 0 | Capture Points: No.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16003463]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_daemonette_icon_d]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$16003460]] -- Favoured Daemonettes
