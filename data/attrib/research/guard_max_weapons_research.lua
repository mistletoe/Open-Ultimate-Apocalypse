...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[guard_heavy_weapons_team_support_squad]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$692353]] -- - Increases the number of heavy weapons a Guardsman squad can carry by 2.
