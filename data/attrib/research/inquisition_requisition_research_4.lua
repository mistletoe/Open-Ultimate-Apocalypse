...
GameData["requirements"]["required_4"]["research_name"] = [[inquisition_requisition_research_3]]
...
GameData["requirements"]["required_5"]["research_name"] = [[inquisition_requisition_research_3]]
