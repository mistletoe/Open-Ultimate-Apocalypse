...
GameData["requirements"]["required_1"]["research_name"] = [[research\ork_research_extra_armour.lua]]
...
GameData["requirements"]["required_3"] = Reference([[requirements\required_total_pop.lua]])
GameData["requirements"]["required_3"]["population_required"] = 120
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increases the health of all Ork vehicles.]]

GameData["ui_info"]["icon_name"] = [[ork_icons\research_extraarmor_2_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$15043077]] -- Even More Vehicle Armor
