...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210577]] -- - The Librarian learns to use the spell, Mind War; offensive ability that drastically damages single infantry targets, including commanders.
