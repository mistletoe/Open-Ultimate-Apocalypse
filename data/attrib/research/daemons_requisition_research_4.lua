...
GameData["requirements"]["required_2"]["research_name"] = [[daemons_requisition_research_3]]
...
GameData["requirements"]["required_10"]["research_name"] = [[daemons_requisition_research_3]]
