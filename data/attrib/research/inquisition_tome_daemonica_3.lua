...
GameData["modifiers"]["modifier_01"] = Reference([[modifiers\enable_hardpoint_08.lua]])
...
GameData["modifiers"]["modifier_02"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_02"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[inquisition_grey_knight_champion]]
GameData["modifiers"]["modifier_02"]["value"] = 2
GameData["modifiers"]["modifier_03"] = Reference([[modifiers\enable_hardpoint_08.lua]])
...
GameData["modifiers"]["modifier_04"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_04"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[inquisition_grey_knights_justicar]]
GameData["modifiers"]["modifier_04"]["value"] = 2
GameData["modifiers"]["modifier_05"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_05"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[inquisition_grey_knights_interceptor]]
GameData["modifiers"]["modifier_05"]["value"] = 2
GameData["modifiers"]["modifier_06"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_06"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_06"]["target_type_name"] = [[inquisition_grey_knights_purgator]]
GameData["modifiers"]["modifier_06"]["value"] = 2
GameData["modifiers"]["modifier_07"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_07"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_07"]["target_type_name"] = [[inquisition_grey_knights_purifier]]
GameData["modifiers"]["modifier_07"]["value"] = 2
GameData["modifiers"]["modifier_08"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_08"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_08"]["target_type_name"] = [[inquisition_grey_knights_terminator]]
GameData["modifiers"]["modifier_08"]["value"] = 2
GameData["modifiers"]["modifier_09"] = Reference([[modifiers\enable_hardpoint_08.lua]])
...
GameData["modifiers"]["modifier_10"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_10"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[inquisition_grey_knights_terminator_paladin]]
GameData["modifiers"]["modifier_10"]["value"] = 2
GameData["modifiers"]["modifier_11"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_11"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_11"]["target_type_name"] = [[inquisition_dreadnought_assault]]
GameData["modifiers"]["modifier_11"]["value"] = 2
GameData["modifiers"]["modifier_12"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_12"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_12"]["target_type_name"] = [[inquisition_dreadnought_support]]
GameData["modifiers"]["modifier_12"]["value"] = 2
GameData["modifiers"]["modifier_13"] = Reference([[modifiers\enable_hardpoint_08.lua]])
GameData["modifiers"]["modifier_13"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_13"]["target_type_name"] = [[inquisition_dreadnought_venerable]]
...
GameData["requirements"]["required_4"]["research_name"] = [[research\inquisition_tome_blades.lua]]
...
GameData["requirements"]["required_5"]["research_name"] = [[research\inquisition_tome_aegis.lua]]
...
GameData["requirements"]["required_6"]["research_name"] = [[research\inquisition_tome_psykers.lua]]
...
GameData["requirements"]["required_7"]["research_name"] = [[research\inquisition_tome_daemonica_2.lua]]
GameData["requirements"]["required_7"]["hide_the_button_when_failed"] = nil
GameData["requirements"]["required_7"]["research_must_not_be_complete"] = nil
GameData["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["research_name"] = [[research\inquisition_tome_daemonica_2.lua]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022181]] -- - Grants all grey knights and grey knight dreadnoughts attacks that decrease their targets health regeneration.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022182]] -- - Grants melee resistance to grey knights.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022183]] -- + A core component of the grey knight's arsenal, this book contains crucial knowledge on daemon slaying.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022077]] -- 
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_daemonica_3_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$16022180]] -- Tome: Libre Daemonica - Section III
