...
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[tyranids_melee_broodlord]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16029538]] -- - Increases the melee damage of all Gaunts, Raveners, Warriors, Biovores, and Zoanthropes.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_adrenalin_warrior]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$16029536]] -- Biomorph - Adrenal Glands Research II
