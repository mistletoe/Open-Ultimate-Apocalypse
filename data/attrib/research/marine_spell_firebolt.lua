...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210569]] -- - The Librarian learns to use the spell, Firebolt; offensive ability with an area of effect that damages all enemies with fire, medium damage. 
