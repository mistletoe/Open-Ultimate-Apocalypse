...
GameData["requirements"]["required_4"]["research_name"] = [[inquisition_generator_boost_research_4]]
...
GameData["requirements"]["required_5"]["research_name"] = [[inquisition_generator_boost_research_4]]
