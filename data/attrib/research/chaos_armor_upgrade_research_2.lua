...
GameData["requirements"]["required_2"]["research_name"] = [[chaos_armor_upgrade_research.lua]]
...
GameData["requirements"]["required_10"]["research_name"] = [[chaos_armor_upgrade_research.lua]]
