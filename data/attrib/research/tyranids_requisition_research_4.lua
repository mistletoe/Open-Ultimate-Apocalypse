...
GameData["requirements"]["required_2"]["research_name"] = [[tyranids_requisition_research_3]]
...
GameData["requirements"]["required_10"]["research_name"] = [[tyranids_requisition_research_3]]
