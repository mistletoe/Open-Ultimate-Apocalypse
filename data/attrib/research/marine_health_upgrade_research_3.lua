...
--REPLACE ME
GameData["modifiers"]["modifier_11"]["target_type_name"] = [[space_marine_deathwatch]]
...
GameData["modifiers"]["modifier_12"]["value"] = 75
...
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[sternguard_veteran]]
GameData["modifiers"]["modifier_19"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifiers"]["modifier_19"]["value"] = 100
...
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[vanguard_veteran]]
...
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[apothecary]]
...
GameData["modifiers"]["modifier_25"]["target_type_name"] = [[terminator_apothecary]]
GameData["modifiers"]["modifier_25"]["value"] = 1.230000019
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Dramatically increases the health of all infantry.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increases the morale of all infantry.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18211086]] -- - Third of three possible upgrades.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[space_marine_icons/marine_health_research_3_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18211087]] -- Wargear: Bionics Level 3
