...
GameData["modifiers"]["modifier_14"]["target_type_name"] = [[ork_big_shoota_dred_right]]
...
GameData["modifiers"]["modifier_18"]["target_type_name"] = [[ork_shotgun]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[ork_slugga_boy]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[ork_kommando]]
GameData["modifiers"]["modifier_21"]["value"] = 2
GameData["modifiers"]["modifier_22"] = Reference([[modifiers\max_damage_weapon_modifier.lua]])
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[ork_big_shoota_ard]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_23"]["target_type_name"] = [[ork_big_shoota_ard]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increases the damage output of all Rokkit Launchas, Big Shootas, and Burnas.]]
