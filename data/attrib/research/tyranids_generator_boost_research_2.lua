...
GameData["requirements"]["required_2"]["research_name"] = [[tyranids_generator_boost_research_1]]
...
GameData["requirements"]["required_10"]["research_name"] = [[tyranids_generator_boost_research_1]]
