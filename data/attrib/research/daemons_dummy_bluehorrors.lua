...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16000186]] -- - (Deepstrike) Ranged anti vehicle unit.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16000187]] -- - Durability: 3 | Strength: 4.5 | Morale: 3.5 | Upgrades: 1 | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 0 | Weapon range: Standard | Capture Points: No.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16000188]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16000189]] -- 
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bluehorror_icon_d]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$16000185]] -- Pink Horrors
