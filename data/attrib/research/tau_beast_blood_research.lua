...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111838]] -- - Increases the regeneration rates in which all kroot units heal.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111839]] -- - First of two possible researches.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_kroot_melee_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18111837]] -- Beast Blood Upgrade
