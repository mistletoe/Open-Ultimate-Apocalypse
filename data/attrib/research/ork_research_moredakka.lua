...
GameData["modifiers"]["modifier_17"]["target_type_name"] = [[ork_deff_gun]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_18"]["target_type_name"] = [[ork_deff_gun]]
...
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[ork_big_shoota_slugga]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[ork_big_shoota_slugga]]
...
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[ork_slugga_armored_nob]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[ork_slugga_armored_nob]]
...
GameData["modifiers"]["modifier_26"]["target_type_name"] = [[ork_slugga_baddok]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_27"]["target_type_name"] = [[ork_big_shoota_ard]]
...
GameData["modifiers"]["modifier_28"]["target_type_name"] = [[ork_big_shoota_ard]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_29"]["target_type_name"] = [[ork_big_shoota_killakan]]
...
GameData["modifiers"]["modifier_30"]["target_type_name"] = [[ork_big_shoota_killakan]]
...
GameData["requirements"]["required_2"]["population_required"] = 30
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Improves the damage output of all basic shootas and Big Shootas.]]
