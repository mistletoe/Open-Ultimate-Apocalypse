...
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_turret_upgrade.lua]]
...
GameData["requirements"]["required_10"]["research_name"] = [[research\daemons_turret_upgrade.lua]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16002108]] -- - Further increases the health of Daemonclaws Obelisks.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16002109]] -- - Further increases the maximum range and damage of Doombolt and Firebolt weapons.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_turret_fortification_rsrch2_icon]]
--REPLACE_ME
