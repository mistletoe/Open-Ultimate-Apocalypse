...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[Biomorph - Keen Senses: Expands the awareness of this creature.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increases the keen sight radius (infiltration detection) of the Lictor.]]
--REPLACE_ME
