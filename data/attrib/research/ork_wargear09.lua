...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$3001681]] -- Skullz: Show off yer 'ead 'unting with the skullz of yer enemies on a couple nice pointy sticks!
GameData["ui_info"]["help_text_list"]["text_02"] = [[$3001682]] -- Damages enemy morale; increases Warboss's health.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210589]] -- - Requires - Hero: Level 3
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[ork_icons/ork_wargear09]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$3001680]] -- Skullz
