...
GameData["requirements"]["required_3"]["research_name"] = [[research\guard_turret_upgrade1.lua]]
...
GameData["requirements"]["required_10"]["research_name"] = [[research\guard_turret_upgrade1.lua]]
...
GameData["time_cost"]["cost"]["requisition"] = 480
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111266]] -- - Upgrades standard turret weapons with Punisher Cannons, very effective against all infantry types.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_turret_heavy_bolter_rsrch2]]
--REPLACE_ME
