...
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[ork_ard_boy_nob]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Further increases the health of all Ork vehicles.]]

GameData["ui_info"]["icon_name"] = [[ork_icons/research_extraarmor_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$15043076]] -- Extra Vehicle Armor
