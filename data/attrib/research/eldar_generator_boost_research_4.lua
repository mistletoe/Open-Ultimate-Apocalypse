...
GameData["requirements"]["required_4"]["research_name"] = [[eldar_generator_boost_research_3]]
...
GameData["requirements"]["required_5"]["research_name"] = [[eldar_generator_boost_research_3]]
