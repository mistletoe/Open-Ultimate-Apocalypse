...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[dark_eldar_dark_lance_warrior]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_24"]["target_type_name"] = [[dark_eldar_splinter_cannon_trueborn]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_25"]["target_type_name"] = [[dark_eldar_dark_lance_trueborn]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_26"]["target_type_name"] = [[dark_eldar_splinter_cannon_warrior]]
GameData["modifiers"]["modifier_26"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifiers"]["modifier_26"]["value"] = 5
...
GameData["modifiers"]["modifier_29"]["value"] = 5
...
GameData["modifiers"]["modifier_35"]["value"] = 5
...
GameData["requirements"]["required_2"]["research_name"] = [[research\dark_eldar_range_increase_research.lua]]
...
GameData["requirements"]["required_10"]["research_name"] = [[research\dark_eldar_range_increase_research.lua]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4150088]] -- - Improves the propulsion system used in Dark Eldar splinter gun technology.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111406]] -- - Further improves the weapon ranges of Dark Eldar weaponry.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/research_range2_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18111405]] -- Improved Splinter Booster Research
