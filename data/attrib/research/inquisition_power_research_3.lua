...
GameData["requirements"]["required_4"]["research_name"] = [[inquisition_power_research_2]]
...
GameData["requirements"]["required_5"]["research_name"] = [[inquisition_power_research_2]]
