...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\eldar_aspect_stone_banshees.lua]]
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[eldar_icons\stealth_stone_banshee_icon]]
GameData["ui_info"]["screen_name_id"] = [[$18112164]] -- Banshee Stealth Stone Research
