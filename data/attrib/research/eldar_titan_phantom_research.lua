...
--REPLACE ME
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[eldar_titan_phantom]]
...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[eldar_pulsar_phantom_titan_left]]
GameData["modifiers"]["modifier_02"]["value"] = 1.25
GameData["modifiers"]["modifier_03"] = Reference([[modifiers\max_damage_weapon_modifier.lua]])
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[eldar_pulsar_phantom_titan_right]]
...
--REPLACE ME
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[eldar_pulsar_phantom_titan_left]]
...
--REPLACE ME
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[eldar_pulsar_phantom_titan_right]]
...
--REPLACE ME
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[eldar_squad_titan_phantom]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211007]] -- - Increases the firepower, health, and void shields of the Phantom Titan.

GameData["ui_info"]["icon_name"] = [[eldar_icons/research_phantom_titan]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18211006]] -- Imbue: The Phantom
