...
--REPLACE ME
GameData["modifiers"]["modifier_13"]["target_type_name"] = [[ork_ard_boy_nob]]
GameData["modifiers"]["modifier_14"] = Reference([[modifiers\default_weapon_modifier_hardpoint2.lua]])
--REPLACE ME
GameData["modifiers"]["modifier_14"]["target_type_name"] = [[ork_kommando_nob]]
...
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[ork_choppa_flash_gitz]]
...
--REPLACE ME
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[ork_choppa_flash_gitz]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- We needs more choppin'!]]
