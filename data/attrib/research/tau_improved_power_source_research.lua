...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
...
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[tau_pulse_carbine_fire_warrior]]
...
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[tau_rail_rifle]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_23"]["target_type_name"] = [[tau_rail_rifle]]
...
GameData["modifiers"]["modifier_24"]["target_type_name"] = [[tau_pulse_rifle_pathfinder]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_25"]["target_type_name"] = [[tau_pulse_rifle_pathfinder]]
...
GameData["modifiers"]["modifier_26"]["target_type_name"] = [[tau_breacher]]
...
--REPLACE_ME
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Improves the weapon damages of all Tau weapons.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Improves the maximum range of all Rail Rifles.]]
--REPLACE_ME
