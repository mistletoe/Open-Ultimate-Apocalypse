...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16002030]] -- - Provides a global bonus to the power resource.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16002031]] -- - Also decreases the amount of time it takes to donate between power trades.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16002244]] -- - Reduces the time needed to perform any of the available trades for Daemonic Power.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16002032]] -- - First of four possible upgrades.
--REPLACE_ME
