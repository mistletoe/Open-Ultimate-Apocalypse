...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_07"]["target_type_name"] = [[weapon\eldar_brightlance_listenpost.lua]]
...
GameData["modifiers"]["modifier_08"]["target_type_name"] = [[eldar_listening_post]]
...
GameData["modifiers"]["modifier_09"]["target_type_name"] = [[eldar_listening_post]]
...
GameData["requirements"]["required_10"]["structure_name"] = [[Data\attrib\ebps\races\eldar\structures\eldar_hq.lua]]
...
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[eldar_icons/listening_post_research]]
--REPLACE_ME
