...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[tau_broadside_battlesuits]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_06"]["target_type_name"] = [[tau_broadside_battlesuits_xv8_shasvre]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_07"]["target_type_name"] = [[tau_crisis_suit]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_08"]["target_type_name"] = [[tau_drone_remora]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_09"]["target_type_name"] = [[tau_drone_squad]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[tau_drone_turret]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_11"]["target_type_name"] = [[tau_drone_harbinger]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_12"]["target_type_name"] = [[tau_harbinger_drones]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_13"]["target_type_name"] = [[tau_healer_drone]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_14"]["target_type_name"] = [[tau_shield_drone]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_15"]["target_type_name"] = [[tau_sniper_drone]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_16"]["target_type_name"] = [[tau_stealth_suit]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_17"]["target_type_name"] = [[tau_xv81_crisis_suit]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_18"]["target_type_name"] = [[tau_xv9_hazard_suit]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[tau_builder]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[tau_builder_commander]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[tau_shasui_fire_warrior]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_22"]["target_type_name"] = [[tau_shasui_fire_warrior_bodyguard_sp]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_23"]["target_type_name"] = [[tau_shasvre_stealth_suit]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_24"]["target_type_name"] = [[tau_commander]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_25"]["target_type_name"] = [[tau_xv89_commander]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_26"]["target_type_name"] = [[tau_xv89_bodyguard]]
...
--INTENTIONAL SPACER
GameData["modifiers"]["modifier_27"]["target_type_name"] = [[tau_breacher]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Dramatically increases the health of all Tau infantry units.]]
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_research_superior_armor]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18111742]] -- Montka Metallurgy
