...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$701650]] -- - Equips all Space Marine squads with Target Finder wargear.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$701651]] -- - Improves ranged weapon accuracy for Space Marine squads.
