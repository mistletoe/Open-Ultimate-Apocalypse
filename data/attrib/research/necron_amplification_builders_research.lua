...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211365]] -- - Grants health, health regeneration, construction speed, and repair speed bonus per Amplification Generator constructed to all Builder Scarabs.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211359]] -- - CHOOSE WISELY! Only 4 amplification researches can be chosen.
--REPLACE_ME
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_amplification_builders_icon]]
--REPLACE_ME
GameData["ui_info"]["screen_name_id"] = [[$18211364]] -- Amplification Research: Builders
