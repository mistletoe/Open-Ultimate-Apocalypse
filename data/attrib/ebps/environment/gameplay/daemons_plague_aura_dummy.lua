...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\daemons_plague_aura_dummy1.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\daemons_plague_aura_dummy2.lua]]
