...
GameData["direct_spawn_ext"]["button_texture"] = [[necron_icons/monolith_phalanx]]
GameData["direct_spawn_ext"]["recharge_period"] = 60
GameData["direct_spawn_ext"]["spawned_entity"] = [[necron_monolith_siege]]
GameData["direct_spawn_ext"]["spawned_squad"] = [[necron_siege_monolith_squad]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Necrons/Troops/Necron_Doomsday_Monolith]]
...
GameData["event_manager_ext"]["event_07"]["event_entry_01"]["event_name"] = [[Necron\Abilities\Necron_Doomsday_Phalanx]]
...
GameData["health_ext"]["max_repairers"] = 1000
...
GameData["modifier_apply_ext"]["modifiers"]["modifier_02"] = Reference([[modifiers\morale_break_event_space_marine.lua]])
...
GameData["spawn_ext"]["oncreate_motion_name"] = [[land]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech\Races\Necron\Buildings\Doomsdaymonolith]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_e]]
GameData["ui_ext"]["ui_index_hint"] = 3
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011050]] -- - (Deepstrike) 750 RELIC POINTS! Siege/titan unit. ~~~ Can teleport; can direct spawn siege monoliths; protects all units from ranged attacks within a 20m radius; immune to most superweapons; allows Necron infantry to teleport to this unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011051]] -- - Durability: Very Excellent | Strength: Excellent | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Very slow | Sight: Excellent |  Keen sight: None | Abilities: Average | Weapon range: Very long | Capture Points: No.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011039]] -- 
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[necron_icons\doomsady_monolith_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011049]] -- Doomsday Monolith
