...
GameData["entity_blueprint_ext"]["animator"] = [[Races\Imperial_Walls\Walls\Wall_sm]]
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/wall_0_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18210465]] -- Tainted Defensive Wall
