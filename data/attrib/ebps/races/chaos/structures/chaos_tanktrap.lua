...
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\all_tanktrap_aura.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18211793]] -- - Tainted emplacement of Chaos, can see enemies passing by and can detect infiltrated units.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18211794]] -- - Blocks enemy movement and provides mild cover.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18210473]] -- - Cheap, small, and is effective at trapping tanks or confuse movement. Only dedicated detectors can detect Tank Traps.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18210470]] -- - Can be upgraded by addons to improve this fortification with a defensive turret and health bonus.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[npc/tanktrap]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18211792]] -- Tainted Tank Trap
