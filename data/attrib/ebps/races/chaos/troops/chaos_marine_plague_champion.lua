...
GameData["ability_ext"]["abilities"]["ability_09"] = [[abilities\chaos_nurgles_rot.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\chaos_plasma_pistol_champion_cultist.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Chaos_Marines/Plague_Marines_Champion]]
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/plague_champion]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[Plague Marine Champion]]
