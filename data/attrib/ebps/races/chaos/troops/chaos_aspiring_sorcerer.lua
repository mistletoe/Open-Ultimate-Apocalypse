...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\chaos_bolt_of_change_aspiringsorcerer.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\chaos_warp_time_aspiringsorcerer.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\chaos_aspiring_sorceror_force_weapon.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[chaos_power_fist]]
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\chaos_power_fist_champion.lua]]
...
GameData["requirement_ext"]["requirements"]["required_1"]["structure_name"] = [[ebps\races\chaos\structures\chaos_sacrificial_circle.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Chaos_Marines/Aspiring_Sorceror]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_q]]
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$97391]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011092]] -- - Leader unit. ~~~ Provides bonuses of special modifiers to all units in the squad; contains improved training in melee combat.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011099]] -- - Durability: Average | Strength: Basic | Morale: Immune | Upgrades: Few | Movement Speed: Standard | Sight: Standard |  Keen sight: 8m | Abilities: Average | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/chaos_aspsorcerer]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011098]] -- Aspiring Sorceror
