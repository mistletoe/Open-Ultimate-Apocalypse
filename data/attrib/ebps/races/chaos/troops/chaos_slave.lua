...
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$97371]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011069]] -- - Builder unit. ~~~ Can construct buildings at a fast rate when overworked.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18011070]] -- - Durability: Weak | Strength: No Attack | Morale: Basic | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Standard |  Keen sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: No.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011068]] -- Heretic
