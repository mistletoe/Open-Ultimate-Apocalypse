...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450072]] -- - One of the Alpha Legion's most veteran Chaos Space Marines.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$667452]] -- - Powerful all-purpose combat unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$667453]] -- - Can be possessed by the Bloodthirster.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$667454]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/aspiring_champion_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$667455]] -- Chosen Champion
