...
GameData["health_ext"]["hitpoints"] = 1160
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450069]] -- - Drawn from the Alpha Legion's most voracious Khorne Berserkers.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$667555]] -- - Powerful close combat unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$667552]] -- - Quick movement speed allows Khorne Berzerkers to quickly close with enemy units.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$667551]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[chaos_icons/chaos_marine_icon_khorne_berzerker]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$667553]] -- Berzerker Champion
