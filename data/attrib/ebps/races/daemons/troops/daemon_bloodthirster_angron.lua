...
GameData["health_ext"]["hitpoints"] = 21000
...
GameData["requirement_ext"]["requirements"]["required_1"]["research_name"] = [[daemons_wargear_angron1]]
GameData["requirement_ext"]["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirement_ext"]["requirements"]["required_2"]["research_name"] = [[daemons_wargear_angron2]]
GameData["requirement_ext"]["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirement_ext"]["requirements"]["required_3"]["research_name"] = [[daemons_wargear_angron3]]
GameData["requirement_ext"]["requirements"]["required_4"] = Reference([[requirements\required_research.lua]])
GameData["requirement_ext"]["requirements"]["required_4"]["research_name"] = [[daemons_wargear_angron4]]
