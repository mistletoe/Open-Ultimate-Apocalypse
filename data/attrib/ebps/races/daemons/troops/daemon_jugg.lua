...
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\daemons_jugg_head_butt.lua]]
GameData["ability_ext"]["abilities"]["ability_06"] = [[abilities\daemons_jugg_enraged80.lua]]
GameData["ability_ext"]["abilities"]["ability_07"] = [[abilities\daemons_jugg_enraged40.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[daemons_jugg_bite.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Daemons/Troops/daemon_juggernaut]]
...
GameData["melee_ext"]["in_melee_modifiers"]["modifier_01"]["value"] = 0.8000000119
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["dead_zombie_time"] = 2.029999971
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["distance"] = 1
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["killer_invulnerable_time"] = 2.029999971
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["killer_motion_name"] = [[synckill_1]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Daemons/Juggernaut]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_q]]
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16000213]] -- - Vehicle/siege unit.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000215]] -- - Able to deal more damage and take more punishment the more the Juggernaut's health decreases.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000214]] -- - Durability: 5.5 | Strength: 6 | Morale: Immune | Upgrades: 0 | Squad Size: Single | Movement Speed: Fast | Sight: Standard | Keen Sight: None | Ability Strength: 4 | Weapon range: 0 | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_juggernaut_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16000212]] -- Juggernaut
