...
GameData["health_ext"]["regeneration_decrease_in_combat"] = -0.5
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16003368]] -- - Possessed Daemonic Lord favoured by Khorne, a towering very strong close combat unit.
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_lord_stature_khorne_icon]]
