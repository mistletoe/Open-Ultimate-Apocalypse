...
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\guard_inferno_grenade_barrage.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\guard_heavy_flamer_firesword.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Imperial_Guard/Troops/Firesword]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011533]] -- - Durability: Excellent | Strength: Excellent | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Standard | Sight: Excellent | Keen Sight: None | Abilities: None | Weapon range: Very Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_firesword]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011540]] -- Firesword
