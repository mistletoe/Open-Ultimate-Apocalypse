...
GameData["health_ext"]["hitpoints"] = 1025
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$668703]] -- - Priest of the Ordo Ministorum.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$690651]] -- - Inspire squads to fight courageously.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$668706]] -- - Fanaticism ability can make any squad he is attached to temporarily invulnerable.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$]]
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_priest]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$668702]] -- Regimental Confessor
