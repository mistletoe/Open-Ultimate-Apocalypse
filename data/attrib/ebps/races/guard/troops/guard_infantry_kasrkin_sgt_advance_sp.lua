...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$690253]] -- - Adds Hit Points to each squad member.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$690254]] -- - Adds Morale to the squad.
