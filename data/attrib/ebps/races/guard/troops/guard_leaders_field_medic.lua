...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\guard_medic_healing_aura.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\guard_medic_invulnerable_aura.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Guard/medic]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_r]]
GameData["ui_ext"]["ui_index_hint"] = 4
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011453]] -- - Basic medical unit. ~~~ Contains an aura around himself which heals nearby infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011454]] -- - Durability: Basic | Strength: Weak | Morale: Basic | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Basic | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/Guard_command_squad_medic]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011452]] -- Field Medic
