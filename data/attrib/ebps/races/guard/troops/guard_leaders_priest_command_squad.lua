...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011444]] -- - Deterrent support unit. ~~~ Inspires the morale of an attached squad, making the squad more vigilant and aggressive.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011447]] -- - Support unit. ~~~ Provides an attached squad with health, morale, and speed bonuses.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011448]] -- - Durability: Average | Strength: Basic | Morale: Average | Upgrades: None | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/leader_squad_priest]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011446]] -- Priest
