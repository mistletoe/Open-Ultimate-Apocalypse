...
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\guard_spotter_infiltrate.lua]]
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$3950234]] -- - Provides targeting information for the Basilisk Magnus.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$3950235]] -- - Kill quickly to prevent the Magnus from firing.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_sargeant_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$3950233]] -- Artillery Spotter
