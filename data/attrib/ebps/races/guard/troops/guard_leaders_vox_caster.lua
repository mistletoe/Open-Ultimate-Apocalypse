...
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\guard_vox_rally.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Guard/Guardsman;Speech/Races/Guard/Vox]]
