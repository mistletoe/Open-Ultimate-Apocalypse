...
GameData["spawner_ext"]["squad_table"]["squad_01"] = [[sbps\races\guard\guard_squad_guardsmen_conscript.lua]]
...
GameData["squad_hold_ext"]["acceptable_type_03"] = Reference([[type_transportable\transport_lieutenant.lua]])
GameData["squad_hold_ext"]["acceptable_type_04"] = Reference([[type_transportable\transport_tank.lua]])
GameData["squad_hold_ext"]["acceptable_type_05"] = Reference([[type_transportable\transport_general.lua]])
--INTENTIONAL SPACER
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011650]] -- Valkyrie Transport
