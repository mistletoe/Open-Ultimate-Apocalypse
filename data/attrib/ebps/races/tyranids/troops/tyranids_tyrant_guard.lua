...
GameData["ability_ext"]["abilities"]["ability_01"] = nil
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_melee_tyrant_guard.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["muzzle"]["y"] = 0.5
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[<Crush_Claw>]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["origin"]["y"] = 0.5
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_melee_tyrant_guard_crushclaw.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[races\tyranids\troops\tyrant_guard]]
...
GameData["health_ext"]["armour_minimum"] = 22
...
GameData["health_ext"]["post_death_event_delay"] = 5.5
GameData["health_ext"]["pre_death_event_delay"] = 6.5
...
GameData["special_attacks_ext"]["special_attacks"]["special_attack_01"]["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 119
...
GameData["special_attacks_ext"]["special_attacks"]["special_attack_01"]["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 35
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["chance"] = 33
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_01"]["dead_zombie_time"] = 5.699999809
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_02"]["chance"] = 33
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_02"]["dead_zombie_time"] = 6.03000021
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_02"]["killer_motion_name"] = [[SyncKill_3]]
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_03"]["chance"] = 34
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16026091]] -- - Meat shield / siege monstrous unit. ~~~ Absorbs most ranged attacks with its carapace shell armor; regenerates really quickly when in combat.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16026092]] -- - Effective versus infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16026093]] -- - Durability: 10 | Strength: 3 | Morale: 5 | Upgrades: 0 | Squad Size: Below Standard | Movement Speed: Slow | Sight: Standard | Keen Sight: None | Ability Strength: 0 | Weapon range: 0 | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tyranids_icons/i_tyrant_guard]]
