...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\tyranids_infiltration.lua]]
...
GameData["health_ext"]["return_from_dead_duration"] = 3
...
GameData["moving_ext"]["speed_max"] = 22.5
