...
GameData["health_ext"]["hitpoints"] = 133
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16026059]] --  - WoN: Without Number: Free, accelerated Unit Spawn, and faster than Spinegaunts MaSS (swarm unit, provides nearby bonuses such as strength, health regen, and production speed).
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[Tyranids_icons/i_spinegaunt_won]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16026058]] --  Spinegaunt (Without Number)
