...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\tyranids_trygon_storm.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\tyranids_bioplasma_trygon.lua]]
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\tyranids_tunnel_spawn.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_melee_trygon.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_melee_trygon_crushclaw.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_melee_trygon.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_melee_trygon_crushclaw.lua]]

GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_melee_trygon.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_melee_trygon_crushclaw.lua]]

GameData["combat_ext"]["hardpoints"]["hardpoint_04"]["weapon_table"]["weapon_01"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_04"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_melee_trygon.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_04"]["weapon_table"]["weapon_02"]["name_for_this_weapon_choice"] = [[tyranids_melee_carnifex]]
GameData["combat_ext"]["hardpoints"]["hardpoint_04"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_melee_trygon_crushclaw.lua]]
...
GameData["direct_spawn_ext"]["button_texture"] = [[tyranids_icons/i_ravener]]
...
GameData["direct_spawn_ext"]["spawned_entity"] = [[tyranids_ravener]]
GameData["direct_spawn_ext"]["spawned_squad"] = [[tyranids_squad_ravener]]
GameData["direct_spawn_ext"]["tool_tip_cost"] = 16026912
GameData["direct_spawn_ext"]["tool_tip_ok_power"] = 16026916
GameData["direct_spawn_ext"]["tool_tip_recharge"] = 16026918
GameData["direct_spawn_ext"]["tool_tip_requirements"] = 16026919
GameData["direct_spawn_ext"]["tool_tip_title"] = 16026911
GameData["entity_blueprint_ext"] = Reference([[ebpextensions\entity_blueprint_ext.lua]])
GameData["entity_blueprint_ext"]["animator"] = [[races/tyranids/troops/trygon]]
...
GameData["health_ext"]["hitpoints"] = 13700
...
GameData["special_attacks_ext"]["special_attacks"]["special_attack_01"]["area_effect"]["throw_data"]["force_max"] = 95
GameData["special_attacks_ext"]["special_attacks"]["special_attack_01"]["area_effect"]["throw_data"]["force_min"] = 85
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_02"]["dead_zombie_time"] = 5.300000191
...
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_03"]["dead_zombie_time"] = 5.300000191
GameData["synckill_ext"]["synckillinfos"]["synckillinfo_03"]["killer_invulnerable_time"] = 5.300000191
