...
GameData["entity_blueprint_ext"]["animator"] = [[races/tyranids/structures/warriorhive]]
...
GameData["spawner_ext"]["squad_table"]["squad_03"] = [[sbps\races\tyranids\tyranids_squad_warrior.lua]]
GameData["spawner_ext"]["squad_table"]["squad_04"] = [[sbps\races\tyranids\tyranids_squad_biovores.lua]]
GameData["spawner_ext"]["squad_table"]["squad_05"] = [[sbps\races\tyranids\tyranids_squad_genestealer.lua]]
GameData["spawner_ext"]["squad_table"]["squad_06"] = [[sbps\races\tyranids\tyranids_squad_zoanthropes.lua]]
GameData["spawner_ext"]["squad_table"]["squad_07"] = [[sbps\races\tyranids\tyranids_squad_broodlord.lua]]
GameData["spawner_ext"]["squad_table"]["squad_08"] = [[sbps\races\tyranids\tyranids_squad_lictor_alpha.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[speech/races/tyranids/buildings/warriorhive]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_w]]
GameData["ui_ext"]["ui_index_hint"] = 2
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16025082]] -- - Requisitions improved infantry units.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16025083]] -- - Produces: Raveners, Warriors, Biovores, Zoanthropes, and Lictors.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16025084]] -- - Provides standard infantry researches.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16025085]] -- - Exudes toxic miasma and synapse.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18210738]] -- - Unlocks the Established Link (Add-On).
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tyranids_icons/i_birthing_sacs]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16025080]] -- Brood Hive
