...
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\tyranids_minelaunch.lua]]
GameData["ability_ext"]["abilities"]["ability_09"] = [[abilities\all_ceizefire.lua]]
GameData["addon_ext"] = Reference([[ebpextensions\addon_ext.lua]])
GameData["addon_ext"]["addons"]["addon_01"] = [[addons\tyranids_turret_bioacid_addon.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 3.155999899
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 1.235999942
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["y"] = 3.335999966
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["z"] = -0.3000000119
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\tyranids_turret_mine_launcher.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["muzzle"]["y"] = 3.155999899
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["muzzle"]["z"] = 1.235999942
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["origin"]["y"] = 3.335999966
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["origin"]["z"] = -0.3000000119
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\tyranids_turret_mine_launcher_bioacid.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[races/tyranids/structures/Hive_nest]]
...
GameData["requirement_ext"]["requirements"]["required_1"]["structure_name_either"] = [[ebps\races\tyranids\structures\tyranids_warrior_hive.lua]]
GameData["requirement_ext"]["requirements"]["required_1"]["structure_name_or"] = [[ebps\races\tyranids\structures\tyranids_biomorph_hive.lua]]
...
GameData["requirement_ext"]["requirements"]["required_4"]["structure_name"] = [[ebps\races\tyranids\structures\tyranids_hq.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Dangerous alien turret that fires toxins at enemy targets.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[- Able to be upgraded with multiple addon types.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Effective versus infantry and light armored vehicles.]]
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tyranids_icons\i_turret]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[Bio Plasma Turret]]
