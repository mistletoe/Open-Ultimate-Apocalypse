...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\all_run!.lua]]
...
GameData["entity_blueprint_ext"]["minimum_update_radius"] = 23
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011899]] -- - Builder unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18011900]] -- - Durability: Weak | Strength: No Attack | Morale: Basic | Upgrades: None | Squad Size: Below Standard | Movement Speed: Standard | Sight: Very Good | Keen Sight: 2m | Abilities: None | Weapon Range: Melee | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_builder_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011898]] -- Earth Caste Builder
