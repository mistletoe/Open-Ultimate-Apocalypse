...
GameData["death_explosion_ext"]["death_explosions"]["death_explosion_01"]["area_effect"]["throw_data"]["up_angle_max"] = 30
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011942]] -- - Monstrous elite unit.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011943]] -- - Durability: Very Good | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: None | Weapon range: Standard | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_krootox_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011941]] -- Krootox
