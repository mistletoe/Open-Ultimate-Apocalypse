...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4450101]] -- - Elder Shaper Ortrazk is has fought many wars under Commander Or'es'Ka.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450102]] -- - He bred the Hunting Hounds and Kroot Alphas, and serves with Or'es'Ka to spread the Greater Good.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$706714]] -- - Improves speed and health of squad.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_kroot_shaper_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$4450153]] -- Shaper Ortrazk
