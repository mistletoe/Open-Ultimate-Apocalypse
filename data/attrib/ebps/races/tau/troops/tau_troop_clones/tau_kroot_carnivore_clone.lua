...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$706551]] -- - Infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$706552]] -- - Fast attack close combat unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$706553]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tau_icons/tau_kroot_warrior_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$706550]] -- Kroot Carnivore
