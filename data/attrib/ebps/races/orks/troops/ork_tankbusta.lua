...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\ork_tankbusta_bombs_sp_dxp3_prisoner.lua]]
...
GameData["ability_ext"]["abilities"]["ability_10"] = [[abilities\ork_infiltration_tankbustaz.lua]]
GameData["ability_ext"]["abilities"]["ability_11"] = [[abilities\all_run!.lua]]
GameData["ability_ext"]["abilities"]["ability_12"] = [[abilities\ork_stikkbombs_improved.lua]]
...
GameData["health_ext"]["hitpoints"] = 540
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011574]] -- - Pre-elite anti vehicle ranged unit (infiltrator). ~~~ Gains strength when in a horde of other Ork Boyz and could possibly increase resource income if high enough.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011575]] -- - Durability: Basic | Strength: Average | Morale: Basic | Upgrades: None | Squad Size: Below standard | Movement Speed: Standard | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011576]] -- 
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/tankbustas_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011573]] -- Tank Bustaz
