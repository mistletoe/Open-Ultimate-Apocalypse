...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 0.824000001
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_lobba_guncart.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012060]] -- - Durability: Basic | Strength: Average | Morale: Basic | Upgrades: None | Movement Speed: Slow | Sight: Good | Keen Sight: 2m | Abilities: None | Weapon range: Very long | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/Lobba_cart_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012058]] -- Gun Kart (Kannon)
