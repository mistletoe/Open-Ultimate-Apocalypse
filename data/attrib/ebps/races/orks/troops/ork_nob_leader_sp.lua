...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$668100]] -- - Heavy Infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$668101]] -- - Leader unit effective at close combat and boosting squad morale.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$668102]] -- - Can be upgraded with powerful close combat weapons (Through Pile O Gunz!).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$668104]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
