...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$700550]] -- - Heavy Infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$700551]] -- - Leader unit effective at close combat and boosting squad morale.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$700553]] -- - Can be upgraded with powerful close combat weapons (Through Pile O Gunz).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$700552]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
