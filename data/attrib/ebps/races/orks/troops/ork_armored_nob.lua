...
GameData["ability_ext"]["abilities"]["ability_05"] = [[abilities\ork_power_surge.lua]]
...
GameData["cost_ext"]["time_cost"]["cost"]["power"] = 66.66999817
GameData["cost_ext"]["time_cost"]["cost"]["requisition"] = 266.6700134
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011600]] -- - Improved elite melee unit. ~~~ Gains strength when in a horde of other Ork Boyz and could possibly increase resource income if high enough.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011601]] -- - Durability: Very Good | Strength: Excellent | Morale: Average | Upgrades: None | Squad Size: Standard | Movement Speed: Slow | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: Yes.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011602]] -- 
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/mega_armor_nob]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011599]] -- Mega Armored Nobz
