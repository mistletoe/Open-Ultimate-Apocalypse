...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\ork_gargant_autorepair.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\ork_gargant_great_squish.lua]]
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\ork_gargant_inspiring.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_super_battlecannon_gargant.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["origin"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_zzzap_gun_gargant_right.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["muzzle"]["x"] = -0.2399999946
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 5.980000019
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 7.410009861
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["origin"]["x"] = -0.2399999946
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["origin"]["y"] = 5.980000019
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["origin"]["z"] = 7.409999847
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_bellygun_gargant.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["attack_motion_variable_name"] = [[Weapon_Range_Tracking_Blaster_Front_Left]]
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["hardpoint_weapon_variant_motion_name"] = [[Weapon_Range_Upgrade_Blaster_Front_Left]]
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["horizontal_aim_motion_variable_name"] = [[Aim_Horizontal_Blaster_Front_Left]]
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["shoot_motion_variable_name"] = [[weapon_range_Firing_Blaster_Front_Left]]
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["vertical_aim_motion_variable_name"] = [[Aim_Vertical_Blaster_Front_Left]]
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["weapon_table"]["weapon_01"]["muzzle"]["x"] = -0.3000000119
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 2
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["weapon_table"]["weapon_01"]["origin"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_05"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_super_battlecannon_gargant_top_left.lua]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["attack_motion_variable_name"] = [[Weapon_Range_Tracking_Blaster_Front_Right]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["hardpoint_weapon_variant_motion_name"] = [[Weapon_Range_Upgrade_Blaster_Front_Right]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["horizontal_aim_motion_variable_name"] = [[Aim_Horizontal_Blaster_Front_Right]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["shoot_motion_variable_name"] = [[weapon_range_Firing_Blaster_Front_Right]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["vertical_aim_motion_variable_name"] = [[Aim_Vertical_Blaster_Front_Right]]
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["weapon_table"]["weapon_01"]["muzzle"]["x"] = 0.3000000119
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 2
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["weapon_table"]["weapon_01"]["origin"]["y"] = 7
GameData["combat_ext"]["hardpoints"]["hardpoint_06"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\ork_super_battlecannon_gargant_top.lua]]


GameData["cost_ext"] = Reference([[ebpextensions\cost_ext.lua]])
GameData["cost_ext"]["time_cost"]["cost"]["population"] = 300
GameData["cost_ext"]["time_cost"]["cost"]["power"] = 13610
GameData["cost_ext"]["time_cost"]["cost"]["requisition"] = 5110
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Orks/Troops/Great_Gargant]]
...
GameData["health_ext"]["hitpoints"] = 74000
...
GameData["special_attack_physics_ext"]["mass"] = 3500
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012161]] -- - Super uber tuff improved shooty unit. ~~~ Inspires all Orks around the globe, increasing their morale greatly; tramples over all but heavily armored structures and titans.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012162]] -- - Durability: Legendary | Strength: Unstoppable | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Slow | Sight: Extreme | Keen Sight: None | Abilities: Below Average | Weapon range: Extreme | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/great_gargant_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012160]] -- Great Gargant
