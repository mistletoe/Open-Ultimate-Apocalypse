...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011621]] -- - Aircraft. ~~~ Can jump to any location on the map.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011622]] -- - Durability: Average | Strength: Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Extreme | Sight: Very good | Keen Sight: None | Abilities: Below Average | Weapon range: Very Long | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[ork_icons/fighta_bomma_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011620]] -- Fighta Bomba
