...
GameData["ability_ext"]["abilities"]["ability_07"] = [[abilities\all_thermo_dump_requisition.lua]]
GameData["ability_ext"]["abilities"]["ability_08"] = [[abilities\all_thermo_dump_power.lua]]
