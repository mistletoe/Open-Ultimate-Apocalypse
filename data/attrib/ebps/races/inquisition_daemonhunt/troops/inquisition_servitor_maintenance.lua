...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/inquisition_daemonhunt/servitor]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_r]]
GameData["ui_ext"]["ui_index_hint"] = 4
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021035]] -- - Secondary builder/repair unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16021036]] -- - Durability: 2.5 | Strength: 2.5 | Morale: N/A | Upgrades: 0 | Squad Size: Small | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 0 | Weapon range: 0 | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/servitor_maintenance_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16021034]] -- Maintenance Servitors
