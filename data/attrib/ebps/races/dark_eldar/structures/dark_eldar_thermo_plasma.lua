...
GameData["ability_ext"]["abilities"]["ability_07"] = [[abilities\dark_eldar_generator_boost_1.lua]]
GameData["ability_ext"]["abilities"]["ability_08"] = [[abilities\dark_eldar_generator_boost_2.lua]]
GameData["ability_ext"]["abilities"]["ability_09"] = [[abilities\dark_eldar_generator_boost_3.lua]]
GameData["ability_ext"]["abilities"]["ability_10"] = [[abilities\dark_eldar_generator_boost_4.lua]]
GameData["ability_ext"]["abilities"]["ability_11"] = [[abilities\dark_eldar_generator_boost_5.lua]]
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4050028]] -- - Generates the Power resource at a higher rate than Plasma Generators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4050029]] -- - Can only be built on top of Slag Deposits.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4050030]] -- - Thermo Plasma Generators are volatile and will damage anything nearby when they are destroyed.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$4050031]] -- - Projects a Control Area around itself, allowing other buildings to be built near it.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$4050027]] -- Thermo Plasma Generator
