...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Dark_Eldar/Structures/Corruptedgate]]
...
GameData["modifier_apply_ext"]["modifiers"]["modifier_02"]["target_type_name"] = [[dark_eldar_vehicle_voidraven]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_02"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_02"]["value"] = 420
...
GameData["modifier_apply_ext"]["modifiers"]["modifier_03"]["target_type_name"] = [[dark_eldar_vehicle_voidraven_variant]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_03"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_03"]["value"] = 300
...
GameData["spawner_ext"]["squad_table"]["squad_02"] = [[sbps\races\dark_eldar\dark_eldar_squad_tormentor.lua]]
GameData["spawner_ext"]["squad_table"]["squad_03"] = [[sbps\races\dark_eldar\dark_eldar_squad_tormentor_assault.lua]]
GameData["spawner_ext"]["squad_table"]["squad_04"] = [[sbps\races\dark_eldar\dark_eldar_squad_instigator.lua]]
GameData["spawner_ext"]["squad_table"]["squad_05"] = [[sbps\races\dark_eldar\dark_eldar_squad_voidraven.lua]]
GameData["spawner_ext"]["squad_table"]["squad_06"] = [[sbps\races\dark_eldar\dark_eldar_squad_voidraven_variant.lua]]
GameData["spawner_ext"]["squad_table"]["squad_07"] = [[sbps\races\dark_eldar\dark_eldar_squad_agony_titan.lua]]
GameData["spawner_ext"]["squad_table"]["squad_08"] = [[sbps\races\dark_eldar\dark_eldar_squad_phoenix.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech\Races\Dark_Eldar\Buildings\corrupted_gate]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_u]]
GameData["ui_ext"]["ui_index_hint"] = 7
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$94621]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18111374]] -- - Spawns the titans of the Dark Eldar.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18111375]] -- - Can hold infantry and vehicle squads shared with other structures of this type around the globe.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/de_ancient_corrupted_gate]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18111373]] -- Ancient Websail
