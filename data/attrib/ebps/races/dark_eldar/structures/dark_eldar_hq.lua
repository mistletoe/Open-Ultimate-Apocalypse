...
GameData["event_manager_ext"]["event_10"]["event_entry_01"]["event_name"] = [[Dark_Eldar/kab_tier1]]
GameData["event_manager_ext"]["event_10"]["modifier_name"] = [[morale_break_event]]
GameData["event_manager_ext"]["event_11"]["event_entry_01"]["event_name"] = [[Dark_Eldar/kab_tier2]]
GameData["event_manager_ext"]["event_11"]["modifier_name"] = [[morale_break_event_ork]]
GameData["event_manager_ext"]["event_12"]["event_entry_01"]["event_name"] = [[Dark_Eldar/kab_tier3]]
GameData["event_manager_ext"]["event_12"]["modifier_name"] = [[ability_speed_event]]
GameData["event_manager_ext"]["event_13"]["event_entry_01"]["event_name"] = [[Dark_Eldar/kab_tier4]]
GameData["event_manager_ext"]["event_13"]["modifier_name"] = [[morale_break_event_space_marine]]
