...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\dark_eldar_energy_field_araspida_operative.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\dark_eldar_soul_shock_araspida.lua]]
GameData["ability_ext"]["abilities"]["ability_08"] = [[abilities\dark_eldar_energy_field_araspida.lua]]
GameData["ability_ext"]["abilities"]["ability_09"] = [[abilities\dark_eldar_gruesome_display_araspida.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 5.382999897
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = 0.8759999871
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["y"] = 5.382999897
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["z"] = -1.268000007
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\dark_eldar_dummy_araspida.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Dark_Eldar/Troops/dark_eldar_araspida]]
...
GameData["event_manager_ext"]["event_23"]["event_entry_01"]["event_name"] = [[Dark_Eldar\shield_operative]]
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012348]] -- - Mobile shield generator/deployable wall. ~~~ Projects a shield of energy around itself, protecting allied units within a 20m radius from ranged attacks | contains a gruesome display, hurting morale of nearby enemies | can "entrench", causing the unit to remain stationary, boosting its shield strength and health.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010017]] -- - Effective versus: None
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012349]] -- - Durability: Good, Excellent (Entrenched) | Strength: N/A | Morale: Immune | Upgrades: Single | Squad Size: Single | Movement Speed: Standard | Sight: Bad | Keen Sight: None | Ability Strength: Very Good | Weapon range: None | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/araspida_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012347]] -- Araspida
