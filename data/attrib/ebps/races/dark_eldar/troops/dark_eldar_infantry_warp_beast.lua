...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011243]] -- - Elite monstrous unit. ~~~ Attacks ally units when morale is broken, but can be recovered when attached with a leader.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011244]] -- - Durability: Good | Strength: Excellent | Morale: Average | Upgrades: None | Squad Size: Below standard | Movement Speed: Fast | Sight: Standard | Keen sight: 2m | Abilities: None | Weapon Range: Melee | Capture Points: No.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011245]] -- 
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/warp_beast_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011242]] -- Warp Beasts
