...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4050156]] -- - Elite Incubi culled from Asdrubael Vect's personal bodyguard.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4050157]] -- - Unmatched among the Dark Eldar in combat skill or pure malice.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4050158]] -- - Effective aganst infantry.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[dark_eldar_icons/HG_incubus_icon]]

GameData["ui_ext"]["ui_info"]["pseudo_leader"] = true 
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$4050155]] -- Elite Incubus
