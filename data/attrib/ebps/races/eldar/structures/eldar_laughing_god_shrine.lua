...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Eldar/Structures/laughing_god_comm]]
...
GameData["relocatee_ext"]["dummy_structure_name"] = [[relocate_khaine_shrine]]
...
GameData["requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\eldar_tier2_research.lua]]
...
GameData["research_ext"]["research_table"]["research_01"] = [[research\eldar_research_stealth_stone_harlequin.lua]]
GameData["research_ext"]["research_table"]["research_02"] = [[research\eldar_research_stealth_stone_autarch.lua]]
GameData["research_ext"]["research_table"]["research_03"] = [[research\eldar_research_stealth_stone_shining_spears.lua]]
GameData["research_ext"]["research_table"]["research_04"] = [[research\eldar_research_shining_spear_squadsize.lua]]
GameData["research_ext"]["research_table"]["research_05"] = [[research\eldar_research_stealth_stone_shadowseer.lua]]
GameData["research_ext"]["research_table"]["research_06"] = [[research\eldar_laughing_god_research.lua]]
GameData["sight_ext"] = Reference([[ebpextensions\sight_ext.lua]])
GameData["sight_ext"]["sight_radius"] = 15
GameData["sim_entity_ext"] = Reference([[ebpextensions\sim_entity_ext.lua]])
GameData["sim_entity_ext"]["is_collide"] = true 
GameData["spawner_ext"] = Reference([[ebpextensions\spawner_ext.lua]])
GameData["spawner_ext"]["squad_table"]["squad_01"] = [[sbps\races\eldar\eldar_squad_laughing_god.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech\Races\Eldar\Buildings\shrine_laughing_god]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_y]]
GameData["ui_ext"]["ui_index_hint"] = 6
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$94641]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18211115]] -- - Produces the Eldar's powerful hero/god unit, the Laughing God.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18211116]] -- - Contains research that allows cloaking of Harlequin related units and the Autarch. 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18211117]] -- - Allows an assortment of upgrades for Shining Spears and the production of the Shadowseer and Vampire Raider.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/eldar_laughing_god_comm_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18211114]] -- Shrine of the Laughing God
