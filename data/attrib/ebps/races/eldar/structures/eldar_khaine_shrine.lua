...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Eldar/Structures/Khala_Mensha_Khaine_Shrine]]
...
GameData["research_ext"]["research_table"]["research_01"] = [[research\eldar_khaine_research_1.lua]]
GameData["research_ext"]["research_table"]["research_02"] = [[research\eldar_khaine_research_2.lua]]
GameData["research_ext"]["research_table"]["research_04"] = [[research\eldar_warlock_ability_research_3.lua]]
GameData["research_ext"]["research_table"]["research_05"] = [[research\eldar_exarch_ability_research_3.lua]]
GameData["research_ext"]["research_table"]["research_06"] = [[research\eldar_exarch_ability_research_4.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_01"] = [[sbps\races\eldar\eldar_squad_avatar.lua]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech\Races\Eldar\Buildings\shrine_wailing_doom]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_t]]
GameData["ui_ext"]["ui_index_hint"] = 5
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$94641]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18111297]] -- - Produces the Eldar's powerful hero/god unit, the Avatar of Khaine.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18211848]] -- - Contains research that globally increase morale and grants deadly weapons to specific unit types.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/kmk_shrine_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18111296]] -- Shrine of the Wailing Doom
