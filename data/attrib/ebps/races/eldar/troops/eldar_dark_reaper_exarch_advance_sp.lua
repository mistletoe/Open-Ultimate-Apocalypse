...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$669300]] -- - Council composed of the three deadliest Dark Reaper Exarchs from Craftworld Ulthwé.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450076]] -- - Serve as Caerys' personal protectors and are often called on to serve as the anchor of her forces.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$669303]] -- - Ranged combat specialists.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$669302]] -- - Effective against Infantry and Heavy Infantry.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/upgrade_exarch_dark_reaper]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$669305]] -- Reaper Exarch Council
