...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011298]] -- - Early harrassment ranged starting unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18011299]] -- - Durability: Basic | Strength: Basic | Morale: Basic | Upgrades: None | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/guardian_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011297]] -- Guardian Defenders
