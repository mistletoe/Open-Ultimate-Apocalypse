...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\eldar_lasblaster.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Eldar/Troops/swooping_hawk_codex]]
...
GameData["ui_ext"]["speech_directory"] = [[Speech/Races/Eldar/Swooping_hawks]]
GameData["ui_ext"]["ui_hotkey_name"] = [[hotkey_r]]
GameData["ui_ext"]["ui_index_hint"] = 4
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012115]] -- - Pre elite ranged combat unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012116]] -- - Durability: Average | Strength: Average | Squad Size: Standard | Upgrades: None | Morale: Average | Movement Speed: Very Fast | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012117]] -- 
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[eldar_icons/swooping_hawk]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012114]] -- Swooping Hawks
