...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011357]] -- - Durability: Average | Strength: Average | Morale: Immune | Upgrades: None | Movement Speed: Standard | Sight: Standard | Keen Sight: None | Abilities: None | Weapon range: Long | Capture Points: No.
--INTENTIONAL SPACER
