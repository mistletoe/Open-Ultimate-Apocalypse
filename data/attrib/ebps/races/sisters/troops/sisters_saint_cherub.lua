...
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\all_infiltration_self.lua]]
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\sisters_accuracy_aura_cherub.lua]]
