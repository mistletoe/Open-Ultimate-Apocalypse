...
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\sisters_krak_grenades.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011696]] -- - Durability: Average | Strength: Average | Upgrades: None | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Basic | Weapon Range: Melee | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_leader_celestian_vet]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011704]] -- Celestian Superior
