...
GameData["resource_ext"]["faith_per_second"] = 0.125
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4250059]] -- - Commander Unit (Primary).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4250060]] -- - Boosts morale and morale recovery when attached to squads.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4250062]] -- - Has access to Acts of Faith: Purifying Light and Ascension.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$4250063]] -- - Faithful. Generates a moderate amount of the Faith Resource while alive.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$4250061]] -- - Versatile hero that is effective at both ranged and melee attacks.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_canoness]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$4250058]] -- Canoness
