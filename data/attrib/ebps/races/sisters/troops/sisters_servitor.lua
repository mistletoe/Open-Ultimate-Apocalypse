...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011659]] -- - Builder unit.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18011660]] -- - Durability: Weak | Strength: No Attack | Squad Size: Below Standard | Upgrades: None | Morale: Basic | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: No.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/squad_support_builder]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011658]] -- Ecclesiarchal Servitor
