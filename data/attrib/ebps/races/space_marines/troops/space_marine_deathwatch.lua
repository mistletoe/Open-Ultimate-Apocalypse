...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\marines_inferno_grenades_deathwatch.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\marines_infiltration_lotd.lua]]
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\marines_frag_grenades.lua]]
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\marines_flashbang_grenades.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/LOTD/Troops/Space_Marine]]
...
GameData["modifier_apply_ext"]["modifiers_idle"]["modifier_01"] = Reference([[modifiers\health_regeneration_modifier.lua]])
...
GameData["modifier_apply_ext"]["modifiers_idle"]["modifier_01"]["value"] = 30
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012365]] -- - (detector) Legion of the Damned pre-elite infantry. ~~~ Will regenerate extremely quickly when idle; is free to recruit but requires a very long build time.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012366]] -- - Durability: Very Good | Strength: Good | Morale: Immune | Upgrades: Few | Squad Size: Below Standard | Movement Speed: Slow | Sight: Good | Keen Sight: 15m | Abilities: Below Average | Weapon range: Good | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/LOTD_space_marine_tactical_bolter_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012364]] -- Legionaires
