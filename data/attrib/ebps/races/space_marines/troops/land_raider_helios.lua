...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["x"] = 0.6999999881
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["y"] = 3.299999952
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["muzzle"]["z"] = -0.6600000262
...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["x"] = 0.6999999881
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["y"] = 3.299999952
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["origin"]["z"] = -1
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\space_marine_missile_battery_helios.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Space_Marines/Troops/Land_Raider_Helios]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011827]] -- - Durability: Excellent | Strength: Excellent.5 | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Very Good | Keen Sight: None | Abilities: Below Average | Weapon range: Artillery (Extreme) | Capture Points: No.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011828]] -- - Relic unit (Transport: 2) (detector). ~~~ Transport rule: Equipped with various support abilities; protects all nearby ally units from ranged attacks and boosts their damage outputs; uses an assortment of map control abilites that jams enemy sensors or reveals the FOW.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/land_raider_helios_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011826]] -- Land Raider Helios
