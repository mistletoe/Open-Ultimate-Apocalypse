...
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\marines_machine_spirit.lua]]
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\marines_smoke_launchers_land_raider.lua]]
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\marines_sensormap_prometheus.lua]]
GameData["ability_ext"]["abilities"]["ability_05"] = [[abilities\marines_ecm_eccm.lua]]
GameData["ability_ext"]["abilities"]["ability_06"] = [[abilities\marines_jammermap_prometheus.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["name_for_this_weapon_choice"] = [[space_marine_quad_bolter]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\space_marine_quad_bolter_right.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_03"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\space_marine_quad_bolter_left.lua]]
...
GameData["combat_ext"]["hardpoints"]["hardpoint_04"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\space_marine_heavy_bolter_land_raider.lua]]
...
GameData["cost_ext"]["time_cost"]["cost"]["power"] = 1200
...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011828]] -- - Relic unit (Transport: 2) (detector). ~~~ Transport rule: Equipped with various support abilities; protects all nearby ally units from ranged attacks and boosts their damage outputs; uses an assortment of map control abilites that jams enemy sensors or reveals the FOW.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011830]] -- - Durability: Excellent | Strength: Very Good | Morale: Immune | Squad Size: Single | Movement Speed: Fast | Sight: Excellent | Keen Sight: 25m | Abilities: Below Average | Weapon range: Good | Capture Points: No.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011829]] -- Land Raider Prometheus
