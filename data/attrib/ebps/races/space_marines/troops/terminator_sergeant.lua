...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\space_marine_power_sword_sergeant.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18012201]] -- - (Deepstrike) Armored elite ranged leader unit (detector).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010004]] -- - Effective versus: Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010005]] -- - Effective versus: Heavy Infantry
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18010008]] -- - Effective versus: Vehicles
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012202]] -- - Durability: Excellent | Strength: Excellent | Movement Speed: Slow | Sight: Standard | Keen Sight: 8m | Abilities: Basic | Weapon range: Good | Capture Points: Yes.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/terminator_sergeant_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18012200]] -- Terminator Sergeant
