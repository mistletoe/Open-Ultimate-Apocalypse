...
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$673750]] -- - A Servitor with data indicating how to operate the Pavonis spaceport.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$673751]] -- - Capturing these Servitors will ensure your ability to run the spaceport.
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/servitor_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$673752]] -- Spaceport Servitor
