...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = [[weapon\space_marine_plasma_cannon_executioner.lua]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Space_Marines/Troops/Predator_infernus_executioner]]
...
GameData["event_manager_ext"]["event_21"]["event_entry_01"]["event_name"] = [[Guard\Abilities\curse_the_machine]]
...
GameData["health_ext"]["hitpoints"] = 6820
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011801]] -- - Elite vehicle. 
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011802]] -- - Durability: Very Good | Strength: Very Good | Squad Size: Single | Upgrades: A lot | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: None | Weapon range: Good | Capture Points: No.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Flamer/Plasma Cannon Predator variant.]]
--INTENTIONAL SPACER
GameData["ui_ext"]["ui_info"]["icon_name"] = [[space_marine_icons/predator_destructor_icon]]

GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$18011870]] -- Predator Executioner
