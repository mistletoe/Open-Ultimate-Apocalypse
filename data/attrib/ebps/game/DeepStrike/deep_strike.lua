...
GameData["squad_hold_ext"]["acceptable_type_04"] = Reference([[type_transportable\transport_greater_daemons.lua]])
GameData["squad_hold_ext"]["acceptable_type_05"] = Reference([[type_transportable\transport_chaoshorror.lua]])
GameData["squad_hold_ext"]["acceptable_type_06"] = Reference([[type_transportable\transport_tank.lua]])
GameData["squad_hold_ext"]["acceptable_type_07"] = Reference([[type_transportable\transport_lieutenant.lua]])
