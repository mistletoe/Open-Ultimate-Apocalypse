...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Tyranids/Projectiles/tyranids_bioplasma]]
...
GameData["projectile_ext"]["death_event_name"] = [[unit_impact_events\bioplasma_explosion]]
