...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Chaos/Projectiles/chaos_acidbolt_projectile]]
...
GameData["projectile_ext"]["death_event_name"] = [[Dark_Eldar\destructor_impact]]
