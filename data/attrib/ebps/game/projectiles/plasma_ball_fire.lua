...
GameData["entity_blueprint_ext"]["animator"] = [[Races/inquisition_daemonhunt/Projectiles/plasma_ball]]
...
GameData["projectile_ext"]["death_event_name"] = [[hit_events/hpg_hit]]
