...
GameData["requirements"]["required_11"]["structure_name"] = [[ebps\races\guard\structures\guard_mars_pattern.lua]]
...
GameData["ui_info"]["icon_name"] = [[guard_icons/upgrade_leman_russ_plasma_cannon_r]]
