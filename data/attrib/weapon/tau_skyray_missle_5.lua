...
GameData["requirements"]["required_2"]["research_name"] = [[research\tau_teachings_of_montka_research.lua]]
...
GameData["ui_info"]["screen_name_id"] = [[$18112079]] -- Missile Launcher (Left)
