...
GameData["cost"]["cost"]["souls"] = 250
GameData["cost"]["time_seconds"] = 7
GameData["death_motion_value"] = [[]]
GameData["fire_cone_angle"] = 5
GameData["fire_cost"] = Reference([[tables\cost_table.lua]])
GameData["fired_projectile"] = [[dark_eldar_stinger]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- 70m range projectile, able to deal good damage against infantry targets.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Disrupts infantry formations by exploding them into hundreds of little bits every shot and will also spread mass poison to nearby squads.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Weak against armored targets.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/stinger_icon]]

GameData["ui_info"]["screen_name_id"] = [[Necrotoxin Missiles]]
