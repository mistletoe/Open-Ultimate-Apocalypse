...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Unit_Impact_events/Death_Spinner_hit]]
...
GameData["fired_projectile"] = [[eldar_nightspinner_projectile]]
