...
GameData["fired_projectile"] = [[daemons_firebolt_redhorror_projectile]]
...
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_inferno_bolt_icon]]

GameData["ui_info"]["screen_name_id"] = [[$16000331]] -- Firebolt Upgrade
