...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 760
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 543
...
GameData["fired_projectile"] = [[chaos_vomit_projectile]]
