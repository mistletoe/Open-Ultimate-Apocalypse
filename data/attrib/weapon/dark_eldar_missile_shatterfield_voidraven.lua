...
GameData["area_effect"]["throw_data"]["force_min"] = 29
GameData["area_effect"]["throw_data"]["up_angle_max"] = 35
GameData["area_effect"]["throw_data"]["up_angle_min"] = 15

GameData["area_effect"]["weapon_damage"]["armour_damage"]["life_leech_damage"] = 280
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 765
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 256
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 1
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 56
...
GameData["fired_projectile"] = [[dark_eldar_wildfire]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- 70m range projectile, able to barrage enemy targets with rapid fire missiles.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Disrupts infantry formations and causes good damage to most units and structures.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Can also attack aircraft and leech enemy health.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/wildfire_icon]]

GameData["ui_info"]["screen_name_id"] = [[Shatterfield Missiles]]
