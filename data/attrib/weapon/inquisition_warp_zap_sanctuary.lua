...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[hit_events/zap_gun]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[hit_events/zap_gun]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[hit_events/zap_gun]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[hit_events/zap_gun]]
...
GameData["ui_info"]["icon_name"] = [[inqusition_icons/upgrade_warp_zap.tga]]

GameData["ui_info"]["screen_name_id"] = [[$16021240]] -- - Monstrous creatures gets dealt severe damage and weaker monsters might be killed in the process.
