...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/upgrade_psycannon]]

GameData["ui_info"]["screen_name_id"] = [[$16021190]] -- - Durability: 6 | Strength: 7 | Morale: Immune | Upgrades: 0 | Squad Size: Single | Movement Speed: Very fast | Sight: Very good | Keen Sight: None | Ability Strength: 4 | Weapon range: Long | Capture Points: No.
