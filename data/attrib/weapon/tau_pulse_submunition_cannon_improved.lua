...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Tau\Weapons\rvarna_submunition]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Tau\Weapons\rvarna_submunition]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Tau\Weapons\rvarna_submunition]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Tau\Weapons\rvarna_submunition]]
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 9443
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 5771
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 300
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 2600
...
GameData["cost"]["cost"]["power"] = 4828
GameData["cost"]["cost"]["requisition"] = 2300
GameData["cost"]["cost"]["souls"] = 0
GameData["cost"]["time_seconds"] = 200
...
GameData["max_traverse_left"] = -115
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Mini nuke weapon. Effective against taking down titans or very large armies with ease.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Must remain stationary to use.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- 12 second long racharge time/14 second setup time.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- 100% accurate.]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]

GameData["ui_info"]["icon_name"] = [[tau_icons/tau_commander_plasma_icon]]

GameData["ui_info"]["screen_name_id"] = [[Supreme Pulse Submunition Cannon]]
