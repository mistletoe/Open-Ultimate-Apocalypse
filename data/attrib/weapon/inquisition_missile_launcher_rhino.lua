...
GameData["fired_projectile"] = [[krak_missile_ID_rhino]]
...
GameData["ui_hotkey_name"] = [[inquisition_missile_launcher]]
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$16021080]] -- - Durability: 7 | Strength: 3 | Morale: Immune | Upgrades: 0 | Squad Size: Single | Movement Speed: Fast | Sight: Good |  Keen sight: None | Ability Strength: 1 | Weapon range: Standard | Capture Points: No.
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/upgrade_missile_launcher]]
