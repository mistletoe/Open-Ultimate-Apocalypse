...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 17
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 1
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 1
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[cosmos_custom_events\agony_titan_side_gun_impact]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[cosmos_custom_events\agony_titan_side_gun_impact]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[cosmos_custom_events\agony_titan_side_gun_impact]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[cosmos_custom_events\agony_titan_side_gun_impact]]
...
GameData["horizontal_traverse_speed"] = 250
...
GameData["raider_weapon_index"] = 2
