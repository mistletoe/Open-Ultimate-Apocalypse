...
GameData["cost"]["time_seconds"] = 5.5
...
GameData["requirements"]["required_2"]["population_required"] = 55
...
GameData["ui_info"]["icon_name"] = [[ork_icons/upgrade_killakan_rokkit_launcha]]
