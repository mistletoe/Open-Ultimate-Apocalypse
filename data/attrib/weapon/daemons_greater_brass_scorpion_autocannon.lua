...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 362
...
GameData["ui_info"]["icon_name"] = [[chaos_autocannon_havoc]]

GameData["ui_info"]["screen_name_id"] = [[Chaos Reaper Autocannon]]
