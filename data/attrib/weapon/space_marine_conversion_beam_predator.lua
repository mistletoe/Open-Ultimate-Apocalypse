...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 121
...
GameData["ui_info"]["icon_name"] = [[space_marine_icons/upgrade_predator_conversion_beamer]]

GameData["ui_info"]["screen_name_id"] = [[Conversion Beam]]
