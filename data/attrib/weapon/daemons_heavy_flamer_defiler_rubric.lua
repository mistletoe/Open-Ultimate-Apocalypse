...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 192
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/upgrade_terminator_heavy_flamer]]

GameData["ui_info"]["screen_name_id"] = [[Combi Flamer]]
