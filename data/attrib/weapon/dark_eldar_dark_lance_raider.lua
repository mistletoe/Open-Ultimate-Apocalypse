...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 248
...
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/heavyweapon_raider_darklance_icon]]

GameData["ui_info"]["screen_name_id"] = [[$593400]] -- Dark Lance
