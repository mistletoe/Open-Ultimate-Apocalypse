...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Eldar\Weapons\Lasblaster_Impact_Flesh]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Eldar\Weapons\Lasblaster_Impact_bone]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Eldar\Weapons\Lasblaster_Impact_light_metal]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Eldar\Weapons\Lasblaster_Impact_HVY]]
...
GameData["vertical_traverse_speed"] = 165
