...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\poison_enable.lua]])
...
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Spreads poison with a constant health degen until death of Hellhound. Poison spreads to your forces as well!]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18210137]] -- - Area effect weapon.

GameData["ui_info"]["icon_name"] = [[guard_icons/upgrade_chem_cannon]]

GameData["ui_info"]["screen_name_id"] = [[$18111236]] -- Chemical Cannon
