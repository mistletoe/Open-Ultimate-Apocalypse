...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 101
...
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/heavyweapon_warrior_splinter_icon]]

GameData["ui_info"]["screen_name_id"] = [[Splinter Cannon]]
