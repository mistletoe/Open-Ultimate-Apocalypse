...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 23.02796555
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 17.27097321
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Unit_Impact_events/eldar_shurican_hit_hvy_metal]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Unit_Impact_events/eldar_shurican_hit_flesh]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Unit_Impact_events/eldar_shurican_hit_hvy_metal]]
