...
GameData["ui_hotkey_name"] = [[marine_inferno_cannon]]
...
GameData["ui_info"]["icon_name"] = [[space_marine_icons/upgrade_inferno_cannon_ven_dread]]

GameData["ui_info"]["screen_name_id"] = [[$18111880]] -- Inferno Cannon
