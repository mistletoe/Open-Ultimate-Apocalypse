...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 685
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[Unit_Impact_events\chaos_lascannon_hit]]
