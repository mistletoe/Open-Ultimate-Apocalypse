...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210865]] -- - Massive slaughter weapon, slower fire rate, but has longer range and leaves a dent into most targets, especially infantry.
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/upgrade_defiler_battlecannon]]

GameData["ui_info"]["screen_name_id"] = [[$18210864]] -- Desecrator Battlecannon
