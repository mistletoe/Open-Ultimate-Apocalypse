...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 83
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/upgrade_grenade_launcher_incendiary]]

GameData["ui_info"]["screen_name_id"] = [[Grenade Launcher (Incendiary Grenades)]]
