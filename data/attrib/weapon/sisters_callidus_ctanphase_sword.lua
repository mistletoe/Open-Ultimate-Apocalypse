...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 268
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 216
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[witch_hunters/impact_ctan_phase]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[witch_hunters/impact_ctan_phase]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[witch_hunters/impact_ctan_phase]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[witch_hunters/impact_ctan_phase]]
...
GameData["kill_enemy_at_percent_life"] = 0.349999994
GameData["kill_enemy_at_percent_life_cooldown_time"] = 2
