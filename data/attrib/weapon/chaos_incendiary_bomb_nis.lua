...
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[Chaos\HT_MissileImpact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[Chaos\HT_MissileImpact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[Chaos\HT_MissileImpact]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[Chaos\HT_MissileImpact]]
...
GameData["fired_projectile"] = [[chaos_incendiary_bomb]]
