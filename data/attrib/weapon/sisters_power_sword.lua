GameData = Inherit([[]])
GameData["accuracy"] = 0.85 --Buffed; these are only used by elites.
GameData["accuracy_reduction_when_moving"] = 0
GameData["area_effect"] = Reference([[tables\STRENGTH_5.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 100
 --reflects that they can cut through pretty much anything over time.
...
--These used to have costs, but they're only activated via Research, so they were a hidden drag on Reinforcement. Eliminated.
...
GameData["ui_info"]["screen_name_id"] = [[$4400046]] -- Power Sword
