GameData = Inherit([[]])
--Less accurate than Power Sword, as these are wielded by non-elites.
...
--For some bizarre reasons, this weapon was nerfed in a lot of Sisters units, which made no sense.
--HTH weapons need to out-DPS shooters, and 55 DPS vs 30+ for Bolt Pistols made no sense. So that fixed, going forward.
...
GameData["ui_info"]["help_text_id"] = [[$4400012]] -- - Sword with motorized biting teeth that saw and slash through enemies.
...
GameData["ui_info"]["screen_name_id"] = [[$588800]] -- Chainsword
