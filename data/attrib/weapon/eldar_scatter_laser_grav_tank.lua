...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 39.55945969
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 33.23048019
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 1
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 6
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[unit_impact_events\eldar_scatter_laser_hit_flesh]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[unit_impact_events\eldar_scatter_laser_hit_hvy_metal]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_impact_events\eldar_scatter_laser_hit_flesh]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[unit_impact_events\eldar_scatter_laser_hit_hvy_metal]]
